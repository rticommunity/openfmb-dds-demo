...
public class CurveDataListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::CurveDataList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CurveDataListTypeSupport _singleton
    = new CurveDataListTypeSupport();
    ...
    */
    public static CurveDataListTypeSupport get_instance() {
        return _singleton;
    }

    public static CurveDataListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CurveDataListTypeCode.VALUE;
    }

    public Object create_data() {
        return CurveDataList.create();
    }
    ...
    * <code>this</code> is not a <code>CurveDataList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CurveDataList typedDst = (CurveDataList) destination;
        CurveDataList typedSrc = (CurveDataList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.CurveDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.CurveDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        CurveDataList typedSrc = (CurveDataList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.CurveDataTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.curveData);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.CurveDataTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.curveData,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CurveDataList typedDst = (CurveDataList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.CurveDataTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.curveData, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.CurveDataTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CurveDataList typedDst = (CurveDataList) sample;
    ...
    protected CurveDataListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CurveDataListTypeCode.VALUE,CurveDataList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CurveDataListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CurveDataListTypeCode.VALUE,CurveDataList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
