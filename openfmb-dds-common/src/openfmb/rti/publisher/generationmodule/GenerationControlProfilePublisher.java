...
/* GenerationControlProfilePublisher.java
 * A publication of data of type GenerationControlProfile
 */
...
import OpenFMB_Information_Model.openfmb.generationmodule.GenerationControlProfileDataWriter;
import OpenFMB_Information_Model.openfmb.generationmodule.GenerationControlProfileTypeSupport;

// ===========================================================================

public class GenerationControlProfilePublisher {
	
    public static GenerationControlProfileDataWriter writer = null;

    // --- Constructors: -----------------------------------------------------

    public GenerationControlProfilePublisher() {
        super();
    }
    ...
    public int initialize(int domainId, String  topicName) {
        ...
        try {
            ...
            writer = (GenerationControlProfileDataWriter)
    ...
    public void publish(GenerationControlProfile instance) {
