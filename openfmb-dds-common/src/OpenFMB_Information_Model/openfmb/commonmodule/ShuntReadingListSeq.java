...
/**
* A sequence of ShuntReadingList instances.
*/
public final class ShuntReadingListSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShuntReadingListSeq() {
        super(ShuntReadingList.class);
    }

    public ShuntReadingListSeq (int initialMaximum) {
        super(ShuntReadingList.class, initialMaximum);
    }

    public ShuntReadingListSeq (Collection elements) {
        super(ShuntReadingList.class, elements);
    }

    public  ShuntReadingList get(int index) { 
        return (ShuntReadingList) super.get(index); 
    }
