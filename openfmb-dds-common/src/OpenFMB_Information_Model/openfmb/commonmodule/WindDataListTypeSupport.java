...
public class WindDataListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::WindDataList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WindDataListTypeSupport _singleton
    = new WindDataListTypeSupport();
    ...
    */
    public static WindDataListTypeSupport get_instance() {
        return _singleton;
    }

    public static WindDataListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WindDataListTypeCode.VALUE;
    }

    public Object create_data() {
        return WindDataList.create();
    }
    ...
    * <code>this</code> is not a <code>WindDataList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        WindDataList typedDst = (WindDataList) destination;
        WindDataList typedSrc = (WindDataList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.WindDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.WindDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        WindDataList typedSrc = (WindDataList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.WindDataTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.windData);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.WindDataTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.windData,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            WindDataList typedDst = (WindDataList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.WindDataTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.windData, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.WindDataTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            WindDataList typedDst = (WindDataList) sample;
    ...
    protected WindDataListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,WindDataListTypeCode.VALUE,WindDataList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WindDataListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,WindDataListTypeCode.VALUE,WindDataList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
