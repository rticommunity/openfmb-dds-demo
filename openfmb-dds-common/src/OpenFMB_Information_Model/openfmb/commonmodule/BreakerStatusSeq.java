...
/**
* A sequence of BreakerStatus instances.
*/
public final class BreakerStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public BreakerStatusSeq() {
        super(BreakerStatus.class);
    }

    public BreakerStatusSeq (int initialMaximum) {
        super(BreakerStatus.class, initialMaximum);
    }

    public BreakerStatusSeq (Collection elements) {
        super(BreakerStatus.class, elements);
    }

    public  BreakerStatus get(int index) { 
        return (BreakerStatus) super.get(index); 
    }
