...
public class ShuntReadingProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::shuntmodule::ShuntReadingProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShuntReadingProfileTypeSupport _singleton
    = new ShuntReadingProfileTypeSupport();
    ...
    */
    public static ShuntReadingProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static ShuntReadingProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShuntReadingProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return ShuntReadingProfile.create();
    }
    ...
    public Class get_type() {
        return ShuntReadingProfile.class;
    }
    ...
    * <code>this</code> is not a <code>ShuntReadingProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShuntReadingProfile typedDst = (ShuntReadingProfile) destination;
        ShuntReadingProfile typedSrc = (ShuntReadingProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingListTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingListTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        ShuntReadingProfile typedSrc = (ShuntReadingProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingListTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.shuntReadingList);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingListTypeSupport.get_instance().serialize(endpoint_data, typedSrc.shuntReadingList, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShuntReadingProfile typedDst = (ShuntReadingProfile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.shuntReadingList = (OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingList)OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingListTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.shuntReadingList, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingListTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShuntReadingProfile typedDst = (ShuntReadingProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        ShuntReadingProfile typedDst
        = (ShuntReadingProfile) instance;
        ShuntReadingProfile typedSrc
        = (ShuntReadingProfile) key;
    ...
    */
    ...
    int mask) {
        return new ShuntReadingProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ShuntReadingProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected ShuntReadingProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ShuntReadingProfileTypeCode.VALUE,ShuntReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShuntReadingProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShuntReadingProfileTypeCode.VALUE,ShuntReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
