...
public class EnergyConsumerTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::EnergyConsumer";
    ...
    */
        ...
        Object sample) 
    {
        ...
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.operatingLimit != null) {

            currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.operatingLimit );
