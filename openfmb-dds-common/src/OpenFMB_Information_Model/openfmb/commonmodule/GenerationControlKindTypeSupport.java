...
* GenerationControlKind
*/

public class GenerationControlKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::GenerationControlKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationControlKindTypeSupport _singleton
    = new GenerationControlKindTypeSupport();
    ...
    */
    public static GenerationControlKindTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationControlKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationControlKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return GenerationControlKind.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationControlKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        GenerationControlKind typedSrc = (GenerationControlKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = GenerationControlKind.valueOf(ordinal);
            if (dst == null) {
                ...
                if (ap.acceptUnknownEnumValue) {
                    dst = GenerationControlKind.valueOf(
                        4);
                } else {
    ...
    protected GenerationControlKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GenerationControlKindTypeCode.VALUE,GenerationControlKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
