...
/**
* A sequence of CurveDataList instances.
*/
public final class CurveDataListSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CurveDataListSeq() {
        super(CurveDataList.class);
    }

    public CurveDataListSeq (int initialMaximum) {
        super(CurveDataList.class, initialMaximum);
    }

    public CurveDataListSeq (Collection elements) {
        super(CurveDataList.class, elements);
    }

    public  CurveDataList get(int index) { 
        return (CurveDataList) super.get(index); 
    }
