...
public class SunRadiationDataListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::SunRadiationDataList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SunRadiationDataListTypeSupport _singleton
    = new SunRadiationDataListTypeSupport();
    ...
    */
    public static SunRadiationDataListTypeSupport get_instance() {
        return _singleton;
    }

    public static SunRadiationDataListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SunRadiationDataListTypeCode.VALUE;
    }

    public Object create_data() {
        return SunRadiationDataList.create();
    }
    ...
    public Object create_key() {
        return new SunRadiationDataList();
    }
    ...
    public Class get_type() {
        return SunRadiationDataList.class;
    }
    ...
    * <code>this</code> is not a <code>SunRadiationDataList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SunRadiationDataList typedDst = (SunRadiationDataList) destination;
        SunRadiationDataList typedSrc = (SunRadiationDataList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SunRadiationDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SunRadiationDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        SunRadiationDataList typedSrc = (SunRadiationDataList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SunRadiationDataTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.sunRadiationData);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.SunRadiationDataTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.sunRadiationData,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SunRadiationDataList typedDst = (SunRadiationDataList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.SunRadiationDataTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.sunRadiationData, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.SunRadiationDataTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SunRadiationDataList typedDst = (SunRadiationDataList) sample;
    ...
    protected SunRadiationDataListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SunRadiationDataListTypeCode.VALUE,SunRadiationDataList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SunRadiationDataListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SunRadiationDataListTypeCode.VALUE,SunRadiationDataList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
