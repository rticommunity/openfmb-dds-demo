...
public class ShuntControlKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ShuntControlKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShuntControlKindTypeSupport _singleton
    = new ShuntControlKindTypeSupport();
    ...
    */
    public static ShuntControlKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ShuntControlKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShuntControlKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ShuntControlKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        ShuntControlKind typedSrc = (ShuntControlKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ShuntControlKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ShuntControlKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShuntControlKindTypeCode.VALUE,ShuntControlKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
