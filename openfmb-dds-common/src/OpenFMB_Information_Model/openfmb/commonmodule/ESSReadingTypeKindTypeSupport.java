...
public class ESSReadingTypeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ESSReadingTypeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ESSReadingTypeKindTypeSupport _singleton
    = new ESSReadingTypeKindTypeSupport();
    ...
    */
    public static ESSReadingTypeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ESSReadingTypeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ESSReadingTypeKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return ESSReadingTypeKind.class;
    }
    ...
    * <code>this</code> is not a <code>ESSReadingTypeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        ESSReadingTypeKind typedSrc = (ESSReadingTypeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ESSReadingTypeKind.valueOf(ordinal);
            if (dst == null) {
                ...
                if (ap.acceptUnknownEnumValue) {
                    dst = ESSReadingTypeKind.valueOf(
                        2);
                } else {
    ...
    protected ESSReadingTypeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ESSReadingTypeKindTypeCode.VALUE,ESSReadingTypeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
