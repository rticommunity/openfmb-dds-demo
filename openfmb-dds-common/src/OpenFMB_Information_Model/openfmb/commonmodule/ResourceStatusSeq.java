...
/**
* A sequence of ResourceStatus instances.
*/
public final class ResourceStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ResourceStatusSeq() {
        super(ResourceStatus.class);
    }

    public ResourceStatusSeq (int initialMaximum) {
        super(ResourceStatus.class, initialMaximum);
    }

    public ResourceStatusSeq (Collection elements) {
        super(ResourceStatus.class, elements);
    }

    public  ResourceStatus get(int index) { 
        return (ResourceStatus) super.get(index); 
    }
