...
public class GenerationReadingListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::GenerationReadingList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationReadingListTypeSupport _singleton
    = new GenerationReadingListTypeSupport();
    ...
    */
    public static GenerationReadingListTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationReadingListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationReadingListTypeCode.VALUE;
    }

    public Object create_data() {
        return GenerationReadingList.create();
    }
    ...
    public Object create_key() {
        return new GenerationReadingList();
    }
    ...
    public Class get_type() {
        return GenerationReadingList.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationReadingList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenerationReadingList typedDst = (GenerationReadingList) destination;
        GenerationReadingList typedSrc = (GenerationReadingList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        GenerationReadingList typedSrc = (GenerationReadingList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationReadingTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.generationReading);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.GenerationReadingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.generationReading,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenerationReadingList typedDst = (GenerationReadingList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.GenerationReadingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.generationReading, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.GenerationReadingTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenerationReadingList typedDst = (GenerationReadingList) sample;
    ...
    protected GenerationReadingListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GenerationReadingListTypeCode.VALUE,GenerationReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenerationReadingListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenerationReadingListTypeCode.VALUE,GenerationReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
