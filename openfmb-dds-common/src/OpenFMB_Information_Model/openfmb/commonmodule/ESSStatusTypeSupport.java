...
public class ESSStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ESSStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ESSStatusTypeSupport _singleton
    = new ESSStatusTypeSupport();
    ...
    */
    public static ESSStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static ESSStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ESSStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return ESSStatus.create();
    }
    ...
    * <code>this</code> is not a <code>ESSStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ESSStatus typedDst = (ESSStatus) destination;
        ESSStatus typedSrc = (ESSStatus) source;
        ...
        Object sample) 
    {
        ...
        ESSStatus typedSrc = (ESSStatus) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByte(typedSrc.__dummy_prevent_empty_class_ESSStatus);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ESSStatus typedDst = (ESSStatus) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.__dummy_prevent_empty_class_ESSStatus = src.readByte();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ESSStatus typedDst = (ESSStatus) sample;
    ...
    protected ESSStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ESSStatusTypeCode.VALUE,ESSStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ESSStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ESSStatusTypeCode.VALUE,ESSStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
