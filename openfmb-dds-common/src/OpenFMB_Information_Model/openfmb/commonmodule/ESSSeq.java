...
/**
* A sequence of ESS instances.
*/
public final class ESSSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ESSSeq (int initialMaximum) {
        super(ESS.class, initialMaximum);
    }

    public ESSSeq (Collection elements) {
        super(ESS.class, elements);
    }

    public  ESS get(int index) { 
        return (ESS) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' ESS objects (beyond the original size of this object)
