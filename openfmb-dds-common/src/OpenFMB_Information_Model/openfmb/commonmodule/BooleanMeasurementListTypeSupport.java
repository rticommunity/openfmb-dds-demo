...
public class BooleanMeasurementListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::BooleanMeasurementList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BooleanMeasurementListTypeSupport _singleton
    = new BooleanMeasurementListTypeSupport();
    ...
    */
    public static BooleanMeasurementListTypeSupport get_instance() {
        return _singleton;
    }

    public static BooleanMeasurementListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BooleanMeasurementListTypeCode.VALUE;
    }

    public Object create_data() {
        return BooleanMeasurementList.create();
    }
    ...
    public Object create_key() {
        return new BooleanMeasurementList();
    }
    ...
    public Class get_type() {
        return BooleanMeasurementList.class;
    }
    ...
    * <code>this</code> is not a <code>BooleanMeasurementList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BooleanMeasurementList typedDst = (BooleanMeasurementList) destination;
        BooleanMeasurementList typedSrc = (BooleanMeasurementList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BooleanMeasurementTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BooleanMeasurementTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        BooleanMeasurementList typedSrc = (BooleanMeasurementList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BooleanMeasurementTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.booleanMeasurement);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.BooleanMeasurementTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.booleanMeasurement,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BooleanMeasurementList typedDst = (BooleanMeasurementList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.BooleanMeasurementTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.booleanMeasurement, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.BooleanMeasurementTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BooleanMeasurementList typedDst = (BooleanMeasurementList) sample;
    ...
    protected BooleanMeasurementListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BooleanMeasurementListTypeCode.VALUE,BooleanMeasurementList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BooleanMeasurementListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BooleanMeasurementListTypeCode.VALUE,BooleanMeasurementList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
