...
public class InterchangeScheduleListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::InterchangeScheduleList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final InterchangeScheduleListTypeSupport _singleton
    = new InterchangeScheduleListTypeSupport();
    ...
    */
    public static InterchangeScheduleListTypeSupport get_instance() {
        return _singleton;
    }

    public static InterchangeScheduleListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return InterchangeScheduleListTypeCode.VALUE;
    }

    public Object create_data() {
        return InterchangeScheduleList.create();
    }
    ...
    public Object create_key() {
        return new InterchangeScheduleList();
    }
    ...
    public Class get_type() {
        return InterchangeScheduleList.class;
    }
    ...
    * <code>this</code> is not a <code>InterchangeScheduleList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        InterchangeScheduleList typedDst = (InterchangeScheduleList) destination;
        InterchangeScheduleList typedSrc = (InterchangeScheduleList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InterchangeScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InterchangeScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        InterchangeScheduleList typedSrc = (InterchangeScheduleList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InterchangeScheduleTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.interchangeSchedule);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.InterchangeScheduleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.interchangeSchedule,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            InterchangeScheduleList typedDst = (InterchangeScheduleList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.InterchangeScheduleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.interchangeSchedule, src, 100, endpoint_plugin_qos);            
    ...
    public String data_to_string(
        InterchangeScheduleList sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.InterchangeScheduleTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            InterchangeScheduleList typedDst = (InterchangeScheduleList) sample;
    ...
    protected InterchangeScheduleListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,InterchangeScheduleListTypeCode.VALUE,InterchangeScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected InterchangeScheduleListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,InterchangeScheduleListTypeCode.VALUE,InterchangeScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
