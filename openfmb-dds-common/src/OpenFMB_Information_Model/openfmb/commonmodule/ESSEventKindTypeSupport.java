...
public class ESSEventKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ESSEventKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ESSEventKindTypeSupport _singleton
    = new ESSEventKindTypeSupport();
    ...
    */
    public static ESSEventKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ESSEventKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ESSEventKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ESSEventKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        ESSEventKind typedSrc = (ESSEventKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ESSEventKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ESSEventKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ESSEventKindTypeCode.VALUE,ESSEventKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
