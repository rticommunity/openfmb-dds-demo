...
public class ESSReadingListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ESSReadingList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ESSReadingListTypeSupport _singleton
    = new ESSReadingListTypeSupport();
    ...
    */
    public static ESSReadingListTypeSupport get_instance() {
        return _singleton;
    }

    public static ESSReadingListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ESSReadingListTypeCode.VALUE;
    }

    public Object create_data() {
        return ESSReadingList.create();
    }
    ...
    * <code>this</code> is not a <code>ESSReadingList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ESSReadingList typedDst = (ESSReadingList) destination;
        ESSReadingList typedSrc = (ESSReadingList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        ESSReadingList typedSrc = (ESSReadingList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSReadingTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.essReading);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ESSReadingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.essReading,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ESSReadingList typedDst = (ESSReadingList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.ESSReadingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.essReading, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ESSReadingTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ESSReadingList typedDst = (ESSReadingList) sample;
    ...
    protected ESSReadingListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ESSReadingListTypeCode.VALUE,ESSReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ESSReadingListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ESSReadingListTypeCode.VALUE,ESSReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
