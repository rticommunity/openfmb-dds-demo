...
public class GenerationReadingTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::GenerationReading";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationReadingTypeSupport _singleton
    = new GenerationReadingTypeSupport();
    ...
    */
    public static GenerationReadingTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationReadingTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationReadingTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return GenerationReading.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationReading</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenerationReading typedDst = (GenerationReading) destination;
        GenerationReading typedSrc = (GenerationReading) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationReadingTypeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationReadingTypeKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        GenerationReading typedSrc = (GenerationReading) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationReadingTypeKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.GenerationReadingTypeKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenerationReading typedDst = (GenerationReading) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.type = (OpenFMB_Information_Model.openfmb.commonmodule.GenerationReadingTypeKind)OpenFMB_Information_Model.openfmb.commonmodule.GenerationReadingTypeKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.GenerationReadingTypeKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenerationReading typedDst = (GenerationReading) sample;
    ...
    protected GenerationReadingTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GenerationReadingTypeCode.VALUE,GenerationReading.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenerationReadingTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenerationReadingTypeCode.VALUE,GenerationReading.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
