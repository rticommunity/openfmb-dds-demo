...
/**
* A sequence of LoadReading instances.
*/
public final class LoadReadingSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LoadReadingSeq() {
        super(LoadReading.class);
    }

    public LoadReadingSeq (int initialMaximum) {
        super(LoadReading.class, initialMaximum);
    }

    public LoadReadingSeq (Collection elements) {
        super(LoadReading.class, elements);
    }

    public  LoadReading get(int index) { 
        return (LoadReading) super.get(index); 
    }
