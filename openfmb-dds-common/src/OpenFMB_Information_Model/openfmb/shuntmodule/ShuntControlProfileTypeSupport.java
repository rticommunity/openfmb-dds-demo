...
public class ShuntControlProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::shuntmodule::ShuntControlProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShuntControlProfileTypeSupport _singleton
    = new ShuntControlProfileTypeSupport();
    ...
    */
    public static ShuntControlProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static ShuntControlProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShuntControlProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return ShuntControlProfile.create();
    }
    ...
    public Class get_type() {
        return ShuntControlProfile.class;
    }
    ...
    * <code>this</code> is not a <code>ShuntControlProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShuntControlProfile typedDst = (ShuntControlProfile) destination;
        ShuntControlProfile typedSrc = (ShuntControlProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        ShuntControlProfile typedSrc = (ShuntControlProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.shuntControl);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlTypeSupport.get_instance().serialize(endpoint_data, typedSrc.shuntControl, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShuntControlProfile typedDst = (ShuntControlProfile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.shuntControl = (OpenFMB_Information_Model.openfmb.commonmodule.ShuntControl)OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.shuntControl, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShuntControlProfile typedDst = (ShuntControlProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        ShuntControlProfile typedDst
        = (ShuntControlProfile) instance;
        ShuntControlProfile typedSrc
        = (ShuntControlProfile) key;
    ...
    */
    ...
    int mask) {
        return new ShuntControlProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ShuntControlProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected ShuntControlProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ShuntControlProfileTypeCode.VALUE,ShuntControlProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShuntControlProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShuntControlProfileTypeCode.VALUE,ShuntControlProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
