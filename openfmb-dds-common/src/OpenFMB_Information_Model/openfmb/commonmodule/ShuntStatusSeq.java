...
/**
* A sequence of ShuntStatus instances.
*/
public final class ShuntStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShuntStatusSeq() {
        super(ShuntStatus.class);
    }

    public ShuntStatusSeq (int initialMaximum) {
        super(ShuntStatus.class, initialMaximum);
    }

    public ShuntStatusSeq (Collection elements) {
        super(ShuntStatus.class, elements);
    }

    public  ShuntStatus get(int index) { 
        return (ShuntStatus) super.get(index); 
    }
