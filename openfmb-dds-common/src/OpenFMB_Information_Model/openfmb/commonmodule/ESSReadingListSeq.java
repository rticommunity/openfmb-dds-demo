...
/**
* A sequence of ESSReadingList instances.
*/
public final class ESSReadingListSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ESSReadingListSeq() {
        super(ESSReadingList.class);
    }

    public ESSReadingListSeq (int initialMaximum) {
        super(ESSReadingList.class, initialMaximum);
    }

    public ESSReadingListSeq (Collection elements) {
        super(ESSReadingList.class, elements);
    }

    public  ESSReadingList get(int index) { 
        return (ESSReadingList) super.get(index); 
    }
