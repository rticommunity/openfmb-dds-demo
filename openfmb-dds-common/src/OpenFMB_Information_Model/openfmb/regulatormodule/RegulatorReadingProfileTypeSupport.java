...
public class RegulatorReadingProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::regulatormodule::RegulatorReadingProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RegulatorReadingProfileTypeSupport _singleton
    = new RegulatorReadingProfileTypeSupport();
    ...
    */
    public static RegulatorReadingProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static RegulatorReadingProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RegulatorReadingProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return RegulatorReadingProfile.create();
    }
    ...
    public Class get_type() {
        return RegulatorReadingProfile.class;
    }
    ...
    * <code>this</code> is not a <code>RegulatorReadingProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RegulatorReadingProfile typedDst = (RegulatorReadingProfile) destination;
        RegulatorReadingProfile typedSrc = (RegulatorReadingProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingListTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingListTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        RegulatorReadingProfile typedSrc = (RegulatorReadingProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingListTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.regulatorReadingList);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingListTypeSupport.get_instance().serialize(endpoint_data, typedSrc.regulatorReadingList, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RegulatorReadingProfile typedDst = (RegulatorReadingProfile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.regulatorReadingList = (OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingList)OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingListTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.regulatorReadingList, src, false, true, endpoint_plugin_qos);     
    ...
    public String data_to_string(
        RegulatorReadingProfile sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingListTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RegulatorReadingProfile typedDst = (RegulatorReadingProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        RegulatorReadingProfile typedDst
        = (RegulatorReadingProfile) instance;
        RegulatorReadingProfile typedSrc
        = (RegulatorReadingProfile) key;
    ...
    */
    ...
    int mask) {
        return new RegulatorReadingProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new RegulatorReadingProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected RegulatorReadingProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,RegulatorReadingProfileTypeCode.VALUE,RegulatorReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RegulatorReadingProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RegulatorReadingProfileTypeCode.VALUE,RegulatorReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
