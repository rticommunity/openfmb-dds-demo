...
public class MarketFactorListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::MarketFactorList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MarketFactorListTypeSupport _singleton
    = new MarketFactorListTypeSupport();
    ...
    */
    public static MarketFactorListTypeSupport get_instance() {
        return _singleton;
    }

    public static MarketFactorListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MarketFactorListTypeCode.VALUE;
    }

    public Object create_data() {
        return MarketFactorList.create();
    }
    ...
    * <code>this</code> is not a <code>MarketFactorList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MarketFactorList typedDst = (MarketFactorList) destination;
        MarketFactorList typedSrc = (MarketFactorList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MarketFactorsTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MarketFactorsTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        MarketFactorList typedSrc = (MarketFactorList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MarketFactorsTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.marketFactor);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MarketFactorsTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.marketFactor,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MarketFactorList typedDst = (MarketFactorList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.MarketFactorsTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.marketFactor, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MarketFactorsTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MarketFactorList typedDst = (MarketFactorList) sample;
    ...
    protected MarketFactorListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MarketFactorListTypeCode.VALUE,MarketFactorList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MarketFactorListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MarketFactorListTypeCode.VALUE,MarketFactorList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
