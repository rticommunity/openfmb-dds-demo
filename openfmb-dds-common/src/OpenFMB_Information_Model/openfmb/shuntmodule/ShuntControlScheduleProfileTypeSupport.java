...
public class ShuntControlScheduleProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::shuntmodule::ShuntControlScheduleProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShuntControlScheduleProfileTypeSupport _singleton
    = new ShuntControlScheduleProfileTypeSupport();
    ...
    */
    public static ShuntControlScheduleProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static ShuntControlScheduleProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShuntControlScheduleProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return ShuntControlScheduleProfile.create();
    }
    ...
    public Object create_key() {
        return new ShuntControlScheduleProfile();
    }
    ...
    public Class get_type() {
        return ShuntControlScheduleProfile.class;
    }
    ...
    * <code>this</code> is not a <code>ShuntControlScheduleProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShuntControlScheduleProfile typedDst = (ShuntControlScheduleProfile) destination;
        ShuntControlScheduleProfile typedSrc = (ShuntControlScheduleProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlScheduleListTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlScheduleListTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        ShuntControlScheduleProfile typedSrc = (ShuntControlScheduleProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlScheduleListTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.shuntControlScheduleList);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlScheduleListTypeSupport.get_instance().serialize(endpoint_data, typedSrc.shuntControlScheduleList, dst, false, encapsulation_id,true,endpoint_plugin_qos);
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        ShuntControlScheduleProfile src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShuntControlScheduleProfile typedDst = (ShuntControlScheduleProfile) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.shuntControlScheduleList = (OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlScheduleList)OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlScheduleListTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.shuntControlScheduleList, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        ShuntControlScheduleProfile dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        ShuntControlScheduleProfile sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlScheduleListTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShuntControlScheduleProfile typedDst = (ShuntControlScheduleProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        ShuntControlScheduleProfile typedDst
        = (ShuntControlScheduleProfile) instance;
        ShuntControlScheduleProfile typedSrc
        = (ShuntControlScheduleProfile) key;
    ...
    */
    ...
    int mask) {
        return new ShuntControlScheduleProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ShuntControlScheduleProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected ShuntControlScheduleProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ShuntControlScheduleProfileTypeCode.VALUE,ShuntControlScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShuntControlScheduleProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShuntControlScheduleProfileTypeCode.VALUE,ShuntControlScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
