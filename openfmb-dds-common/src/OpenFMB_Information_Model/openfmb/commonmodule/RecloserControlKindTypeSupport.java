...
public class RecloserControlKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::RecloserControlKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RecloserControlKindTypeSupport _singleton
    = new RecloserControlKindTypeSupport();
    ...
    */
    public static RecloserControlKindTypeSupport get_instance() {
        return _singleton;
    }

    public static RecloserControlKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RecloserControlKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return RecloserControlKind.class;
    }
    ...
    * <code>this</code> is not a <code>RecloserControlKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        RecloserControlKind typedSrc = (RecloserControlKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = RecloserControlKind.valueOf(ordinal);
            if (dst == null) {
                ...
                if (ap.acceptUnknownEnumValue) {
                    dst = RecloserControlKind.valueOf(
                        4);
                } else {
    ...
    protected RecloserControlKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RecloserControlKindTypeCode.VALUE,RecloserControlKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
