...
public class ShuntReadingListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ShuntReadingList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShuntReadingListTypeSupport _singleton
    = new ShuntReadingListTypeSupport();
    ...
    */
    public static ShuntReadingListTypeSupport get_instance() {
        return _singleton;
    }

    public static ShuntReadingListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShuntReadingListTypeCode.VALUE;
    }

    public Object create_data() {
        return ShuntReadingList.create();
    }
    ...
    * <code>this</code> is not a <code>ShuntReadingList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShuntReadingList typedDst = (ShuntReadingList) destination;
        ShuntReadingList typedSrc = (ShuntReadingList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        ShuntReadingList typedSrc = (ShuntReadingList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.shuntReading);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.shuntReading,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShuntReadingList typedDst = (ShuntReadingList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.shuntReading, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShuntReadingList typedDst = (ShuntReadingList) sample;
    ...
    protected ShuntReadingListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShuntReadingListTypeCode.VALUE,ShuntReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShuntReadingListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShuntReadingListTypeCode.VALUE,ShuntReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
