...
public class RegulatorStatusProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::regulatormodule::RegulatorStatusProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RegulatorStatusProfileTypeSupport _singleton
    = new RegulatorStatusProfileTypeSupport();
    ...
    */
    public static RegulatorStatusProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static RegulatorStatusProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RegulatorStatusProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return RegulatorStatusProfile.create();
    }
    ...
    public Class get_type() {
        return RegulatorStatusProfile.class;
    }
    ...
    * <code>this</code> is not a <code>RegulatorStatusProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RegulatorStatusProfile typedDst = (RegulatorStatusProfile) destination;
        RegulatorStatusProfile typedSrc = (RegulatorStatusProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        RegulatorStatusProfile typedSrc = (RegulatorStatusProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorStatusTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.regulatorStatus);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.regulatorStatus, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RegulatorStatusProfile typedDst = (RegulatorStatusProfile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.regulatorStatus = (OpenFMB_Information_Model.openfmb.commonmodule.RegulatorStatus)OpenFMB_Information_Model.openfmb.commonmodule.RegulatorStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.regulatorStatus, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RegulatorStatusProfile typedDst = (RegulatorStatusProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        RegulatorStatusProfile typedDst
        = (RegulatorStatusProfile) instance;
        RegulatorStatusProfile typedSrc
        = (RegulatorStatusProfile) key;
    ...
    */
    ...
    int mask) {
        return new RegulatorStatusProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new RegulatorStatusProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected RegulatorStatusProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,RegulatorStatusProfileTypeCode.VALUE,RegulatorStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RegulatorStatusProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RegulatorStatusProfileTypeCode.VALUE,RegulatorStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
