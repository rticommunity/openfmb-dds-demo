...
* GenerationReadingTypeKind
*/

public class GenerationReadingTypeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::GenerationReadingTypeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationReadingTypeKindTypeSupport _singleton
    = new GenerationReadingTypeKindTypeSupport();
    ...
    */
    public static GenerationReadingTypeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationReadingTypeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationReadingTypeKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return GenerationReadingTypeKind.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationReadingTypeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        GenerationReadingTypeKind typedSrc = (GenerationReadingTypeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = GenerationReadingTypeKind.valueOf(ordinal);
            if (dst == null) {
                ...
                if (ap.acceptUnknownEnumValue) {
                    dst = GenerationReadingTypeKind.valueOf(
                        2);
                } else {
    ...
    protected GenerationReadingTypeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GenerationReadingTypeKindTypeCode.VALUE,GenerationReadingTypeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
