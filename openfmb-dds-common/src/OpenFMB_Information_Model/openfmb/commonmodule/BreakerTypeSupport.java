...
public class BreakerTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::Breaker";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BreakerTypeSupport _singleton
    = new BreakerTypeSupport();
    ...
    */
    public static BreakerTypeSupport get_instance() {
        return _singleton;
    }

    public static BreakerTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BreakerTypeCode.VALUE;
    }

    public Object create_data() {
        return Breaker.create();
    }
    ...
    * <code>this</code> is not a <code>Breaker</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Breaker typedDst = (Breaker) destination;
        Breaker typedSrc = (Breaker) source;
        ...
        Object sample) 
    {
        ...
        Breaker typedSrc = (Breaker) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByte(typedSrc.__dummy_prevent_empty_class_Breaker);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                typedDst.__dummy_prevent_empty_class_Breaker = src.readByte();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Breaker typedDst = (Breaker) sample;
    ...
    protected BreakerTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BreakerTypeCode.VALUE,Breaker.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BreakerTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BreakerTypeCode.VALUE,Breaker.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
