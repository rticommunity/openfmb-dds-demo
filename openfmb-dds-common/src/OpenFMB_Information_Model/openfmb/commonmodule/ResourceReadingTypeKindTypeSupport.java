...
* ResourceReadingTypeKind
*/

public class ResourceReadingTypeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ResourceReadingTypeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ResourceReadingTypeKindTypeSupport _singleton
    = new ResourceReadingTypeKindTypeSupport();
    ...
    */
    public static ResourceReadingTypeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ResourceReadingTypeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ResourceReadingTypeKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return ResourceReadingTypeKind.class;
    }
    ...
    * <code>this</code> is not a <code>ResourceReadingTypeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        ResourceReadingTypeKind typedSrc = (ResourceReadingTypeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ResourceReadingTypeKind.valueOf(ordinal);
            if (dst == null) {
                ...
                if (ap.acceptUnknownEnumValue) {
                    dst = ResourceReadingTypeKind.valueOf(
                        2);
                } else {
    ...
    protected ResourceReadingTypeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ResourceReadingTypeKindTypeCode.VALUE,ResourceReadingTypeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
