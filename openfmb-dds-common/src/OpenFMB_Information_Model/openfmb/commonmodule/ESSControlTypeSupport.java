...
public class ESSControlTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ESSControl";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ESSControlTypeSupport _singleton
    = new ESSControlTypeSupport();
    ...
    */
    public static ESSControlTypeSupport get_instance() {
        return _singleton;
    }

    public static ESSControlTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ESSControlTypeCode.VALUE;
    }

    public Object create_data() {
        return ESSControl.create();
    }
    ...
    * <code>this</code> is not a <code>ESSControl</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ESSControl typedDst = (ESSControl) destination;
        ESSControl typedSrc = (ESSControl) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSControlKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(0, (255)+1);
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SetPointListTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSControlKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        ...
        Object sample) 
    {
        ...
        ESSControl typedSrc = (ESSControl) sample;
        ...
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.issueID != null) {

            currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.issueID );
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSControlKindTypeSupport.get_instance().get_serialized_sample_size(
        ...
        if (typedSrc.setPointList != null) {
            ...
            currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SetPointListTypeSupport.get_instance().get_serialized_sample_size(
                endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.setPointList);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            if (typedSrc.scheduledInterval != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.DateTimeIntervalTypeSupport.get_instance().serialize(endpoint_data, typedSrc.scheduledInterval, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ESSControlKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            ...
            if (typedSrc.setPointList != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.SetPointListTypeSupport.get_instance().serialize(endpoint_data, typedSrc.setPointList, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ESSControl typedDst = (ESSControl) dst;
            typedDst.clear();      
            try{
                ...
                src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
                if (tmpLength > 0) {
                    if (typedDst.scheduledInterval == null) {
                    ...
                    typedDst.scheduledInterval = (OpenFMB_Information_Model.openfmb.commonmodule.DateTimeInterval)OpenFMB_Information_Model.openfmb.commonmodule.DateTimeIntervalTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.scheduledInterval, src, false, true, endpoint_plugin_qos);     
                }
                else {
                ...
                typedDst.type = (OpenFMB_Information_Model.openfmb.commonmodule.ESSControlKind)OpenFMB_Information_Model.openfmb.commonmodule.ESSControlKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);     
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.setPointList = (OpenFMB_Information_Model.openfmb.commonmodule.SetPointList)OpenFMB_Information_Model.openfmb.commonmodule.SetPointListTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.setPointList, src, false, true, endpoint_plugin_qos);     
                }
                else {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ESSControlKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            ...
            src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
            if (tmpLength > 0) {
                OpenFMB_Information_Model.openfmb.commonmodule.SetPointListTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
            src.getBuffer().setDesBufferSize(tmpSize);
            src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ESSControl typedDst = (ESSControl) sample;
    ...
    protected ESSControlTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ESSControlTypeCode.VALUE,ESSControl.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ESSControlTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ESSControlTypeCode.VALUE,ESSControl.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
