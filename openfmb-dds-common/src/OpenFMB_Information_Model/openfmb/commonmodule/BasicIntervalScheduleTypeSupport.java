...
public class BasicIntervalScheduleTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::BasicIntervalSchedule";
    ...
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            memberLengthPosition = dst.writeMemberId((short)memberId);
            if (typedSrc.value1Multiplier != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.UnitMultiplierKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.value1Multiplier, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            dst.writeMemberLength(memberLengthPosition, false);
            ...
            memberLengthPosition = dst.writeMemberId((short)memberId);
            if (typedSrc.value1Unit != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.UnitSymbolKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.value1Unit, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            dst.writeMemberLength(memberLengthPosition, false);
            ...
            memberLengthPosition = dst.writeMemberId((short)memberId);
            if (typedSrc.value2Multiplier != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.UnitMultiplierKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.value2Multiplier, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            dst.writeMemberLength(memberLengthPosition, false);
            ...
            memberLengthPosition = dst.writeMemberId((short)memberId);
            if (typedSrc.value2Unit != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.UnitSymbolKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.value2Unit, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            dst.writeMemberLength(memberLengthPosition, false);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
                if (tmpLength > 0) {
                    if (typedDst.value1Multiplier == null) {
                    ...
                    typedDst.value1Multiplier = (OpenFMB_Information_Model.openfmb.commonmodule.UnitMultiplierKind)OpenFMB_Information_Model.openfmb.commonmodule.UnitMultiplierKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.value1Multiplier, src, false, true, endpoint_plugin_qos);     
                }
                else {
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.value1Unit = (OpenFMB_Information_Model.openfmb.commonmodule.UnitSymbolKind)OpenFMB_Information_Model.openfmb.commonmodule.UnitSymbolKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.value1Unit, src, false, true, endpoint_plugin_qos);     
                }
                else {
                ...
                src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
                if (tmpLength > 0) {
                    if (typedDst.value2Multiplier == null) {
                        typedDst.value2Multiplier = 
                        (OpenFMB_Information_Model.openfmb.commonmodule.UnitMultiplierKind) OpenFMB_Information_Model.openfmb.commonmodule.UnitMultiplierKind.create();
                    }

                    typedDst.value2Multiplier = (OpenFMB_Information_Model.openfmb.commonmodule.UnitMultiplierKind)OpenFMB_Information_Model.openfmb.commonmodule.UnitMultiplierKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.value2Multiplier, src, false, true, endpoint_plugin_qos);     
                }
                else {
                ...
                src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
                if (tmpLength > 0) {
                    if (typedDst.value2Unit == null) {
                        typedDst.value2Unit = 
                        (OpenFMB_Information_Model.openfmb.commonmodule.UnitSymbolKind) OpenFMB_Information_Model.openfmb.commonmodule.UnitSymbolKind.create();
                    }

                    typedDst.value2Unit = (OpenFMB_Information_Model.openfmb.commonmodule.UnitSymbolKind)OpenFMB_Information_Model.openfmb.commonmodule.UnitSymbolKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.value2Unit, src, false, true, endpoint_plugin_qos);     
                }
                else {
