...
public class RecloserReadingListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::RecloserReadingList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RecloserReadingListTypeSupport _singleton
    = new RecloserReadingListTypeSupport();
    ...
    */
    public static RecloserReadingListTypeSupport get_instance() {
        return _singleton;
    }

    public static RecloserReadingListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RecloserReadingListTypeCode.VALUE;
    }

    public Object create_data() {
        return RecloserReadingList.create();
    }
    ...
    public Object create_key() {
        return new RecloserReadingList();
    }
    ...
    public Class get_type() {
        return RecloserReadingList.class;
    }
    ...
    * <code>this</code> is not a <code>RecloserReadingList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RecloserReadingList typedDst = (RecloserReadingList) destination;
        RecloserReadingList typedSrc = (RecloserReadingList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RecloserReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RecloserReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        RecloserReadingList typedSrc = (RecloserReadingList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RecloserReadingTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.recloserReading);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RecloserReadingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.recloserReading,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RecloserReadingList typedDst = (RecloserReadingList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.RecloserReadingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.recloserReading, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RecloserReadingTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RecloserReadingList typedDst = (RecloserReadingList) sample;
    ...
    protected RecloserReadingListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RecloserReadingListTypeCode.VALUE,RecloserReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RecloserReadingListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RecloserReadingListTypeCode.VALUE,RecloserReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
