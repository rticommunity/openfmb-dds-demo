...
public class ESSEventProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::essmodule::ESSEventProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ESSEventProfileTypeSupport _singleton
    = new ESSEventProfileTypeSupport();
    ...
    */
    public static ESSEventProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static ESSEventProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ESSEventProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return ESSEventProfile.create();
    }
    ...
    * <code>this</code> is not a <code>ESSEventProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ESSEventProfile typedDst = (ESSEventProfile) destination;
        ESSEventProfile typedSrc = (ESSEventProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSEventTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSEventTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        ESSEventProfile typedSrc = (ESSEventProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSEventTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.essEvent);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ESSEventTypeSupport.get_instance().serialize(endpoint_data, typedSrc.essEvent, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ESSEventProfile typedDst = (ESSEventProfile) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.essEvent = (OpenFMB_Information_Model.openfmb.commonmodule.ESSEvent)OpenFMB_Information_Model.openfmb.commonmodule.ESSEventTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.essEvent, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ESSEventTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ESSEventProfile typedDst = (ESSEventProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        ESSEventProfile typedDst
        = (ESSEventProfile) instance;
        ESSEventProfile typedSrc
        = (ESSEventProfile) key;
    ...
    */
    ...
    int mask) {
        return new ESSEventProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ESSEventProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected ESSEventProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ESSEventProfileTypeCode.VALUE,ESSEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ESSEventProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ESSEventProfileTypeCode.VALUE,ESSEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
