...
public class PlannedInterconnectionScheduleProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::interconnectionmodule::PlannedInterconnectionScheduleProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PlannedInterconnectionScheduleProfileTypeSupport _singleton
    = new PlannedInterconnectionScheduleProfileTypeSupport();
    ...
    */
    public static PlannedInterconnectionScheduleProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static PlannedInterconnectionScheduleProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PlannedInterconnectionScheduleProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return PlannedInterconnectionScheduleProfile.create();
    }
    ...
    public Object create_key() {
        return new PlannedInterconnectionScheduleProfile();
    }
    ...
    public Class get_type() {
        return PlannedInterconnectionScheduleProfile.class;
    }
    ...
    * <code>this</code> is not a <code>PlannedInterconnectionScheduleProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PlannedInterconnectionScheduleProfile typedDst = (PlannedInterconnectionScheduleProfile) destination;
        PlannedInterconnectionScheduleProfile typedSrc = (PlannedInterconnectionScheduleProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionPointTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionScheduleListTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionPointTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionScheduleListTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        PlannedInterconnectionScheduleProfile typedSrc = (PlannedInterconnectionScheduleProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionPointTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.interconnectionPoint);

        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionScheduleListTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.interconnectionScheduleList);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionPointTypeSupport.get_instance().serialize(endpoint_data, typedSrc.interconnectionPoint, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionScheduleListTypeSupport.get_instance().serialize(endpoint_data, typedSrc.interconnectionScheduleList, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        PlannedInterconnectionScheduleProfile src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PlannedInterconnectionScheduleProfile typedDst = (PlannedInterconnectionScheduleProfile) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.interconnectionPoint = (OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionPoint)OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionPointTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.interconnectionPoint, src, false, true, endpoint_plugin_qos);     
                typedDst.interconnectionScheduleList = (OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionScheduleList)OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionScheduleListTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.interconnectionScheduleList, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        PlannedInterconnectionScheduleProfile dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        PlannedInterconnectionScheduleProfile sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionPointTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionScheduleListTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PlannedInterconnectionScheduleProfile typedDst = (PlannedInterconnectionScheduleProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        PlannedInterconnectionScheduleProfile typedDst
        = (PlannedInterconnectionScheduleProfile) instance;
        PlannedInterconnectionScheduleProfile typedSrc
        = (PlannedInterconnectionScheduleProfile) key;
    ...
    */
    ...
    int mask) {
        return new PlannedInterconnectionScheduleProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new PlannedInterconnectionScheduleProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected PlannedInterconnectionScheduleProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,PlannedInterconnectionScheduleProfileTypeCode.VALUE,PlannedInterconnectionScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PlannedInterconnectionScheduleProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PlannedInterconnectionScheduleProfileTypeCode.VALUE,PlannedInterconnectionScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
