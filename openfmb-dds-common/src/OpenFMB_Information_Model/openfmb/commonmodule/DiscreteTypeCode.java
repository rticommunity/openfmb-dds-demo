...
public class  DiscreteTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("discreteMeasurementValue", false, (short)-1,  false,(TypeCode) OpenFMB_Information_Model.openfmb.commonmodule.DiscreteValueTypeCode.VALUE,7 , false);__i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("OpenFMB_Information_Model::openfmb::commonmodule::Discrete",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
