...
public class MarketRunListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::MarketRunList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MarketRunListTypeSupport _singleton
    = new MarketRunListTypeSupport();
    ...
    */
    public static MarketRunListTypeSupport get_instance() {
        return _singleton;
    }

    public static MarketRunListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MarketRunListTypeCode.VALUE;
    }

    public Object create_data() {
        return MarketRunList.create();
    }
    ...
    * <code>this</code> is not a <code>MarketRunList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MarketRunList typedDst = (MarketRunList) destination;
        MarketRunList typedSrc = (MarketRunList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MarketRunTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MarketRunTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        MarketRunList typedSrc = (MarketRunList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MarketRunTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.marketRun);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MarketRunTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.marketRun,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MarketRunList typedDst = (MarketRunList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.MarketRunTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.marketRun, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MarketRunTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MarketRunList typedDst = (MarketRunList) sample;
    ...
    protected MarketRunListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MarketRunListTypeCode.VALUE,MarketRunList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MarketRunListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MarketRunListTypeCode.VALUE,MarketRunList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
