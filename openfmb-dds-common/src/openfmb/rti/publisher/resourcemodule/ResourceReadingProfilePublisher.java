...
/* ResourceReadingProfilePublisher.java
 * A publication of data of type ResourceReadingProfile
 */
...
public class ResourceReadingProfilePublisher {
	
    public static ResourceReadingProfileDataWriter writer = null;

    // --- Constructors: -----------------------------------------------------

    public ResourceReadingProfilePublisher() {
        super();
    }
    ...
    public void publish(ResourceReadingProfile instance) {
