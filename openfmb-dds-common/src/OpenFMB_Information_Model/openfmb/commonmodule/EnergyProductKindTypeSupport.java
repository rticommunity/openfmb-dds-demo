...
public class EnergyProductKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::EnergyProductKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EnergyProductKindTypeSupport _singleton
    = new EnergyProductKindTypeSupport();
    ...
    */
    public static EnergyProductKindTypeSupport get_instance() {
        return _singleton;
    }

    public static EnergyProductKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EnergyProductKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return EnergyProductKind.class;
    }
    ...
    * <code>this</code> is not a <code>EnergyProductKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        EnergyProductKind typedSrc = (EnergyProductKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = EnergyProductKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected EnergyProductKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,EnergyProductKindTypeCode.VALUE,EnergyProductKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
