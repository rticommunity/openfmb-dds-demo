...
public class MarketFactorsTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::MarketFactors";
    ...
    */
        ...
        Object sample) 
    {
        ...
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.intervalEndTime != null) {
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(epd.getAlignment(currentAlignment), 4) + 4);
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.intervalStartTime != null) {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.intervalStartTime = null;
                }
                src.getBuffer().setDesBufferSize(tmpSize);
                src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
