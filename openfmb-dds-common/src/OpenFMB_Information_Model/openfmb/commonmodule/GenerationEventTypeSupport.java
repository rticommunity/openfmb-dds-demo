...
public class GenerationEventTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::GenerationEvent";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationEventTypeSupport _singleton
    = new GenerationEventTypeSupport();
    ...
    */
    public static GenerationEventTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationEventTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationEventTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>GenerationEvent</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenerationEvent typedDst = (GenerationEvent) destination;
        GenerationEvent typedSrc = (GenerationEvent) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationEventKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationEventKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        ...
        Object sample) 
    {
        ...
        GenerationEvent typedSrc = (GenerationEvent) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationEventKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.GenerationEventKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenerationEvent typedDst = (GenerationEvent) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.type = (OpenFMB_Information_Model.openfmb.commonmodule.GenerationEventKind)OpenFMB_Information_Model.openfmb.commonmodule.GenerationEventKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.GenerationEventKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenerationEvent typedDst = (GenerationEvent) sample;
    ...
    protected GenerationEventTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GenerationEventTypeCode.VALUE,GenerationEvent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenerationEventTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenerationEventTypeCode.VALUE,GenerationEvent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
