...
public class ESSTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ESS";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ESSTypeSupport _singleton
    = new ESSTypeSupport();
    ...
    */
    public static ESSTypeSupport get_instance() {
        return _singleton;
    }

    public static ESSTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ESSTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ESS</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ESS typedDst = (ESS) destination;
        ESS typedSrc = (ESS) source;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByte(typedSrc.__dummy_prevent_empty_class_ESS);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                typedDst.__dummy_prevent_empty_class_ESS = src.readByte();
    ...
    protected ESSTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ESSTypeCode.VALUE,ESS.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ESSTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ESSTypeCode.VALUE,ESS.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
