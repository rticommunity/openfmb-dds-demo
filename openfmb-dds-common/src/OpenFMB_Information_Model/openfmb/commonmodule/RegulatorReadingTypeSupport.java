...
public class RegulatorReadingTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::RegulatorReading";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RegulatorReadingTypeSupport _singleton
    = new RegulatorReadingTypeSupport();
    ...
    */
    public static RegulatorReadingTypeSupport get_instance() {
        return _singleton;
    }

    public static RegulatorReadingTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RegulatorReadingTypeCode.VALUE;
    }

    public Object create_data() {
        return RegulatorReading.create();
    }
    ...
    * <code>this</code> is not a <code>RegulatorReading</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RegulatorReading typedDst = (RegulatorReading) destination;
        RegulatorReading typedSrc = (RegulatorReading) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingTypeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingTypeKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        RegulatorReading typedSrc = (RegulatorReading) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingTypeKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingTypeKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RegulatorReading typedDst = (RegulatorReading) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.type = (OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingTypeKind)OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingTypeKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingTypeKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RegulatorReading typedDst = (RegulatorReading) sample;
    ...
    protected RegulatorReadingTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RegulatorReadingTypeCode.VALUE,RegulatorReading.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RegulatorReadingTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RegulatorReadingTypeCode.VALUE,RegulatorReading.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
