...
* ShuntReadingTypeKind
*/

public class ShuntReadingTypeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ShuntReadingTypeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShuntReadingTypeKindTypeSupport _singleton
    = new ShuntReadingTypeKindTypeSupport();
    ...
    */
    public static ShuntReadingTypeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ShuntReadingTypeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShuntReadingTypeKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return ShuntReadingTypeKind.class;
    }
    ...
    * <code>this</code> is not a <code>ShuntReadingTypeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        ShuntReadingTypeKind typedSrc = (ShuntReadingTypeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ShuntReadingTypeKind.valueOf(ordinal);
            if (dst == null) {
                ...
                if (ap.acceptUnknownEnumValue) {
                    dst = ShuntReadingTypeKind.valueOf(
                        2);
                } else {
    ...
    protected ShuntReadingTypeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShuntReadingTypeKindTypeCode.VALUE,ShuntReadingTypeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
