...
* MotorOperatedSwitchReadingTypeKind
*/

public class MotorOperatedSwitchReadingTypeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::MotorOperatedSwitchReadingTypeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MotorOperatedSwitchReadingTypeKindTypeSupport _singleton
    = new MotorOperatedSwitchReadingTypeKindTypeSupport();
    ...
    */
    public static MotorOperatedSwitchReadingTypeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static MotorOperatedSwitchReadingTypeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MotorOperatedSwitchReadingTypeKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return MotorOperatedSwitchReadingTypeKind.class;
    }
    ...
    * <code>this</code> is not a <code>MotorOperatedSwitchReadingTypeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        MotorOperatedSwitchReadingTypeKind typedSrc = (MotorOperatedSwitchReadingTypeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = MotorOperatedSwitchReadingTypeKind.valueOf(ordinal);
            if (dst == null) {
                ...
                if (ap.acceptUnknownEnumValue) {
                    dst = MotorOperatedSwitchReadingTypeKind.valueOf(
                        2);
                } else {
    ...
    protected MotorOperatedSwitchReadingTypeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MotorOperatedSwitchReadingTypeKindTypeCode.VALUE,MotorOperatedSwitchReadingTypeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
