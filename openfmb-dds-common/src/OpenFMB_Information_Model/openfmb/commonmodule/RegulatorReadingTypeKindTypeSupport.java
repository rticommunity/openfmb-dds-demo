...
* RegulatorReadingTypeKind
*/

public class RegulatorReadingTypeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::RegulatorReadingTypeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RegulatorReadingTypeKindTypeSupport _singleton
    = new RegulatorReadingTypeKindTypeSupport();
    ...
    */
    public static RegulatorReadingTypeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static RegulatorReadingTypeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RegulatorReadingTypeKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return RegulatorReadingTypeKind.class;
    }
    ...
    * <code>this</code> is not a <code>RegulatorReadingTypeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        RegulatorReadingTypeKind typedSrc = (RegulatorReadingTypeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = RegulatorReadingTypeKind.valueOf(ordinal);
            if (dst == null) {
                ...
                if (ap.acceptUnknownEnumValue) {
                    dst = RegulatorReadingTypeKind.valueOf(
                        2);
                } else {
    ...
    protected RegulatorReadingTypeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RegulatorReadingTypeKindTypeCode.VALUE,RegulatorReadingTypeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
