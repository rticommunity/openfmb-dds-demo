...
public class LoadControlScheduleProfileListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::optimizermodule::LoadControlScheduleProfileList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LoadControlScheduleProfileListTypeSupport _singleton
    = new LoadControlScheduleProfileListTypeSupport();
    ...
    */
    public static LoadControlScheduleProfileListTypeSupport get_instance() {
        return _singleton;
    }

    public static LoadControlScheduleProfileListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LoadControlScheduleProfileListTypeCode.VALUE;
    }

    public Object create_data() {
        return LoadControlScheduleProfileList.create();
    }
    ...
    public Object create_key() {
        return new LoadControlScheduleProfileList();
    }
    ...
    public Class get_type() {
        return LoadControlScheduleProfileList.class;
    }
    ...
    * <code>this</code> is not a <code>LoadControlScheduleProfileList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LoadControlScheduleProfileList typedDst = (LoadControlScheduleProfileList) destination;
        LoadControlScheduleProfileList typedSrc = (LoadControlScheduleProfileList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.loadmodule.LoadControlScheduleProfileTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.loadmodule.LoadControlScheduleProfileTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        LoadControlScheduleProfileList typedSrc = (LoadControlScheduleProfileList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.loadmodule.LoadControlScheduleProfileTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.loadControlScheduleProfile);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.loadmodule.LoadControlScheduleProfileTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.loadControlScheduleProfile,100, endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        LoadControlScheduleProfileList src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LoadControlScheduleProfileList typedDst = (LoadControlScheduleProfileList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.loadmodule.LoadControlScheduleProfileTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.loadControlScheduleProfile, src, 100, endpoint_plugin_qos);            
    ...
    public void deserialize_from_cdr_buffer(
        LoadControlScheduleProfileList dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        LoadControlScheduleProfileList sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.loadmodule.LoadControlScheduleProfileTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LoadControlScheduleProfileList typedDst = (LoadControlScheduleProfileList) sample;
    ...
    protected LoadControlScheduleProfileListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LoadControlScheduleProfileListTypeCode.VALUE,LoadControlScheduleProfileList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LoadControlScheduleProfileListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LoadControlScheduleProfileListTypeCode.VALUE,LoadControlScheduleProfileList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
