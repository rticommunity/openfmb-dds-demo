...
public class MotorOperatedSwitchControl   implements Copyable, Serializable{

    public String name= null; /* maximum length = (255) */
    public OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlKind type = (OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlKind)OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlKind.create();
    ...
    public MotorOperatedSwitchControl() {

    }
    public MotorOperatedSwitchControl (MotorOperatedSwitchControl other) {
    ...
    public static Object create() {
        ...
        MotorOperatedSwitchControl self;
        self = new  MotorOperatedSwitchControl();
        self.clear();
        return self;
    ...
    public void clear() {
        ...
        name=null; 
        type = OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlKind.create();
        issueID=null; 
    ...
    public boolean equals(Object o) {
        ...
        MotorOperatedSwitchControl otherObj = (MotorOperatedSwitchControl)o;
    ...
    * This method could be placed into <code>MotorOperatedSwitchControlTypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        MotorOperatedSwitchControl typedSrc = (MotorOperatedSwitchControl) src;
        MotorOperatedSwitchControl typedDst = this;

        typedDst.name = typedSrc.name;
        typedDst.type = (OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlKind) typedDst.type.copy_from(typedSrc.type);
