...
/**
* A sequence of Analog instances.
*/
public final class AnalogSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public AnalogSeq (int initialMaximum) {
        super(Analog.class, initialMaximum);
    }

    public AnalogSeq (Collection elements) {
        super(Analog.class, elements);
    }

    public  Analog get(int index) { 
        return (Analog) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Analog objects (beyond the original size of this object)
