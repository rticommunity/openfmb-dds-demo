...
public class MotorOperatedSwitchControlTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::MotorOperatedSwitchControl";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MotorOperatedSwitchControlTypeSupport _singleton
    = new MotorOperatedSwitchControlTypeSupport();
    ...
    */
    public static MotorOperatedSwitchControlTypeSupport get_instance() {
        return _singleton;
    }

    public static MotorOperatedSwitchControlTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MotorOperatedSwitchControlTypeCode.VALUE;
    }

    public Object create_data() {
        return MotorOperatedSwitchControl.create();
    }
    ...
    public Object create_key() {
        return new MotorOperatedSwitchControl();
    }
    ...
    public Class get_type() {
        return MotorOperatedSwitchControl.class;
    }
    ...
    * <code>this</code> is not a <code>MotorOperatedSwitchControl</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MotorOperatedSwitchControl typedDst = (MotorOperatedSwitchControl) destination;
        MotorOperatedSwitchControl typedSrc = (MotorOperatedSwitchControl) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(0, (255)+1);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        ...
        Object sample) 
    {
        ...
        MotorOperatedSwitchControl typedSrc = (MotorOperatedSwitchControl) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        MotorOperatedSwitchControl src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MotorOperatedSwitchControl typedDst = (MotorOperatedSwitchControl) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.type = (OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlKind)OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        MotorOperatedSwitchControl dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        MotorOperatedSwitchControl sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MotorOperatedSwitchControl typedDst = (MotorOperatedSwitchControl) sample;
    ...
    protected MotorOperatedSwitchControlTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MotorOperatedSwitchControlTypeCode.VALUE,MotorOperatedSwitchControl.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MotorOperatedSwitchControlTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MotorOperatedSwitchControlTypeCode.VALUE,MotorOperatedSwitchControl.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
