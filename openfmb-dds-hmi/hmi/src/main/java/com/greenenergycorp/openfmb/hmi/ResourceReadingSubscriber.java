...
public class ResourceReadingSubscriber implements ResourceReadingProfileEventUpdate {
	...
	public ResourceReadingSubscriber(StateManager machine, int domainId, String topicName, String qosLibrary, String qosProfile) {
	...
	public void update(ResourceReadingProfile data) {
    	...
    	machine.updateLoadPower(data.logicalDeviceID, power);
   }
