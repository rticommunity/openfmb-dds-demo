...
/* LoadReadingProfileSubscriber.java */
...
import OpenFMB_Information_Model.openfmb.loadmodule.LoadReadingProfileDataReader;
import OpenFMB_Information_Model.openfmb.loadmodule.LoadReadingProfileSeq;
import OpenFMB_Information_Model.openfmb.loadmodule.LoadReadingProfileTypeSupport;


// ===========================================================================

public class LoadReadingProfileSubscriber {

        private LoadReadingProfileEventUpdate ie;

    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------

    public LoadReadingProfileSubscriber(LoadReadingProfileEventUpdate update) {
        ie = update;
    ...
    public int initialize (int domainId, String topicName, String QoSLibrary, String QoSProfile) {
        ...
        LoadReadingProfileDataReader reader = null;
        ...
        try {
            ...
            listener = new LoadReadingProfileListener();

            reader = (LoadReadingProfileDataReader)
    ...
    public class LoadReadingProfileListener extends DataReaderAdapter {

        LoadReadingProfileSeq _dataSeq = new LoadReadingProfileSeq();
        SampleInfoSeq _infoSeq = new SampleInfoSeq();
        
        
 
        public void on_data_available(DataReader reader) {
            LoadReadingProfileDataReader LoadReadingProfileReader =
            (LoadReadingProfileDataReader)reader;
            
            try {
                LoadReadingProfileReader.take(
                    _dataSeq, _infoSeq,
                ...
                for(int i = 0; i < _dataSeq.size(); ++i) {
                    ...
                    if (info.valid_data) {
                        ie.update((LoadReadingProfile)_dataSeq.get(i));
                ...
                LoadReadingProfileReader.return_loan(_dataSeq, _infoSeq);
            }
        }
    }
