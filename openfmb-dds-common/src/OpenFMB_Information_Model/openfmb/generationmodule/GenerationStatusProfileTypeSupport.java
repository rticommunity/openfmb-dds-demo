...
public class GenerationStatusProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::generationmodule::GenerationStatusProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationStatusProfileTypeSupport _singleton
    = new GenerationStatusProfileTypeSupport();
    ...
    */
    public static GenerationStatusProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationStatusProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationStatusProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return GenerationStatusProfile.create();
    }
    ...
    public Object create_key() {
        return new GenerationStatusProfile();
    }
    ...
    public Class get_type() {
        return GenerationStatusProfile.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationStatusProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenerationStatusProfile typedDst = (GenerationStatusProfile) destination;
        GenerationStatusProfile typedSrc = (GenerationStatusProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        GenerationStatusProfile typedSrc = (GenerationStatusProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationStatusTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.GenerationStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.generationStatus, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenerationStatusProfile typedDst = (GenerationStatusProfile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.generationStatus = (OpenFMB_Information_Model.openfmb.commonmodule.GenerationStatus)OpenFMB_Information_Model.openfmb.commonmodule.GenerationStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.generationStatus, src, false, true, endpoint_plugin_qos);     
    ...
    public String data_to_string(
        GenerationStatusProfile sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.GenerationStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenerationStatusProfile typedDst = (GenerationStatusProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GenerationStatusProfile typedDst
        = (GenerationStatusProfile) instance;
        GenerationStatusProfile typedSrc
        = (GenerationStatusProfile) key;
    ...
    */
    ...
    int mask) {
        return new GenerationStatusProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GenerationStatusProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected GenerationStatusProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GenerationStatusProfileTypeCode.VALUE,GenerationStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenerationStatusProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenerationStatusProfileTypeCode.VALUE,GenerationStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
