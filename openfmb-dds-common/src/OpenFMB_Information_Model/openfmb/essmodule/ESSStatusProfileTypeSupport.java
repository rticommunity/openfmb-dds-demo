...
public class ESSStatusProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::essmodule::ESSStatusProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ESSStatusProfileTypeSupport _singleton
    = new ESSStatusProfileTypeSupport();
    ...
    */
    public static ESSStatusProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static ESSStatusProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ESSStatusProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return ESSStatusProfile.create();
    }
    ...
    * <code>this</code> is not a <code>ESSStatusProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ESSStatusProfile typedDst = (ESSStatusProfile) destination;
        ESSStatusProfile typedSrc = (ESSStatusProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        ESSStatusProfile typedSrc = (ESSStatusProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSStatusTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.essStatus);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ESSStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.essStatus, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ESSStatusProfile typedDst = (ESSStatusProfile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.essStatus = (OpenFMB_Information_Model.openfmb.commonmodule.ESSStatus)OpenFMB_Information_Model.openfmb.commonmodule.ESSStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.essStatus, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ESSStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ESSStatusProfile typedDst = (ESSStatusProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        ESSStatusProfile typedDst
        = (ESSStatusProfile) instance;
        ESSStatusProfile typedSrc
        = (ESSStatusProfile) key;
    ...
    */
    ...
    int mask) {
        return new ESSStatusProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ESSStatusProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected ESSStatusProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ESSStatusProfileTypeCode.VALUE,ESSStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ESSStatusProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ESSStatusProfileTypeCode.VALUE,ESSStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
