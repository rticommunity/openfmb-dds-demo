...
public class ESSControlScheduleListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ESSControlScheduleList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ESSControlScheduleListTypeSupport _singleton
    = new ESSControlScheduleListTypeSupport();
    ...
    */
    public static ESSControlScheduleListTypeSupport get_instance() {
        return _singleton;
    }

    public static ESSControlScheduleListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ESSControlScheduleListTypeCode.VALUE;
    }

    public Object create_data() {
        return ESSControlScheduleList.create();
    }
    ...
    public Object create_key() {
        return new ESSControlScheduleList();
    }
    ...
    public Class get_type() {
        return ESSControlScheduleList.class;
    }
    ...
    * <code>this</code> is not a <code>ESSControlScheduleList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ESSControlScheduleList typedDst = (ESSControlScheduleList) destination;
        ESSControlScheduleList typedSrc = (ESSControlScheduleList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSControlScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSControlScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        ESSControlScheduleList typedSrc = (ESSControlScheduleList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSControlScheduleTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.essControlSchedule);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ESSControlScheduleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.essControlSchedule,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ESSControlScheduleList typedDst = (ESSControlScheduleList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.ESSControlScheduleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.essControlSchedule, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ESSControlScheduleTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ESSControlScheduleList typedDst = (ESSControlScheduleList) sample;
    ...
    protected ESSControlScheduleListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ESSControlScheduleListTypeCode.VALUE,ESSControlScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ESSControlScheduleListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ESSControlScheduleListTypeCode.VALUE,ESSControlScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
