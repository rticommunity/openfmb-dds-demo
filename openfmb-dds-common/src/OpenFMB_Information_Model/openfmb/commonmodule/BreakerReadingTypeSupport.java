...
public class BreakerReadingTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::BreakerReading";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BreakerReadingTypeSupport _singleton
    = new BreakerReadingTypeSupport();
    ...
    */
    public static BreakerReadingTypeSupport get_instance() {
        return _singleton;
    }

    public static BreakerReadingTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BreakerReadingTypeCode.VALUE;
    }

    public Object create_data() {
        return BreakerReading.create();
    }
    ...
    * <code>this</code> is not a <code>BreakerReading</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BreakerReading typedDst = (BreakerReading) destination;
        BreakerReading typedSrc = (BreakerReading) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingTypeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(0, (255)+1);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingTypeKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        ...
        Object sample) 
    {
        ...
        BreakerReading typedSrc = (BreakerReading) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingTypeKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingTypeKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BreakerReading typedDst = (BreakerReading) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.type = (OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingTypeKind)OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingTypeKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingTypeKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BreakerReading typedDst = (BreakerReading) sample;
    ...
    protected BreakerReadingTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BreakerReadingTypeCode.VALUE,BreakerReading.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BreakerReadingTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BreakerReadingTypeCode.VALUE,BreakerReading.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
