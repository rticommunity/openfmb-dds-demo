...
/**
* A sequence of ESSControlKind instances.
*/
public final class ESSControlKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ESSControlKindSeq() {
        super(ESSControlKind.class);
    }

    public ESSControlKindSeq (int initialMaximum) {
        super(ESSControlKind.class, initialMaximum);
    }

    public ESSControlKindSeq (Collection elements) {
        super(ESSControlKind.class, elements);
    }

    public  ESSControlKind get(int index) { 
        return (ESSControlKind) super.get(index); 
    }
