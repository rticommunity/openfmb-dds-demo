...
/**
* A sequence of ESSStatusProfile instances.
*/
public final class ESSStatusProfileSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ESSStatusProfileSeq() {
        super(ESSStatusProfile.class);
    }

    public ESSStatusProfileSeq (int initialMaximum) {
        super(ESSStatusProfile.class, initialMaximum);
    }

    public ESSStatusProfileSeq (Collection elements) {
        super(ESSStatusProfile.class, elements);
    }

    public  ESSStatusProfile get(int index) { 
        return (ESSStatusProfile) super.get(index); 
    }
