...
/**
* A sequence of SwitchEventKind instances.
*/
public final class SwitchEventKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SwitchEventKindSeq() {
        super(SwitchEventKind.class);
    }

    public SwitchEventKindSeq (int initialMaximum) {
        super(SwitchEventKind.class, initialMaximum);
    }

    public SwitchEventKindSeq (Collection elements) {
        super(SwitchEventKind.class, elements);
    }

    public  SwitchEventKind get(int index) { 
        return (SwitchEventKind) super.get(index); 
    }
