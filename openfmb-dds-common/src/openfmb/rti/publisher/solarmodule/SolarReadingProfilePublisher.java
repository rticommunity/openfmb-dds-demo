...
/* SolarReadingProfilePublisher.java
 * A publication of data of type SolarReadingProfile
 */
...
import OpenFMB_Information_Model.openfmb.solarmodule.SolarReadingProfileDataWriter;
import OpenFMB_Information_Model.openfmb.solarmodule.SolarReadingProfileTypeSupport;

// ===========================================================================

public class SolarReadingProfilePublisher {
	
    public static SolarReadingProfileDataWriter writer = null;

    // --- Constructors: -----------------------------------------------------

    public SolarReadingProfilePublisher() {
        super();
    }
    ...
    public int initialize(int domainId, String  topicName, String QoSLibrary, String QoSProfile) {
        ...
        try {
            ...
            writer = (SolarReadingProfileDataWriter)
    ...
    public void publish(SolarReadingProfile instance) {
