...
public class RegulatorControlScheduleProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::regulatormodule::RegulatorControlScheduleProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RegulatorControlScheduleProfileTypeSupport _singleton
    = new RegulatorControlScheduleProfileTypeSupport();
    ...
    */
    public static RegulatorControlScheduleProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static RegulatorControlScheduleProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RegulatorControlScheduleProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return RegulatorControlScheduleProfile.create();
    }
    ...
    public Object create_key() {
        return new RegulatorControlScheduleProfile();
    }
    ...
    public Class get_type() {
        return RegulatorControlScheduleProfile.class;
    }
    ...
    * <code>this</code> is not a <code>RegulatorControlScheduleProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RegulatorControlScheduleProfile typedDst = (RegulatorControlScheduleProfile) destination;
        RegulatorControlScheduleProfile typedSrc = (RegulatorControlScheduleProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorControlScheduleListTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorSystemTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorControlScheduleListTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorSystemTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        RegulatorControlScheduleProfile typedSrc = (RegulatorControlScheduleProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorControlScheduleListTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.regulatorControlScheduleList);

        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorSystemTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.regulatorSystem);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorControlScheduleListTypeSupport.get_instance().serialize(endpoint_data, typedSrc.regulatorControlScheduleList, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorSystemTypeSupport.get_instance().serialize(endpoint_data, typedSrc.regulatorSystem, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        RegulatorControlScheduleProfile src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RegulatorControlScheduleProfile typedDst = (RegulatorControlScheduleProfile) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.regulatorControlScheduleList = (OpenFMB_Information_Model.openfmb.commonmodule.RegulatorControlScheduleList)OpenFMB_Information_Model.openfmb.commonmodule.RegulatorControlScheduleListTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.regulatorControlScheduleList, src, false, true, endpoint_plugin_qos);     
                typedDst.regulatorSystem = (OpenFMB_Information_Model.openfmb.commonmodule.RegulatorSystem)OpenFMB_Information_Model.openfmb.commonmodule.RegulatorSystemTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.regulatorSystem, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        RegulatorControlScheduleProfile dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        RegulatorControlScheduleProfile sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorControlScheduleListTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorSystemTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RegulatorControlScheduleProfile typedDst = (RegulatorControlScheduleProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        RegulatorControlScheduleProfile typedDst
        = (RegulatorControlScheduleProfile) instance;
        RegulatorControlScheduleProfile typedSrc
        = (RegulatorControlScheduleProfile) key;
    ...
    */
    ...
    int mask) {
        return new RegulatorControlScheduleProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new RegulatorControlScheduleProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected RegulatorControlScheduleProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,RegulatorControlScheduleProfileTypeCode.VALUE,RegulatorControlScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RegulatorControlScheduleProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RegulatorControlScheduleProfileTypeCode.VALUE,RegulatorControlScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
