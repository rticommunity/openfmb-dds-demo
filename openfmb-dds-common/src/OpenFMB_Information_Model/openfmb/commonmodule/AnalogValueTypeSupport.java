...
public class AnalogValueTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::AnalogValue";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final AnalogValueTypeSupport _singleton
    = new AnalogValueTypeSupport();
    ...
    */
    public static AnalogValueTypeSupport get_instance() {
        return _singleton;
    }

    public static AnalogValueTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return AnalogValueTypeCode.VALUE;
    }

    public Object create_data() {
        return AnalogValue.create();
    }
    ...
    * <code>this</code> is not a <code>AnalogValue</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        AnalogValue typedDst = (AnalogValue) destination;
        AnalogValue typedSrc = (AnalogValue) source;
        ...
        Object sample) 
    {
        ...
        AnalogValue typedSrc = (AnalogValue) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            AnalogValue typedDst = (AnalogValue) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            AnalogValue typedDst = (AnalogValue) sample;
    ...
    protected AnalogValueTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,AnalogValueTypeCode.VALUE,AnalogValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected AnalogValueTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,AnalogValueTypeCode.VALUE,AnalogValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
