...
/**
* A sequence of ShuntControlKind instances.
*/
public final class ShuntControlKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShuntControlKindSeq() {
        super(ShuntControlKind.class);
    }

    public ShuntControlKindSeq (int initialMaximum) {
        super(ShuntControlKind.class, initialMaximum);
    }

    public ShuntControlKindSeq (Collection elements) {
        super(ShuntControlKind.class, elements);
    }

    public  ShuntControlKind get(int index) { 
        return (ShuntControlKind) super.get(index); 
    }
