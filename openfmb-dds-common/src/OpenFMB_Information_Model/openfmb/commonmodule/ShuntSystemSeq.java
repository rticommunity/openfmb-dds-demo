...
/**
* A sequence of ShuntSystem instances.
*/
public final class ShuntSystemSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShuntSystemSeq() {
        super(ShuntSystem.class);
    }

    public ShuntSystemSeq (int initialMaximum) {
        super(ShuntSystem.class, initialMaximum);
    }

    public ShuntSystemSeq (Collection elements) {
        super(ShuntSystem.class, elements);
    }

    public  ShuntSystem get(int index) { 
        return (ShuntSystem) super.get(index); 
    }
