...
public class LoadStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::LoadStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LoadStatusTypeSupport _singleton
    = new LoadStatusTypeSupport();
    ...
    */
    public static LoadStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static LoadStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LoadStatusTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>LoadStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LoadStatus typedDst = (LoadStatus) destination;
        LoadStatus typedSrc = (LoadStatus) source;
        ...
        Object sample) 
    {
        ...
        LoadStatus typedSrc = (LoadStatus) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByte(typedSrc.__dummy_prevent_empty_class_LoadStatus);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LoadStatus typedDst = (LoadStatus) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.__dummy_prevent_empty_class_LoadStatus = src.readByte();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LoadStatus typedDst = (LoadStatus) sample;
    ...
    protected LoadStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LoadStatusTypeCode.VALUE,LoadStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LoadStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LoadStatusTypeCode.VALUE,LoadStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
