...
/**
* A sequence of SolarReadingList instances.
*/
public final class SolarReadingListSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SolarReadingListSeq() {
        super(SolarReadingList.class);
    }

    public SolarReadingListSeq (int initialMaximum) {
        super(SolarReadingList.class, initialMaximum);
    }

    public SolarReadingListSeq (Collection elements) {
        super(SolarReadingList.class, elements);
    }

    public  SolarReadingList get(int index) { 
        return (SolarReadingList) super.get(index); 
    }
