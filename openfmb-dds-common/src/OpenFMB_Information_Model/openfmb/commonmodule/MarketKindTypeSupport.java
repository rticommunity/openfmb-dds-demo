...
public class MarketKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::MarketKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MarketKindTypeSupport _singleton
    = new MarketKindTypeSupport();
    ...
    */
    public static MarketKindTypeSupport get_instance() {
        return _singleton;
    }

    public static MarketKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MarketKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>MarketKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        MarketKind typedSrc = (MarketKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = MarketKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected MarketKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MarketKindTypeCode.VALUE,MarketKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
