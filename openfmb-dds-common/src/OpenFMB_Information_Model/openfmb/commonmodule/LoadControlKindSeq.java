...
/**
* A sequence of LoadControlKind instances.
*/
public final class LoadControlKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LoadControlKindSeq() {
        super(LoadControlKind.class);
    }

    public LoadControlKindSeq (int initialMaximum) {
        super(LoadControlKind.class, initialMaximum);
    }

    public LoadControlKindSeq (Collection elements) {
        super(LoadControlKind.class, elements);
    }

    public  LoadControlKind get(int index) { 
        return (LoadControlKind) super.get(index); 
    }
