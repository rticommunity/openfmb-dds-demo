...
public class ExecutionKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ExecutionKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ExecutionKindTypeSupport _singleton
    = new ExecutionKindTypeSupport();
    ...
    */
    public static ExecutionKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ExecutionKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ExecutionKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ExecutionKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        ExecutionKind typedSrc = (ExecutionKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ExecutionKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ExecutionKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ExecutionKindTypeCode.VALUE,ExecutionKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
