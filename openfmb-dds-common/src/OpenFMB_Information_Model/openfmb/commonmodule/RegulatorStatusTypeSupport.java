...
public class RegulatorStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::RegulatorStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RegulatorStatusTypeSupport _singleton
    = new RegulatorStatusTypeSupport();
    ...
    */
    public static RegulatorStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static RegulatorStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RegulatorStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return RegulatorStatus.create();
    }
    ...
    * <code>this</code> is not a <code>RegulatorStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RegulatorStatus typedDst = (RegulatorStatus) destination;
        RegulatorStatus typedSrc = (RegulatorStatus) source;
        ...
        Object sample) 
    {
        ...
        RegulatorStatus typedSrc = (RegulatorStatus) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByte(typedSrc.__dummy_prevent_empty_class_RegulatorStatus);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RegulatorStatus typedDst = (RegulatorStatus) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.__dummy_prevent_empty_class_RegulatorStatus = src.readByte();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RegulatorStatus typedDst = (RegulatorStatus) sample;
    ...
    protected RegulatorStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RegulatorStatusTypeCode.VALUE,RegulatorStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RegulatorStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RegulatorStatusTypeCode.VALUE,RegulatorStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
