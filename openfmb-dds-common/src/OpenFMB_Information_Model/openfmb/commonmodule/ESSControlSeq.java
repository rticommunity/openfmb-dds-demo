...
/**
* A sequence of ESSControl instances.
*/
public final class ESSControlSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ESSControlSeq() {
        super(ESSControl.class);
    }

    public ESSControlSeq (int initialMaximum) {
        super(ESSControl.class, initialMaximum);
    }

    public ESSControlSeq (Collection elements) {
        super(ESSControl.class, elements);
    }

    public  ESSControl get(int index) { 
        return (ESSControl) super.get(index); 
    }
