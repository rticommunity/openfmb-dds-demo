...
public class BreakerStatusProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::breakermodule::BreakerStatusProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BreakerStatusProfileTypeSupport _singleton
    = new BreakerStatusProfileTypeSupport();
    ...
    */
    public static BreakerStatusProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static BreakerStatusProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BreakerStatusProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return BreakerStatusProfile.create();
    }
    ...
    public Object create_key() {
        return new BreakerStatusProfile();
    }
    ...
    public Class get_type() {
        return BreakerStatusProfile.class;
    }
    ...
    * <code>this</code> is not a <code>BreakerStatusProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BreakerStatusProfile typedDst = (BreakerStatusProfile) destination;
        BreakerStatusProfile typedSrc = (BreakerStatusProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        BreakerStatusProfile typedSrc = (BreakerStatusProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerStatusTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.breakerStatus);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.BreakerStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.breakerStatus, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BreakerStatusProfile typedDst = (BreakerStatusProfile) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.breakerStatus = (OpenFMB_Information_Model.openfmb.commonmodule.BreakerStatus)OpenFMB_Information_Model.openfmb.commonmodule.BreakerStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.breakerStatus, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.BreakerStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BreakerStatusProfile typedDst = (BreakerStatusProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        BreakerStatusProfile typedDst
        = (BreakerStatusProfile) instance;
        BreakerStatusProfile typedSrc
        = (BreakerStatusProfile) key;
    ...
    */
    ...
    int mask) {
        return new BreakerStatusProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BreakerStatusProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected BreakerStatusProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,BreakerStatusProfileTypeCode.VALUE,BreakerStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BreakerStatusProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BreakerStatusProfileTypeCode.VALUE,BreakerStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
