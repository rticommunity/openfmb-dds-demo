...
public class ScheduleTypeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ScheduleTypeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ScheduleTypeKindTypeSupport _singleton
    = new ScheduleTypeKindTypeSupport();
    ...
    */
    public static ScheduleTypeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ScheduleTypeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ScheduleTypeKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ScheduleTypeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        ScheduleTypeKind typedSrc = (ScheduleTypeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ScheduleTypeKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ScheduleTypeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ScheduleTypeKindTypeCode.VALUE,ScheduleTypeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
