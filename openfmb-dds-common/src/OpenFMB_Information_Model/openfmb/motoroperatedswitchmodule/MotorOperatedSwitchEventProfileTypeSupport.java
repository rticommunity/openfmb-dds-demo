...
public class MotorOperatedSwitchEventProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::motoroperatedswitchmodule::MotorOperatedSwitchEventProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MotorOperatedSwitchEventProfileTypeSupport _singleton
    = new MotorOperatedSwitchEventProfileTypeSupport();
    ...
    */
    public static MotorOperatedSwitchEventProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static MotorOperatedSwitchEventProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MotorOperatedSwitchEventProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return MotorOperatedSwitchEventProfile.create();
    }
    ...
    public Object create_key() {
        return new MotorOperatedSwitchEventProfile();
    }
    ...
    public Class get_type() {
        return MotorOperatedSwitchEventProfile.class;
    }
    ...
    * <code>this</code> is not a <code>MotorOperatedSwitchEventProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MotorOperatedSwitchEventProfile typedDst = (MotorOperatedSwitchEventProfile) destination;
        MotorOperatedSwitchEventProfile typedSrc = (MotorOperatedSwitchEventProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchEventTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchEventTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        MotorOperatedSwitchEventProfile typedSrc = (MotorOperatedSwitchEventProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchEventTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.motorOperatedSwitchEvent);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchEventTypeSupport.get_instance().serialize(endpoint_data, typedSrc.motorOperatedSwitchEvent, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        MotorOperatedSwitchEventProfile src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MotorOperatedSwitchEventProfile typedDst = (MotorOperatedSwitchEventProfile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.motorOperatedSwitchEvent = (OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchEvent)OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchEventTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.motorOperatedSwitchEvent, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        MotorOperatedSwitchEventProfile dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        MotorOperatedSwitchEventProfile sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchEventTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MotorOperatedSwitchEventProfile typedDst = (MotorOperatedSwitchEventProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        MotorOperatedSwitchEventProfile typedDst
        = (MotorOperatedSwitchEventProfile) instance;
        MotorOperatedSwitchEventProfile typedSrc
        = (MotorOperatedSwitchEventProfile) key;
    ...
    */
    ...
    int mask) {
        return new MotorOperatedSwitchEventProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MotorOperatedSwitchEventProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected MotorOperatedSwitchEventProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,MotorOperatedSwitchEventProfileTypeCode.VALUE,MotorOperatedSwitchEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MotorOperatedSwitchEventProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MotorOperatedSwitchEventProfileTypeCode.VALUE,MotorOperatedSwitchEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
