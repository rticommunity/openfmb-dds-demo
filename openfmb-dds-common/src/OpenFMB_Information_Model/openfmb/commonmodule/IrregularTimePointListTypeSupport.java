...
public class IrregularTimePointListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::IrregularTimePointList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final IrregularTimePointListTypeSupport _singleton
    = new IrregularTimePointListTypeSupport();
    ...
    */
    public static IrregularTimePointListTypeSupport get_instance() {
        return _singleton;
    }

    public static IrregularTimePointListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return IrregularTimePointListTypeCode.VALUE;
    }

    public Object create_data() {
        return IrregularTimePointList.create();
    }
    ...
    public Object create_key() {
        return new IrregularTimePointList();
    }
    ...
    public Class get_type() {
        return IrregularTimePointList.class;
    }
    ...
    * <code>this</code> is not a <code>IrregularTimePointList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        IrregularTimePointList typedDst = (IrregularTimePointList) destination;
        IrregularTimePointList typedSrc = (IrregularTimePointList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.IrregularTimePointTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.IrregularTimePointTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        IrregularTimePointList typedSrc = (IrregularTimePointList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.IrregularTimePointTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.irregularTimePoint);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.IrregularTimePointTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.irregularTimePoint,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            IrregularTimePointList typedDst = (IrregularTimePointList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.IrregularTimePointTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.irregularTimePoint, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.IrregularTimePointTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            IrregularTimePointList typedDst = (IrregularTimePointList) sample;
    ...
    protected IrregularTimePointListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,IrregularTimePointListTypeCode.VALUE,IrregularTimePointList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected IrregularTimePointListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,IrregularTimePointListTypeCode.VALUE,IrregularTimePointList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
