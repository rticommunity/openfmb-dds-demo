...
public class MarketRunTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::MarketRun";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ExecutionKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MarketKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        ...
        Object sample) 
    {
        ...
        if (typedSrc.executionType != null) {
            ...
            currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ExecutionKindTypeSupport.get_instance().get_serialized_sample_size(
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(epd.getAlignment(currentAlignment), 4) + 4);
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.marketEndTime != null) {
        ...
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.marketID != null) {

            currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.marketID );

            currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        }
        currentAlignment += (CdrPrimitiveType.getPadSize(epd.getAlignment(currentAlignment), 4) + 12);
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.marketRunID != null) {

            currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.marketRunID );

            currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        }
        currentAlignment += (CdrPrimitiveType.getPadSize(epd.getAlignment(currentAlignment), 4) + 4);
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.marketStartTime != null) {
        ...
        if (typedSrc.marketType != null) {
            ...
            currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MarketKindTypeSupport.get_instance().get_serialized_sample_size(
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(epd.getAlignment(currentAlignment), 4) + 12);
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.marketTypeExtension != null) {

            currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.marketTypeExtension );

            currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        }
        currentAlignment += (CdrPrimitiveType.getPadSize(epd.getAlignment(currentAlignment), 4) + 12);
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.executionTypeExtension != null) {

            currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.executionTypeExtension );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            if (typedSrc.executionType != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.ExecutionKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.executionType, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            ...
            memberLengthPosition = dst.writeMemberId((short)memberId);
            if (typedSrc.marketType != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.MarketKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.marketType, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            dst.writeMemberLength(memberLengthPosition, false);
            ...
            if (typedSrc.marketTypeExtension != null) {
                dst.writeString(typedSrc.marketTypeExtension,255);
            }
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
            ...
            if (typedSrc.executionTypeExtension != null) {
                dst.writeString(typedSrc.executionTypeExtension,255);
            }
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                if (tmpLength > 0) {
                    if (typedDst.executionType == null) {
                    ...
                    typedDst.executionType = (OpenFMB_Information_Model.openfmb.commonmodule.ExecutionKind)OpenFMB_Information_Model.openfmb.commonmodule.ExecutionKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.executionType, src, false, true, endpoint_plugin_qos);     
                }
                else {
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.marketType = (OpenFMB_Information_Model.openfmb.commonmodule.MarketKind)OpenFMB_Information_Model.openfmb.commonmodule.MarketKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.marketType, src, false, true, endpoint_plugin_qos);     
                }
                else {
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.marketTypeExtension = src.readString(255);
                }
                else {
                    typedDst.marketTypeExtension = null;
                }
                src.getBuffer().setDesBufferSize(tmpSize);
                src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.executionTypeExtension = src.readString(255);
                }
                else {
                    typedDst.executionTypeExtension = null;
                }
                src.getBuffer().setDesBufferSize(tmpSize);
                src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
            if (tmpLength > 0) {
                OpenFMB_Information_Model.openfmb.commonmodule.ExecutionKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
            src.getBuffer().setDesBufferSize(tmpSize);
            src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
            ...
            src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
            if (tmpLength > 0) {
                OpenFMB_Information_Model.openfmb.commonmodule.MarketKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
            src.getBuffer().setDesBufferSize(tmpSize);
            src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
