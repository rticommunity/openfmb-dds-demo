...
/**
* A sequence of SetPointList instances.
*/
public final class SetPointListSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SetPointListSeq() {
        super(SetPointList.class);
    }

    public SetPointListSeq (int initialMaximum) {
        super(SetPointList.class, initialMaximum);
    }

    public SetPointListSeq (Collection elements) {
        super(SetPointList.class, elements);
    }

    public  SetPointList get(int index) { 
        return (SetPointList) super.get(index); 
    }
