...
/**
* A sequence of ExecutionKind instances.
*/
public final class ExecutionKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ExecutionKindSeq() {
        super(ExecutionKind.class);
    }

    public ExecutionKindSeq (int initialMaximum) {
        super(ExecutionKind.class, initialMaximum);
    }

    public ExecutionKindSeq (Collection elements) {
        super(ExecutionKind.class, elements);
    }

    public  ExecutionKind get(int index) { 
        return (ExecutionKind) super.get(index); 
    }
