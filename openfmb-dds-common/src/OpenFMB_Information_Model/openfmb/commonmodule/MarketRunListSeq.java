...
/**
* A sequence of MarketRunList instances.
*/
public final class MarketRunListSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MarketRunListSeq() {
        super(MarketRunList.class);
    }

    public MarketRunListSeq (int initialMaximum) {
        super(MarketRunList.class, initialMaximum);
    }

    public MarketRunListSeq (Collection elements) {
        super(MarketRunList.class, elements);
    }

    public  MarketRunList get(int index) { 
        return (MarketRunList) super.get(index); 
    }
