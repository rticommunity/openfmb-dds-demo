...
public class InterconnectionScheduleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::InterconnectionSchedule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final InterconnectionScheduleTypeSupport _singleton
    = new InterconnectionScheduleTypeSupport();
    ...
    */
    public static InterconnectionScheduleTypeSupport get_instance() {
        return _singleton;
    }

    public static InterconnectionScheduleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return InterconnectionScheduleTypeCode.VALUE;
    }

    public Object create_data() {
        return InterconnectionSchedule.create();
    }
    ...
    public Object create_key() {
        return new InterconnectionSchedule();
    }
    ...
    public Class get_type() {
        return InterconnectionSchedule.class;
    }
    ...
    * <code>this</code> is not a <code>InterconnectionSchedule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        InterconnectionSchedule typedDst = (InterconnectionSchedule) destination;
        InterconnectionSchedule typedSrc = (InterconnectionSchedule) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.CurveTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false,encapsulation_id,currentAlignment);

        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InverterModeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);

        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ScheduleTypeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.DateTimeIntervalTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.CurveTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false,encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);

        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ScheduleTypeKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        ...
        Object sample) 
    {
        ...
        InterconnectionSchedule typedSrc = (InterconnectionSchedule) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.CurveTypeSupport.get_instance().get_serialized_sample_size(
        ...
        if (typedSrc.inverterMode != null) {
            ...
            currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InverterModeKindTypeSupport.get_instance().get_serialized_sample_size(
                endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.inverterMode);

            currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        }

        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ScheduleTypeKindTypeSupport.get_instance().get_serialized_sample_size(
        ...
        if (typedSrc.dateTimeInterval != null) {
            ...
            currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.DateTimeIntervalTypeSupport.get_instance().get_serialized_sample_size(
                endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.dateTimeInterval);
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(epd.getAlignment(currentAlignment), 4) + 12);
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.inverterModeExtension != null) {

            currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.inverterModeExtension );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.CurveTypeSupport.get_instance().serialize(endpoint_data,src,dst,false,encapsulation_id,serialize_sample,endpoint_plugin_qos);

            memberId = 7;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            if (typedSrc.inverterMode != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.InverterModeKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.inverterMode, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            dst.writeMemberLength(memberLengthPosition, false);

            OpenFMB_Information_Model.openfmb.commonmodule.ScheduleTypeKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            ...
            if (typedSrc.dateTimeInterval != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.DateTimeIntervalTypeSupport.get_instance().serialize(endpoint_data, typedSrc.dateTimeInterval, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            if (dst.useExtendedMemberId == true) {
            ...
            if (typedSrc.inverterModeExtension != null) {
                dst.writeString(typedSrc.inverterModeExtension,255);
            }
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            InterconnectionSchedule typedDst = (InterconnectionSchedule) dst;
            typedDst.clear();      
            OpenFMB_Information_Model.openfmb.commonmodule.CurveTypeSupport.get_instance().deserialize_sample(endpoint_data,dst,src,false,deserialize_sample,endpoint_plugin_qos);
            ...
            try{
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.inverterMode = (OpenFMB_Information_Model.openfmb.commonmodule.InverterModeKind)OpenFMB_Information_Model.openfmb.commonmodule.InverterModeKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.inverterMode, src, false, true, endpoint_plugin_qos);     
                }
                else {
                ...
                typedDst.type = (OpenFMB_Information_Model.openfmb.commonmodule.ScheduleTypeKind)OpenFMB_Information_Model.openfmb.commonmodule.ScheduleTypeKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);     
                ...
                src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
                if (tmpLength > 0) {
                    if (typedDst.dateTimeInterval == null) {
                    ...
                    typedDst.dateTimeInterval = (OpenFMB_Information_Model.openfmb.commonmodule.DateTimeInterval)OpenFMB_Information_Model.openfmb.commonmodule.DateTimeIntervalTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.dateTimeInterval, src, false, true, endpoint_plugin_qos);     
                }
                else {
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.inverterModeExtension = src.readString(255);
                }
                else {
                    typedDst.inverterModeExtension = null;
                }
                src.getBuffer().setDesBufferSize(tmpSize);
                src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
    ...
    public String data_to_string(
        InterconnectionSchedule sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.CurveTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            ...
            src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
            if (tmpLength > 0) {
                OpenFMB_Information_Model.openfmb.commonmodule.InverterModeKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
            src.getBuffer().setDesBufferSize(tmpSize);
            src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));

            OpenFMB_Information_Model.openfmb.commonmodule.ScheduleTypeKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            ...
            src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
            if (tmpLength > 0) {
                OpenFMB_Information_Model.openfmb.commonmodule.DateTimeIntervalTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
            src.getBuffer().setDesBufferSize(tmpSize);
            src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            InterconnectionSchedule typedDst = (InterconnectionSchedule) sample;
    ...
    protected InterconnectionScheduleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,InterconnectionScheduleTypeCode.VALUE,InterconnectionSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected InterconnectionScheduleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,InterconnectionScheduleTypeCode.VALUE,InterconnectionSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
