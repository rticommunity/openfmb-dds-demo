...
public class RequestedOptimizerScheduleProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::optimizermodule::RequestedOptimizerScheduleProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RequestedOptimizerScheduleProfileTypeSupport _singleton
    = new RequestedOptimizerScheduleProfileTypeSupport();
    ...
    */
    public static RequestedOptimizerScheduleProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static RequestedOptimizerScheduleProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RequestedOptimizerScheduleProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return RequestedOptimizerScheduleProfile.create();
    }
    ...
    public Object create_key() {
        return new RequestedOptimizerScheduleProfile();
    }
    ...
    public Class get_type() {
        return RequestedOptimizerScheduleProfile.class;
    }
    ...
    * <code>this</code> is not a <code>RequestedOptimizerScheduleProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RequestedOptimizerScheduleProfile typedDst = (RequestedOptimizerScheduleProfile) destination;
        RequestedOptimizerScheduleProfile typedSrc = (RequestedOptimizerScheduleProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += OpenFMB_Information_Model.openfmb.optimizermodule.RequestedInterconnectionScheduleProfileListTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        ...
        Object sample) 
    {
        ...
        RequestedOptimizerScheduleProfile typedSrc = (RequestedOptimizerScheduleProfile) sample;
        ...
        if (typedSrc.requestedInterconnectionScheduleProfileList != null) {
            ...
            currentAlignment += OpenFMB_Information_Model.openfmb.optimizermodule.RequestedInterconnectionScheduleProfileListTypeSupport.get_instance().get_serialized_sample_size(
                endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.requestedInterconnectionScheduleProfileList);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            if (typedSrc.requestedInterconnectionScheduleProfileList != null) {
                OpenFMB_Information_Model.openfmb.optimizermodule.RequestedInterconnectionScheduleProfileListTypeSupport.get_instance().serialize(endpoint_data, typedSrc.requestedInterconnectionScheduleProfileList, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        RequestedOptimizerScheduleProfile src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RequestedOptimizerScheduleProfile typedDst = (RequestedOptimizerScheduleProfile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
                if (tmpLength > 0) {
                    if (typedDst.requestedInterconnectionScheduleProfileList == null) {
                    ...
                    typedDst.requestedInterconnectionScheduleProfileList = (OpenFMB_Information_Model.openfmb.optimizermodule.RequestedInterconnectionScheduleProfileList)OpenFMB_Information_Model.openfmb.optimizermodule.RequestedInterconnectionScheduleProfileListTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.requestedInterconnectionScheduleProfileList, src, false, true, endpoint_plugin_qos);     
                }
                else {
    ...
    public void deserialize_from_cdr_buffer(
        RequestedOptimizerScheduleProfile dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        RequestedOptimizerScheduleProfile sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
            if (tmpLength > 0) {
                OpenFMB_Information_Model.openfmb.optimizermodule.RequestedInterconnectionScheduleProfileListTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
            src.getBuffer().setDesBufferSize(tmpSize);
            src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RequestedOptimizerScheduleProfile typedDst = (RequestedOptimizerScheduleProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        RequestedOptimizerScheduleProfile typedDst
        = (RequestedOptimizerScheduleProfile) instance;
        RequestedOptimizerScheduleProfile typedSrc
        = (RequestedOptimizerScheduleProfile) key;
    ...
    */
    ...
    int mask) {
        return new RequestedOptimizerScheduleProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new RequestedOptimizerScheduleProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected RequestedOptimizerScheduleProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,RequestedOptimizerScheduleProfileTypeCode.VALUE,RequestedOptimizerScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RequestedOptimizerScheduleProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RequestedOptimizerScheduleProfileTypeCode.VALUE,RequestedOptimizerScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
