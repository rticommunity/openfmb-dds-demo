...
/**
* A sequence of ShuntReading instances.
*/
public final class ShuntReadingSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShuntReadingSeq() {
        super(ShuntReading.class);
    }

    public ShuntReadingSeq (int initialMaximum) {
        super(ShuntReading.class, initialMaximum);
    }

    public ShuntReadingSeq (Collection elements) {
        super(ShuntReading.class, elements);
    }

    public  ShuntReading get(int index) { 
        return (ShuntReading) super.get(index); 
    }
