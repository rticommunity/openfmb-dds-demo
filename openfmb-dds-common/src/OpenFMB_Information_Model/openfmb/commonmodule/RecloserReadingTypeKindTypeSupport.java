...
* RecloserReadingTypeKind
*/

public class RecloserReadingTypeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::RecloserReadingTypeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RecloserReadingTypeKindTypeSupport _singleton
    = new RecloserReadingTypeKindTypeSupport();
    ...
    */
    public static RecloserReadingTypeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static RecloserReadingTypeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RecloserReadingTypeKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return RecloserReadingTypeKind.class;
    }
    ...
    * <code>this</code> is not a <code>RecloserReadingTypeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        RecloserReadingTypeKind typedSrc = (RecloserReadingTypeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = RecloserReadingTypeKind.valueOf(ordinal);
            if (dst == null) {
                ...
                if (ap.acceptUnknownEnumValue) {
                    dst = RecloserReadingTypeKind.valueOf(
                        2);
                } else {
    ...
    protected RecloserReadingTypeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RecloserReadingTypeKindTypeCode.VALUE,RecloserReadingTypeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
