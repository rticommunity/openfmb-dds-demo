...
public class SolarCapabilityTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::SolarCapability";
    ...
    */
        ...
        Object sample) 
    {
        ...
        if (typedSrc.qualityFlag != null) {
            ...
            currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.qualityFlag );
