...
public class ESSControlProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::essmodule::ESSControlProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ESSControlProfileTypeSupport _singleton
    = new ESSControlProfileTypeSupport();
    ...
    */
    public static ESSControlProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static ESSControlProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ESSControlProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return ESSControlProfile.create();
    }
    ...
    public Class get_type() {
        return ESSControlProfile.class;
    }
    ...
    * <code>this</code> is not a <code>ESSControlProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ESSControlProfile typedDst = (ESSControlProfile) destination;
        ESSControlProfile typedSrc = (ESSControlProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSControlTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSControlTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        ESSControlProfile typedSrc = (ESSControlProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSControlTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.essControl);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ESSControlTypeSupport.get_instance().serialize(endpoint_data, typedSrc.essControl, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ESSControlProfile typedDst = (ESSControlProfile) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.essControl = (OpenFMB_Information_Model.openfmb.commonmodule.ESSControl)OpenFMB_Information_Model.openfmb.commonmodule.ESSControlTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.essControl, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ESSControlTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ESSControlProfile typedDst = (ESSControlProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        ESSControlProfile typedDst
        = (ESSControlProfile) instance;
        ESSControlProfile typedSrc
        = (ESSControlProfile) key;
    ...
    */
    ...
    int mask) {
        return new ESSControlProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ESSControlProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected ESSControlProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ESSControlProfileTypeCode.VALUE,ESSControlProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ESSControlProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ESSControlProfileTypeCode.VALUE,ESSControlProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
