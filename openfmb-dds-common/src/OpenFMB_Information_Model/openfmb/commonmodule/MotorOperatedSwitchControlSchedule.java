...
public class MotorOperatedSwitchControlSchedule  extends OpenFMB_Information_Model.openfmb.commonmodule.Curve implements Copyable, Serializable{

    public OpenFMB_Information_Model.openfmb.commonmodule.DateTimeInterval dateTimeInterval = null ;

    public MotorOperatedSwitchControlSchedule() {

        super();

    }
    public MotorOperatedSwitchControlSchedule (MotorOperatedSwitchControlSchedule other) {
    ...
    public static Object create() {
        ...
        MotorOperatedSwitchControlSchedule self;
        self = new  MotorOperatedSwitchControlSchedule();
        self.clear();
        return self;
    ...
    public boolean equals(Object o) {
        ...
        MotorOperatedSwitchControlSchedule otherObj = (MotorOperatedSwitchControlSchedule)o;
    ...
    * This method could be placed into <code>MotorOperatedSwitchControlScheduleTypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        MotorOperatedSwitchControlSchedule typedSrc = (MotorOperatedSwitchControlSchedule) src;
        MotorOperatedSwitchControlSchedule typedDst = this;
