...
/**
* A sequence of ESSEventProfile instances.
*/
public final class ESSEventProfileSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ESSEventProfileSeq() {
        super(ESSEventProfile.class);
    }

    public ESSEventProfileSeq (int initialMaximum) {
        super(ESSEventProfile.class, initialMaximum);
    }

    public ESSEventProfileSeq (Collection elements) {
        super(ESSEventProfile.class, elements);
    }

    public  ESSEventProfile get(int index) { 
        return (ESSEventProfile) super.get(index); 
    }
