...
/**
* A sequence of BreakerEvent instances.
*/
public final class BreakerEventSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public BreakerEventSeq() {
        super(BreakerEvent.class);
    }

    public BreakerEventSeq (int initialMaximum) {
        super(BreakerEvent.class, initialMaximum);
    }

    public BreakerEventSeq (Collection elements) {
        super(BreakerEvent.class, elements);
    }

    public  BreakerEvent get(int index) { 
        return (BreakerEvent) super.get(index); 
    }
