...
/**
* A sequence of InverterModeKind instances.
*/
public final class InverterModeKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public InverterModeKindSeq() {
        super(InverterModeKind.class);
    }

    public InverterModeKindSeq (int initialMaximum) {
        super(InverterModeKind.class, initialMaximum);
    }

    public InverterModeKindSeq (Collection elements) {
        super(InverterModeKind.class, elements);
    }

    public  InverterModeKind get(int index) { 
        return (InverterModeKind) super.get(index); 
    }
