...
/**
* A sequence of AnalogValue instances.
*/
public final class AnalogValueSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public AnalogValueSeq() {
        super(AnalogValue.class);
    }

    public AnalogValueSeq (int initialMaximum) {
        super(AnalogValue.class, initialMaximum);
    }

    public AnalogValueSeq (Collection elements) {
        super(AnalogValue.class, elements);
    }

    public  AnalogValue get(int index) { 
        return (AnalogValue) super.get(index); 
    }
