...
/**
* A sequence of ResourceReading instances.
*/
public final class ResourceReadingSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ResourceReadingSeq() {
        super(ResourceReading.class);
    }

    public ResourceReadingSeq (int initialMaximum) {
        super(ResourceReading.class, initialMaximum);
    }

    public ResourceReadingSeq (Collection elements) {
        super(ResourceReading.class, elements);
    }

    public  ResourceReading get(int index) { 
        return (ResourceReading) super.get(index); 
    }
