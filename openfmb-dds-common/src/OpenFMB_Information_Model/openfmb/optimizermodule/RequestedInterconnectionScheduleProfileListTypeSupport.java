...
public class RequestedInterconnectionScheduleProfileListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::optimizermodule::RequestedInterconnectionScheduleProfileList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RequestedInterconnectionScheduleProfileListTypeSupport _singleton
    = new RequestedInterconnectionScheduleProfileListTypeSupport();
    ...
    */
    public static RequestedInterconnectionScheduleProfileListTypeSupport get_instance() {
        return _singleton;
    }

    public static RequestedInterconnectionScheduleProfileListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RequestedInterconnectionScheduleProfileListTypeCode.VALUE;
    }

    public Object create_data() {
        return RequestedInterconnectionScheduleProfileList.create();
    }
    ...
    public Object create_key() {
        return new RequestedInterconnectionScheduleProfileList();
    }
    ...
    public Class get_type() {
        return RequestedInterconnectionScheduleProfileList.class;
    }
    ...
    * <code>this</code> is not a <code>RequestedInterconnectionScheduleProfileList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RequestedInterconnectionScheduleProfileList typedDst = (RequestedInterconnectionScheduleProfileList) destination;
        RequestedInterconnectionScheduleProfileList typedSrc = (RequestedInterconnectionScheduleProfileList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.interconnectionmodule.RequestedInterconnectionScheduleProfileTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.interconnectionmodule.RequestedInterconnectionScheduleProfileTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        RequestedInterconnectionScheduleProfileList typedSrc = (RequestedInterconnectionScheduleProfileList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.interconnectionmodule.RequestedInterconnectionScheduleProfileTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.requestedInterconnectionScheduleProfile);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.interconnectionmodule.RequestedInterconnectionScheduleProfileTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.requestedInterconnectionScheduleProfile,100, endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        RequestedInterconnectionScheduleProfileList src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RequestedInterconnectionScheduleProfileList typedDst = (RequestedInterconnectionScheduleProfileList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.interconnectionmodule.RequestedInterconnectionScheduleProfileTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.requestedInterconnectionScheduleProfile, src, 100, endpoint_plugin_qos);            
    ...
    public void deserialize_from_cdr_buffer(
        RequestedInterconnectionScheduleProfileList dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        RequestedInterconnectionScheduleProfileList sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.interconnectionmodule.RequestedInterconnectionScheduleProfileTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RequestedInterconnectionScheduleProfileList typedDst = (RequestedInterconnectionScheduleProfileList) sample;
    ...
    protected RequestedInterconnectionScheduleProfileListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RequestedInterconnectionScheduleProfileListTypeCode.VALUE,RequestedInterconnectionScheduleProfileList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RequestedInterconnectionScheduleProfileListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RequestedInterconnectionScheduleProfileListTypeCode.VALUE,RequestedInterconnectionScheduleProfileList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
