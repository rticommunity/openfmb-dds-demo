...
public class SolarControlScheduleListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::SolarControlScheduleList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarControlScheduleListTypeSupport _singleton
    = new SolarControlScheduleListTypeSupport();
    ...
    */
    public static SolarControlScheduleListTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarControlScheduleListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarControlScheduleListTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarControlScheduleList.create();
    }
    ...
    public Object create_key() {
        return new SolarControlScheduleList();
    }
    ...
    public Class get_type() {
        return SolarControlScheduleList.class;
    }
    ...
    * <code>this</code> is not a <code>SolarControlScheduleList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarControlScheduleList typedDst = (SolarControlScheduleList) destination;
        SolarControlScheduleList typedSrc = (SolarControlScheduleList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarControlScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarControlScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        SolarControlScheduleList typedSrc = (SolarControlScheduleList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarControlScheduleTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.solarControlSchedule);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.SolarControlScheduleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.solarControlSchedule,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarControlScheduleList typedDst = (SolarControlScheduleList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.SolarControlScheduleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.solarControlSchedule, src, 100, endpoint_plugin_qos);            
    ...
    public String data_to_string(
        SolarControlScheduleList sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.SolarControlScheduleTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarControlScheduleList typedDst = (SolarControlScheduleList) sample;
    ...
    protected SolarControlScheduleListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SolarControlScheduleListTypeCode.VALUE,SolarControlScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarControlScheduleListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarControlScheduleListTypeCode.VALUE,SolarControlScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
