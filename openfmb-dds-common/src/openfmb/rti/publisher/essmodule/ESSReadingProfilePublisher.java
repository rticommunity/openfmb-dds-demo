...
/* ESSReadingProfilePublisher.java
 * A publication of data of type ESSReadingProfile
 */
...
import OpenFMB_Information_Model.openfmb.essmodule.ESSReadingProfileDataWriter;
import OpenFMB_Information_Model.openfmb.essmodule.ESSReadingProfileTypeSupport;

// ===========================================================================

public class ESSReadingProfilePublisher {
	
    public static ESSReadingProfileDataWriter writer = null;

    // --- Constructors: -----------------------------------------------------

    public ESSReadingProfilePublisher() {
        super();
    }
    ...
    public int initialize(int domainId, String  topicName, String QoSLibrary, String QoSProfile ) {
        ...
        try {
            ...
            writer = (ESSReadingProfileDataWriter)
    ...
    public void publish(ESSReadingProfile instance) {
