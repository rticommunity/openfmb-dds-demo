...
/**
* A sequence of Discrete instances.
*/
public final class DiscreteSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DiscreteSeq() {
        super(Discrete.class);
    }

    public DiscreteSeq (int initialMaximum) {
        super(Discrete.class, initialMaximum);
    }

    public DiscreteSeq (Collection elements) {
        super(Discrete.class, elements);
    }

    public  Discrete get(int index) { 
        return (Discrete) super.get(index); 
    }
        ...
        for(int i = 0; (i < origSize) && (i < srcSize); i++){
            if (typedSrc.get(i) == null){
                ...
                if (get(i) == null){ 
                    ...
                    set(i, Discrete.create());
                }
                set(i, ((Copyable) get(i)).copy_from(typedSrc.get(i)));
            }
        }

        // copy 'new' Discrete objects (beyond the original size of this object)
