...
public class StringMeasurementListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::StringMeasurementList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final StringMeasurementListTypeSupport _singleton
    = new StringMeasurementListTypeSupport();
    ...
    */
    public static StringMeasurementListTypeSupport get_instance() {
        return _singleton;
    }

    public static StringMeasurementListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return StringMeasurementListTypeCode.VALUE;
    }

    public Object create_data() {
        return StringMeasurementList.create();
    }
    ...
    public Object create_key() {
        return new StringMeasurementList();
    }
    ...
    public Class get_type() {
        return StringMeasurementList.class;
    }
    ...
    * <code>this</code> is not a <code>StringMeasurementList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        StringMeasurementList typedDst = (StringMeasurementList) destination;
        StringMeasurementList typedSrc = (StringMeasurementList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        StringMeasurementList typedSrc = (StringMeasurementList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.stringMeasurement);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.stringMeasurement,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            StringMeasurementList typedDst = (StringMeasurementList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.stringMeasurement, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            StringMeasurementList typedDst = (StringMeasurementList) sample;
    ...
    protected StringMeasurementListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,StringMeasurementListTypeCode.VALUE,StringMeasurementList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected StringMeasurementListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,StringMeasurementListTypeCode.VALUE,StringMeasurementList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
