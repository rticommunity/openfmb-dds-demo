...
public class RegulatorSystemTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::RegulatorSystem";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RegulatorSystemTypeSupport _singleton
    = new RegulatorSystemTypeSupport();
    ...
    */
    public static RegulatorSystemTypeSupport get_instance() {
        return _singleton;
    }

    public static RegulatorSystemTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RegulatorSystemTypeCode.VALUE;
    }

    public Object create_data() {
        return RegulatorSystem.create();
    }
    ...
    * <code>this</code> is not a <code>RegulatorSystem</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RegulatorSystem typedDst = (RegulatorSystem) destination;
        RegulatorSystem typedSrc = (RegulatorSystem) source;
        ...
        Object sample) 
    {
        ...
        RegulatorSystem typedSrc = (RegulatorSystem) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByte(typedSrc.__dummy_prevent_empty_class_RegulatorSystem);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RegulatorSystem typedDst = (RegulatorSystem) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.__dummy_prevent_empty_class_RegulatorSystem = src.readByte();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RegulatorSystem typedDst = (RegulatorSystem) sample;
    ...
    protected RegulatorSystemTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RegulatorSystemTypeCode.VALUE,RegulatorSystem.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RegulatorSystemTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RegulatorSystemTypeCode.VALUE,RegulatorSystem.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
