...
public class LoadReadingTypeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::LoadReadingTypeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LoadReadingTypeKindTypeSupport _singleton
    = new LoadReadingTypeKindTypeSupport();
    ...
    */
    public static LoadReadingTypeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static LoadReadingTypeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LoadReadingTypeKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return LoadReadingTypeKind.class;
    }
    ...
    * <code>this</code> is not a <code>LoadReadingTypeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        LoadReadingTypeKind typedSrc = (LoadReadingTypeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = LoadReadingTypeKind.valueOf(ordinal);
            if (dst == null) {
                ...
                if (ap.acceptUnknownEnumValue) {
                    dst = LoadReadingTypeKind.valueOf(
                        2);
                } else {
    ...
    protected LoadReadingTypeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LoadReadingTypeKindTypeCode.VALUE,LoadReadingTypeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
