...
public class ShuntStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ShuntStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShuntStatusTypeSupport _singleton
    = new ShuntStatusTypeSupport();
    ...
    */
    public static ShuntStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static ShuntStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShuntStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return ShuntStatus.create();
    }
    ...
    * <code>this</code> is not a <code>ShuntStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShuntStatus typedDst = (ShuntStatus) destination;
        ShuntStatus typedSrc = (ShuntStatus) source;
        ...
        Object sample) 
    {
        ...
        ShuntStatus typedSrc = (ShuntStatus) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByte(typedSrc.__dummy_prevent_empty_class_ShuntStatus);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShuntStatus typedDst = (ShuntStatus) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.__dummy_prevent_empty_class_ShuntStatus = src.readByte();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShuntStatus typedDst = (ShuntStatus) sample;
    ...
    protected ShuntStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShuntStatusTypeCode.VALUE,ShuntStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShuntStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShuntStatusTypeCode.VALUE,ShuntStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
