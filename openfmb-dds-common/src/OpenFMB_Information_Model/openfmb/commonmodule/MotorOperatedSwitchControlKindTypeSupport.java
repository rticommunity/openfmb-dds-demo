...
* MotorOperatedSwitchControlKind
*/

public class MotorOperatedSwitchControlKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::MotorOperatedSwitchControlKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MotorOperatedSwitchControlKindTypeSupport _singleton
    = new MotorOperatedSwitchControlKindTypeSupport();
    ...
    */
    public static MotorOperatedSwitchControlKindTypeSupport get_instance() {
        return _singleton;
    }

    public static MotorOperatedSwitchControlKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MotorOperatedSwitchControlKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return MotorOperatedSwitchControlKind.class;
    }
    ...
    * <code>this</code> is not a <code>MotorOperatedSwitchControlKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        MotorOperatedSwitchControlKind typedSrc = (MotorOperatedSwitchControlKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = MotorOperatedSwitchControlKind.valueOf(ordinal);
            if (dst == null) {
                ...
                if (ap.acceptUnknownEnumValue) {
                    dst = MotorOperatedSwitchControlKind.valueOf(
                        4);
                } else {
    ...
    protected MotorOperatedSwitchControlKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MotorOperatedSwitchControlKindTypeCode.VALUE,MotorOperatedSwitchControlKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
