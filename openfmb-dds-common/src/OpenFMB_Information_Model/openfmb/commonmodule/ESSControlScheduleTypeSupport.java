...
public class ESSControlScheduleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ESSControlSchedule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ESSControlScheduleTypeSupport _singleton
    = new ESSControlScheduleTypeSupport();
    ...
    */
    public static ESSControlScheduleTypeSupport get_instance() {
        return _singleton;
    }

    public static ESSControlScheduleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ESSControlScheduleTypeCode.VALUE;
    }

    public Object create_data() {
        return ESSControlSchedule.create();
    }
    ...
    public Class get_type() {
        return ESSControlSchedule.class;
    }
    ...
    * <code>this</code> is not a <code>ESSControlSchedule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ESSControlSchedule typedDst = (ESSControlSchedule) destination;
        ESSControlSchedule typedSrc = (ESSControlSchedule) source;
        ...
        Object sample) 
    {
        ...
        ESSControlSchedule typedSrc = (ESSControlSchedule) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ESSControlSchedule typedDst = (ESSControlSchedule) dst;
            typedDst.clear();      
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ESSControlSchedule typedDst = (ESSControlSchedule) sample;
    ...
    protected ESSControlScheduleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ESSControlScheduleTypeCode.VALUE,ESSControlSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ESSControlScheduleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ESSControlScheduleTypeCode.VALUE,ESSControlSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
