...
public class ESSControlScheduleProfileListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::optimizermodule::ESSControlScheduleProfileList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ESSControlScheduleProfileListTypeSupport _singleton
    = new ESSControlScheduleProfileListTypeSupport();
    ...
    */
    public static ESSControlScheduleProfileListTypeSupport get_instance() {
        return _singleton;
    }

    public static ESSControlScheduleProfileListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ESSControlScheduleProfileListTypeCode.VALUE;
    }

    public Object create_data() {
        return ESSControlScheduleProfileList.create();
    }
    ...
    public Object create_key() {
        return new ESSControlScheduleProfileList();
    }
    ...
    public Class get_type() {
        return ESSControlScheduleProfileList.class;
    }
    ...
    * <code>this</code> is not a <code>ESSControlScheduleProfileList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ESSControlScheduleProfileList typedDst = (ESSControlScheduleProfileList) destination;
        ESSControlScheduleProfileList typedSrc = (ESSControlScheduleProfileList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.essmodule.ESSControlScheduleProfileTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.essmodule.ESSControlScheduleProfileTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        ESSControlScheduleProfileList typedSrc = (ESSControlScheduleProfileList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.essmodule.ESSControlScheduleProfileTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.essControlScheduleProfile);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.essmodule.ESSControlScheduleProfileTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.essControlScheduleProfile,100, endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        ESSControlScheduleProfileList src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ESSControlScheduleProfileList typedDst = (ESSControlScheduleProfileList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.essmodule.ESSControlScheduleProfileTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.essControlScheduleProfile, src, 100, endpoint_plugin_qos);            
    ...
    public void deserialize_from_cdr_buffer(
        ESSControlScheduleProfileList dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        ESSControlScheduleProfileList sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.essmodule.ESSControlScheduleProfileTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ESSControlScheduleProfileList typedDst = (ESSControlScheduleProfileList) sample;
    ...
    protected ESSControlScheduleProfileListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ESSControlScheduleProfileListTypeCode.VALUE,ESSControlScheduleProfileList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ESSControlScheduleProfileListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ESSControlScheduleProfileListTypeCode.VALUE,ESSControlScheduleProfileList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
