...
public class ForecastScheduleTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ForecastSchedule";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BasicIntervalScheduleTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false,encapsulation_id,currentAlignment);
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.IrregularTimePointListTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BasicIntervalScheduleTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false,encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        ...
        Object sample) 
    {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BasicIntervalScheduleTypeSupport.get_instance().get_serialized_sample_size(
        ...
        if (typedSrc.irregularTimePointList != null) {
            ...
            currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.IrregularTimePointListTypeSupport.get_instance().get_serialized_sample_size(
                endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.irregularTimePointList);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.BasicIntervalScheduleTypeSupport.get_instance().serialize(endpoint_data,src,dst,false,encapsulation_id,serialize_sample,endpoint_plugin_qos);
            ...
            if (typedSrc.irregularTimePointList != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.IrregularTimePointListTypeSupport.get_instance().serialize(endpoint_data, typedSrc.irregularTimePointList, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            typedDst.clear();      
            OpenFMB_Information_Model.openfmb.commonmodule.BasicIntervalScheduleTypeSupport.get_instance().deserialize_sample(endpoint_data,dst,src,false,deserialize_sample,endpoint_plugin_qos);
            ...
            try{
                ...
                src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
                if (tmpLength > 0) {
                    if (typedDst.irregularTimePointList == null) {
                    ...
                    typedDst.irregularTimePointList = (OpenFMB_Information_Model.openfmb.commonmodule.IrregularTimePointList)OpenFMB_Information_Model.openfmb.commonmodule.IrregularTimePointListTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.irregularTimePointList, src, false, true, endpoint_plugin_qos);     
                }
                else {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.BasicIntervalScheduleTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            ...
            src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
            if (tmpLength > 0) {
                OpenFMB_Information_Model.openfmb.commonmodule.IrregularTimePointListTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
            src.getBuffer().setDesBufferSize(tmpSize);
            src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
