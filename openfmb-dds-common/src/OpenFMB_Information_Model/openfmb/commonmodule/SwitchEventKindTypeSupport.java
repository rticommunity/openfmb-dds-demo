...
public class SwitchEventKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::SwitchEventKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SwitchEventKindTypeSupport _singleton
    = new SwitchEventKindTypeSupport();
    ...
    */
    public static SwitchEventKindTypeSupport get_instance() {
        return _singleton;
    }

    public static SwitchEventKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SwitchEventKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>SwitchEventKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        SwitchEventKind typedSrc = (SwitchEventKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = SwitchEventKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected SwitchEventKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SwitchEventKindTypeCode.VALUE,SwitchEventKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
