...
/**
* A sequence of RecloserEvent instances.
*/
public final class RecloserEventSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public RecloserEventSeq() {
        super(RecloserEvent.class);
    }

    public RecloserEventSeq (int initialMaximum) {
        super(RecloserEvent.class, initialMaximum);
    }

    public RecloserEventSeq (Collection elements) {
        super(RecloserEvent.class, elements);
    }

    public  RecloserEvent get(int index) { 
        return (RecloserEvent) super.get(index); 
    }
