...
/**
* A sequence of CurveNameKind instances.
*/
public final class CurveNameKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CurveNameKindSeq() {
        super(CurveNameKind.class);
    }

    public CurveNameKindSeq (int initialMaximum) {
        super(CurveNameKind.class, initialMaximum);
    }

    public CurveNameKindSeq (Collection elements) {
        super(CurveNameKind.class, elements);
    }

    public  CurveNameKind get(int index) { 
        return (CurveNameKind) super.get(index); 
    }
