...
/* GenerationReadingProfilePublisher.java
 * A publication of data of type GenerationReadingProfile
 */
...
import OpenFMB_Information_Model.openfmb.generationmodule.GenerationReadingProfileDataWriter;
import OpenFMB_Information_Model.openfmb.generationmodule.GenerationReadingProfileTypeSupport;

// ===========================================================================

public class GenerationReadingProfilePublisher {
	
    public static GenerationReadingProfileDataWriter writer = null;

    // --- Constructors: -----------------------------------------------------

    public GenerationReadingProfilePublisher() {
        super();
    }
    ...
    public int initialize(int domainId, String  topicName) {
        ...
        try {
            ...
            writer = (GenerationReadingProfileDataWriter)
    ...
    public void publish(GenerationReadingProfile instance) {
