...
/* LoadStatusProfilePublisher.java
 * A publication of data of type LoadStatusProfile
 */
...
import OpenFMB_Information_Model.openfmb.loadmodule.LoadStatusProfileDataWriter;
import OpenFMB_Information_Model.openfmb.loadmodule.LoadStatusProfileTypeSupport;

// ===========================================================================

public class LoadStatusProfilePublisher {
	
    public static LoadStatusProfileDataWriter writer = null;

    // --- Constructors: -----------------------------------------------------

    public LoadStatusProfilePublisher() {
        super();
    }
    ...
    public int initialize(int domainId, String  topicName) {
        ...
        try {
            ...
            writer = (LoadStatusProfileDataWriter)
    ...
    public void publish(LoadStatusProfile instance) {
