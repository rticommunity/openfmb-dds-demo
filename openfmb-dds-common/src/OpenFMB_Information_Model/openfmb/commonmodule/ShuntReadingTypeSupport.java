...
public class ShuntReadingTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ShuntReading";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShuntReadingTypeSupport _singleton
    = new ShuntReadingTypeSupport();
    ...
    */
    public static ShuntReadingTypeSupport get_instance() {
        return _singleton;
    }

    public static ShuntReadingTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShuntReadingTypeCode.VALUE;
    }

    public Object create_data() {
        return ShuntReading.create();
    }
    ...
    * <code>this</code> is not a <code>ShuntReading</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShuntReading typedDst = (ShuntReading) destination;
        ShuntReading typedSrc = (ShuntReading) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingTypeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingTypeKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        ShuntReading typedSrc = (ShuntReading) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingTypeKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingTypeKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShuntReading typedDst = (ShuntReading) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.type = (OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingTypeKind)OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingTypeKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ShuntReadingTypeKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShuntReading typedDst = (ShuntReading) sample;
    ...
    protected ShuntReadingTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShuntReadingTypeCode.VALUE,ShuntReading.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShuntReadingTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShuntReadingTypeCode.VALUE,ShuntReading.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
