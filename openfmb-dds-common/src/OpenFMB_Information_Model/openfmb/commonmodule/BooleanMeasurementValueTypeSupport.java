...
public class BooleanMeasurementValueTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::BooleanMeasurementValue";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BooleanMeasurementValueTypeSupport _singleton
    = new BooleanMeasurementValueTypeSupport();
    ...
    */
    public static BooleanMeasurementValueTypeSupport get_instance() {
        return _singleton;
    }

    public static BooleanMeasurementValueTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BooleanMeasurementValueTypeCode.VALUE;
    }

    public Object create_data() {
        return BooleanMeasurementValue.create();
    }
    ...
    public Class get_type() {
        return BooleanMeasurementValue.class;
    }
    ...
    * <code>this</code> is not a <code>BooleanMeasurementValue</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BooleanMeasurementValue typedDst = (BooleanMeasurementValue) destination;
        BooleanMeasurementValue typedSrc = (BooleanMeasurementValue) source;
        ...
        Object sample) 
    {
        ...
        BooleanMeasurementValue typedSrc = (BooleanMeasurementValue) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.value);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BooleanMeasurementValue typedDst = (BooleanMeasurementValue) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.value = src.readBoolean();
    ...
    public String data_to_string(
        BooleanMeasurementValue sample,
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BooleanMeasurementValue typedDst = (BooleanMeasurementValue) sample;
    ...
    protected BooleanMeasurementValueTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BooleanMeasurementValueTypeCode.VALUE,BooleanMeasurementValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BooleanMeasurementValueTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BooleanMeasurementValueTypeCode.VALUE,BooleanMeasurementValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
