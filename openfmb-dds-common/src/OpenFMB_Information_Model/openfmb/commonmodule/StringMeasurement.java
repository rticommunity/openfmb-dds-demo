...
public class StringMeasurement   implements Copyable, Serializable{
    ...
    public OpenFMB_Information_Model.openfmb.commonmodule.StringMeasurementValue stringMeasurementValue = (OpenFMB_Information_Model.openfmb.commonmodule.StringMeasurementValue)OpenFMB_Information_Model.openfmb.commonmodule.StringMeasurementValue.create();
    ...
    public void clear() {
        ...
        phases=null; 
        unit=null; 
        if (stringMeasurementValue != null) {
            stringMeasurementValue.clear();
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if(!stringMeasurementValue.equals(otherObj.stringMeasurementValue)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        __result += stringMeasurementValue.hashCode(); 
        return __result;
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        typedDst.stringMeasurementValue = (OpenFMB_Information_Model.openfmb.commonmodule.StringMeasurementValue) typedDst.stringMeasurementValue.copy_from(typedSrc.stringMeasurementValue);
    ...
    public String toString(String desc, int indent) {
        ...
        strBuffer.append(stringMeasurementValue.toString("stringMeasurementValue ", indent+1));
