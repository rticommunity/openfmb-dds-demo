...
public class RegulatorControlScheduleProfileListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::optimizermodule::RegulatorControlScheduleProfileList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RegulatorControlScheduleProfileListTypeSupport _singleton
    = new RegulatorControlScheduleProfileListTypeSupport();
    ...
    */
    public static RegulatorControlScheduleProfileListTypeSupport get_instance() {
        return _singleton;
    }

    public static RegulatorControlScheduleProfileListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RegulatorControlScheduleProfileListTypeCode.VALUE;
    }

    public Object create_data() {
        return RegulatorControlScheduleProfileList.create();
    }
    ...
    public Object create_key() {
        return new RegulatorControlScheduleProfileList();
    }
    ...
    public Class get_type() {
        return RegulatorControlScheduleProfileList.class;
    }
    ...
    * <code>this</code> is not a <code>RegulatorControlScheduleProfileList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RegulatorControlScheduleProfileList typedDst = (RegulatorControlScheduleProfileList) destination;
        RegulatorControlScheduleProfileList typedSrc = (RegulatorControlScheduleProfileList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.regulatormodule.RegulatorControlScheduleProfileTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.regulatormodule.RegulatorControlScheduleProfileTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        RegulatorControlScheduleProfileList typedSrc = (RegulatorControlScheduleProfileList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.regulatormodule.RegulatorControlScheduleProfileTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.regulatorControlScheduleProfile);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.regulatormodule.RegulatorControlScheduleProfileTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.regulatorControlScheduleProfile,100, endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        RegulatorControlScheduleProfileList src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RegulatorControlScheduleProfileList typedDst = (RegulatorControlScheduleProfileList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.regulatormodule.RegulatorControlScheduleProfileTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.regulatorControlScheduleProfile, src, 100, endpoint_plugin_qos);            
    ...
    public void deserialize_from_cdr_buffer(
        RegulatorControlScheduleProfileList dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        RegulatorControlScheduleProfileList sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.regulatormodule.RegulatorControlScheduleProfileTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RegulatorControlScheduleProfileList typedDst = (RegulatorControlScheduleProfileList) sample;
    ...
    protected RegulatorControlScheduleProfileListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RegulatorControlScheduleProfileListTypeCode.VALUE,RegulatorControlScheduleProfileList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RegulatorControlScheduleProfileListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RegulatorControlScheduleProfileListTypeCode.VALUE,RegulatorControlScheduleProfileList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
