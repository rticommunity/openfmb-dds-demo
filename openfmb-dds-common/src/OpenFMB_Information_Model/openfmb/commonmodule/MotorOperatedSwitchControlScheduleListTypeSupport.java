...
public class MotorOperatedSwitchControlScheduleListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::MotorOperatedSwitchControlScheduleList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MotorOperatedSwitchControlScheduleListTypeSupport _singleton
    = new MotorOperatedSwitchControlScheduleListTypeSupport();
    ...
    */
    public static MotorOperatedSwitchControlScheduleListTypeSupport get_instance() {
        return _singleton;
    }

    public static MotorOperatedSwitchControlScheduleListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MotorOperatedSwitchControlScheduleListTypeCode.VALUE;
    }

    public Object create_data() {
        return MotorOperatedSwitchControlScheduleList.create();
    }
    ...
    public Object create_key() {
        return new MotorOperatedSwitchControlScheduleList();
    }
    ...
    public Class get_type() {
        return MotorOperatedSwitchControlScheduleList.class;
    }
    ...
    * <code>this</code> is not a <code>MotorOperatedSwitchControlScheduleList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MotorOperatedSwitchControlScheduleList typedDst = (MotorOperatedSwitchControlScheduleList) destination;
        MotorOperatedSwitchControlScheduleList typedSrc = (MotorOperatedSwitchControlScheduleList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        MotorOperatedSwitchControlScheduleList typedSrc = (MotorOperatedSwitchControlScheduleList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlScheduleTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.motorOperatedSwitchControlSchedule);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlScheduleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.motorOperatedSwitchControlSchedule,100, endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        MotorOperatedSwitchControlScheduleList src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MotorOperatedSwitchControlScheduleList typedDst = (MotorOperatedSwitchControlScheduleList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlScheduleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.motorOperatedSwitchControlSchedule, src, 100, endpoint_plugin_qos);            
    ...
    public void deserialize_from_cdr_buffer(
        MotorOperatedSwitchControlScheduleList dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        MotorOperatedSwitchControlScheduleList sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlScheduleTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MotorOperatedSwitchControlScheduleList typedDst = (MotorOperatedSwitchControlScheduleList) sample;
    ...
    protected MotorOperatedSwitchControlScheduleListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MotorOperatedSwitchControlScheduleListTypeCode.VALUE,MotorOperatedSwitchControlScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MotorOperatedSwitchControlScheduleListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MotorOperatedSwitchControlScheduleListTypeCode.VALUE,MotorOperatedSwitchControlScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
