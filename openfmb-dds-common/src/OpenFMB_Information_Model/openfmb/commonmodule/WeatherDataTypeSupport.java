...
public class WeatherDataTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::WeatherData";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.TemperatureTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);

        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.WindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);

        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.HumidityTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);

        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SunRadiationTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        ...
        Object sample) 
    {
        ...
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.interval != null) {

            currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.interval );

            currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        }
        currentAlignment += (CdrPrimitiveType.getPadSize(epd.getAlignment(currentAlignment), 4) + 12);
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.source != null) {

            currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.source );

            currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        }
        currentAlignment += (CdrPrimitiveType.getPadSize(epd.getAlignment(currentAlignment), 4) + 12);
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.version != null) {

            currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.version );

            currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        }
        currentAlignment += (CdrPrimitiveType.getPadSize(epd.getAlignment(currentAlignment), 4) + 4);
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.versionDateTime != null) {
        ...
        if (typedSrc.temperature != null) {
            ...
            currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.TemperatureTypeSupport.get_instance().get_serialized_sample_size(
        ...
        if (typedSrc.wind != null) {
            ...
            currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.WindTypeSupport.get_instance().get_serialized_sample_size(
        ...
        if (typedSrc.humidity != null) {
            ...
            currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.HumidityTypeSupport.get_instance().get_serialized_sample_size(
        ...
        if (typedSrc.sunRadiation != null) {
            ...
            currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SunRadiationTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            if (typedSrc.temperature != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.TemperatureTypeSupport.get_instance().serialize(endpoint_data, typedSrc.temperature, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
            ...
            if (typedSrc.wind != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.WindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.wind, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
            ...
            if (typedSrc.humidity != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.HumidityTypeSupport.get_instance().serialize(endpoint_data, typedSrc.humidity, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
            ...
            if (typedSrc.sunRadiation != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.SunRadiationTypeSupport.get_instance().serialize(endpoint_data, typedSrc.sunRadiation, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.temperature = (OpenFMB_Information_Model.openfmb.commonmodule.Temperature)OpenFMB_Information_Model.openfmb.commonmodule.TemperatureTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.temperature, src, false, true, endpoint_plugin_qos);     
                }
                else {
                ...
                src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
                if (tmpLength > 0) {
                    if (typedDst.wind == null) {
                        typedDst.wind = 
                        (OpenFMB_Information_Model.openfmb.commonmodule.Wind) OpenFMB_Information_Model.openfmb.commonmodule.Wind.create();
                    }

                    typedDst.wind = (OpenFMB_Information_Model.openfmb.commonmodule.Wind)OpenFMB_Information_Model.openfmb.commonmodule.WindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.wind, src, false, true, endpoint_plugin_qos);     
                }
                else {
                    typedDst.wind = null;
                }
                ...
                src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
                if (tmpLength > 0) {
                    if (typedDst.humidity == null) {
                        typedDst.humidity = 
                        (OpenFMB_Information_Model.openfmb.commonmodule.Humidity) OpenFMB_Information_Model.openfmb.commonmodule.Humidity.create();
                    }

                    typedDst.humidity = (OpenFMB_Information_Model.openfmb.commonmodule.Humidity)OpenFMB_Information_Model.openfmb.commonmodule.HumidityTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.humidity, src, false, true, endpoint_plugin_qos);     
                }
                else {
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.sunRadiation = (OpenFMB_Information_Model.openfmb.commonmodule.SunRadiation)OpenFMB_Information_Model.openfmb.commonmodule.SunRadiationTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.sunRadiation, src, false, true, endpoint_plugin_qos);     
                }
                else {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
            if (tmpLength > 0) {
                OpenFMB_Information_Model.openfmb.commonmodule.TemperatureTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
            src.getBuffer().setDesBufferSize(tmpSize);
            src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
            ...
            src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
            if (tmpLength > 0) {
                OpenFMB_Information_Model.openfmb.commonmodule.WindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
            src.getBuffer().setDesBufferSize(tmpSize);
            src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
            ...
            src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
            if (tmpLength > 0) {
                OpenFMB_Information_Model.openfmb.commonmodule.HumidityTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
            src.getBuffer().setDesBufferSize(tmpSize);
            src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
            ...
            src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
            if (tmpLength > 0) {
                OpenFMB_Information_Model.openfmb.commonmodule.SunRadiationTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
            src.getBuffer().setDesBufferSize(tmpSize);
            src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
