...
/**
* A sequence of GenerationEvent instances.
*/
public final class GenerationEventSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public GenerationEventSeq() {
        super(GenerationEvent.class);
    }

    public GenerationEventSeq (int initialMaximum) {
        super(GenerationEvent.class, initialMaximum);
    }

    public GenerationEventSeq (Collection elements) {
        super(GenerationEvent.class, elements);
    }

    public  GenerationEvent get(int index) { 
        return (GenerationEvent) super.get(index); 
    }
