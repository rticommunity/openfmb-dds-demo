...
public class RegulatorControlSchedule  extends OpenFMB_Information_Model.openfmb.commonmodule.Curve implements Copyable, Serializable{

    public OpenFMB_Information_Model.openfmb.commonmodule.DateTimeInterval dateTimeInterval = null ;

    public RegulatorControlSchedule() {

        super();

    }
    public RegulatorControlSchedule (RegulatorControlSchedule other) {
    ...
    public static Object create() {
        ...
        RegulatorControlSchedule self;
        self = new  RegulatorControlSchedule();
        self.clear();
        return self;
    ...
    public boolean equals(Object o) {
        ...
        RegulatorControlSchedule otherObj = (RegulatorControlSchedule)o;
    ...
    * This method could be placed into <code>RegulatorControlScheduleTypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        RegulatorControlSchedule typedSrc = (RegulatorControlSchedule) src;
        RegulatorControlSchedule typedDst = this;
