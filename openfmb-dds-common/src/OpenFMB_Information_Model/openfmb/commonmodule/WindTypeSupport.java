...
public class WindTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::Wind";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.WindDataListTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        ...
        Object sample) 
    {
        ...
        if (typedSrc.windDataList != null) {
            ...
            currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.WindDataListTypeSupport.get_instance().get_serialized_sample_size(
                endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.windDataList);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            if (typedSrc.directionUnit != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.UnitSymbolKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.directionUnit, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            ...
            memberLengthPosition = dst.writeMemberId((short)memberId);
            if (typedSrc.speedUnit != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.UnitSymbolKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.speedUnit, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            dst.writeMemberLength(memberLengthPosition, false);
            ...
            if (typedSrc.windDataList != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.WindDataListTypeSupport.get_instance().serialize(endpoint_data, typedSrc.windDataList, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            if (dst.useExtendedMemberId == true) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                if (tmpLength > 0) {
                    if (typedDst.directionUnit == null) {
                    ...
                    typedDst.directionUnit = (OpenFMB_Information_Model.openfmb.commonmodule.UnitSymbolKind)OpenFMB_Information_Model.openfmb.commonmodule.UnitSymbolKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.directionUnit, src, false, true, endpoint_plugin_qos);     
                }
                else {
                ...
                src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
                if (tmpLength > 0) {
                    if (typedDst.speedUnit == null) {
                        typedDst.speedUnit = 
                        (OpenFMB_Information_Model.openfmb.commonmodule.UnitSymbolKind) OpenFMB_Information_Model.openfmb.commonmodule.UnitSymbolKind.create();
                    }

                    typedDst.speedUnit = (OpenFMB_Information_Model.openfmb.commonmodule.UnitSymbolKind)OpenFMB_Information_Model.openfmb.commonmodule.UnitSymbolKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.speedUnit, src, false, true, endpoint_plugin_qos);     
                }
                else {
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.windDataList = (OpenFMB_Information_Model.openfmb.commonmodule.WindDataList)OpenFMB_Information_Model.openfmb.commonmodule.WindDataListTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.windDataList, src, false, true, endpoint_plugin_qos);     
                }
                else {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
            if (tmpLength > 0) {
                OpenFMB_Information_Model.openfmb.commonmodule.WindDataListTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
            src.getBuffer().setDesBufferSize(tmpSize);
            src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
