...
public class MotorOperatedSwitchReadingListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::MotorOperatedSwitchReadingList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MotorOperatedSwitchReadingListTypeSupport _singleton
    = new MotorOperatedSwitchReadingListTypeSupport();
    ...
    */
    public static MotorOperatedSwitchReadingListTypeSupport get_instance() {
        return _singleton;
    }

    public static MotorOperatedSwitchReadingListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MotorOperatedSwitchReadingListTypeCode.VALUE;
    }

    public Object create_data() {
        return MotorOperatedSwitchReadingList.create();
    }
    ...
    public Object create_key() {
        return new MotorOperatedSwitchReadingList();
    }
    ...
    public Class get_type() {
        return MotorOperatedSwitchReadingList.class;
    }
    ...
    * <code>this</code> is not a <code>MotorOperatedSwitchReadingList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MotorOperatedSwitchReadingList typedDst = (MotorOperatedSwitchReadingList) destination;
        MotorOperatedSwitchReadingList typedSrc = (MotorOperatedSwitchReadingList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        MotorOperatedSwitchReadingList typedSrc = (MotorOperatedSwitchReadingList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.motorOperatedSwitchReading);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.motorOperatedSwitchReading,100, endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        MotorOperatedSwitchReadingList src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MotorOperatedSwitchReadingList typedDst = (MotorOperatedSwitchReadingList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.motorOperatedSwitchReading, src, 100, endpoint_plugin_qos);            
    ...
    public void deserialize_from_cdr_buffer(
        MotorOperatedSwitchReadingList dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        MotorOperatedSwitchReadingList sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MotorOperatedSwitchReadingList typedDst = (MotorOperatedSwitchReadingList) sample;
    ...
    protected MotorOperatedSwitchReadingListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MotorOperatedSwitchReadingListTypeCode.VALUE,MotorOperatedSwitchReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MotorOperatedSwitchReadingListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MotorOperatedSwitchReadingListTypeCode.VALUE,MotorOperatedSwitchReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
