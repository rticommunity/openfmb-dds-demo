...
/**
* A sequence of ESSReading instances.
*/
public final class ESSReadingSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ESSReadingSeq() {
        super(ESSReading.class);
    }

    public ESSReadingSeq (int initialMaximum) {
        super(ESSReading.class, initialMaximum);
    }

    public ESSReadingSeq (Collection elements) {
        super(ESSReading.class, elements);
    }

    public  ESSReading get(int index) { 
        return (ESSReading) super.get(index); 
    }
