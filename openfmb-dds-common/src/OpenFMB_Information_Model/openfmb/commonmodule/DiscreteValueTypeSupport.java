...
public class DiscreteValueTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::DiscreteValue";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DiscreteValueTypeSupport _singleton
    = new DiscreteValueTypeSupport();
    ...
    */
    public static DiscreteValueTypeSupport get_instance() {
        return _singleton;
    }

    public static DiscreteValueTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DiscreteValueTypeCode.VALUE;
    }

    public Object create_data() {
        return DiscreteValue.create();
    }
    ...
    * <code>this</code> is not a <code>DiscreteValue</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DiscreteValue typedDst = (DiscreteValue) destination;
        DiscreteValue typedSrc = (DiscreteValue) source;
        ...
        Object sample) 
    {
        ...
        DiscreteValue typedSrc = (DiscreteValue) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DiscreteValue typedDst = (DiscreteValue) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DiscreteValue typedDst = (DiscreteValue) sample;
    ...
    protected DiscreteValueTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DiscreteValueTypeCode.VALUE,DiscreteValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DiscreteValueTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DiscreteValueTypeCode.VALUE,DiscreteValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
