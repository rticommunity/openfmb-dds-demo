...
public class BreakerReadingListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::BreakerReadingList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BreakerReadingListTypeSupport _singleton
    = new BreakerReadingListTypeSupport();
    ...
    */
    public static BreakerReadingListTypeSupport get_instance() {
        return _singleton;
    }

    public static BreakerReadingListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BreakerReadingListTypeCode.VALUE;
    }

    public Object create_data() {
        return BreakerReadingList.create();
    }
    ...
    public Class get_type() {
        return BreakerReadingList.class;
    }
    ...
    * <code>this</code> is not a <code>BreakerReadingList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BreakerReadingList typedDst = (BreakerReadingList) destination;
        BreakerReadingList typedSrc = (BreakerReadingList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        BreakerReadingList typedSrc = (BreakerReadingList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.breakerReading);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.breakerReading,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BreakerReadingList typedDst = (BreakerReadingList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.breakerReading, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BreakerReadingList typedDst = (BreakerReadingList) sample;
    ...
    protected BreakerReadingListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BreakerReadingListTypeCode.VALUE,BreakerReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BreakerReadingListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BreakerReadingListTypeCode.VALUE,BreakerReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
