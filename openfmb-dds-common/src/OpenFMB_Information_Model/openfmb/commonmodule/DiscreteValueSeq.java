...
/**
* A sequence of DiscreteValue instances.
*/
public final class DiscreteValueSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DiscreteValueSeq() {
        super(DiscreteValue.class);
    }

    public DiscreteValueSeq (int initialMaximum) {
        super(DiscreteValue.class, initialMaximum);
    }

    public DiscreteValueSeq (Collection elements) {
        super(DiscreteValue.class, elements);
    }

    public  DiscreteValue get(int index) { 
        return (DiscreteValue) super.get(index); 
    }
