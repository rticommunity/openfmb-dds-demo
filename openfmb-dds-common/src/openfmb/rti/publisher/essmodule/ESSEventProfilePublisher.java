...
/* ESSEventProfilePublisher.java
 * A publication of data of type ESSEventProfile
 */
...
import OpenFMB_Information_Model.openfmb.essmodule.ESSEventProfileDataWriter;
import OpenFMB_Information_Model.openfmb.essmodule.ESSEventProfileTypeSupport;

// ===========================================================================

public class ESSEventProfilePublisher {
	
    public static ESSEventProfileDataWriter writer = null;

    // --- Constructors: -----------------------------------------------------

    public ESSEventProfilePublisher() {
        super();
    }
    ...
    public int initialize(int domainId, String  topicName, String QoSLibrary, String QoSProfile) {
        ...
        try {
            ...
            writer = (ESSEventProfileDataWriter)
    ...
    public void publish(ESSEventProfile instance) {
