...
public class MotorOperatedSwitchControlScheduleProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::motoroperatedswitchmodule::MotorOperatedSwitchControlScheduleProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MotorOperatedSwitchControlScheduleProfileTypeSupport _singleton
    = new MotorOperatedSwitchControlScheduleProfileTypeSupport();
    ...
    */
    public static MotorOperatedSwitchControlScheduleProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static MotorOperatedSwitchControlScheduleProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MotorOperatedSwitchControlScheduleProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return MotorOperatedSwitchControlScheduleProfile.create();
    }
    ...
    public Object create_key() {
        return new MotorOperatedSwitchControlScheduleProfile();
    }
    ...
    public Class get_type() {
        return MotorOperatedSwitchControlScheduleProfile.class;
    }
    ...
    * <code>this</code> is not a <code>MotorOperatedSwitchControlScheduleProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MotorOperatedSwitchControlScheduleProfile typedDst = (MotorOperatedSwitchControlScheduleProfile) destination;
        MotorOperatedSwitchControlScheduleProfile typedSrc = (MotorOperatedSwitchControlScheduleProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlScheduleListTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlScheduleListTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        MotorOperatedSwitchControlScheduleProfile typedSrc = (MotorOperatedSwitchControlScheduleProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.motorOperatedSwitch);

        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlScheduleListTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.motorOperatedSwitchControlScheduleList);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchTypeSupport.get_instance().serialize(endpoint_data, typedSrc.motorOperatedSwitch, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlScheduleListTypeSupport.get_instance().serialize(endpoint_data, typedSrc.motorOperatedSwitchControlScheduleList, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        MotorOperatedSwitchControlScheduleProfile src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MotorOperatedSwitchControlScheduleProfile typedDst = (MotorOperatedSwitchControlScheduleProfile) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.motorOperatedSwitch = (OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitch)OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.motorOperatedSwitch, src, false, true, endpoint_plugin_qos);     
                typedDst.motorOperatedSwitchControlScheduleList = (OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlScheduleList)OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlScheduleListTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.motorOperatedSwitchControlScheduleList, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        MotorOperatedSwitchControlScheduleProfile dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        MotorOperatedSwitchControlScheduleProfile sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlScheduleListTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MotorOperatedSwitchControlScheduleProfile typedDst = (MotorOperatedSwitchControlScheduleProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        MotorOperatedSwitchControlScheduleProfile typedDst
        = (MotorOperatedSwitchControlScheduleProfile) instance;
        MotorOperatedSwitchControlScheduleProfile typedSrc
        = (MotorOperatedSwitchControlScheduleProfile) key;
    ...
    */
    ...
    int mask) {
        return new MotorOperatedSwitchControlScheduleProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MotorOperatedSwitchControlScheduleProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected MotorOperatedSwitchControlScheduleProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,MotorOperatedSwitchControlScheduleProfileTypeCode.VALUE,MotorOperatedSwitchControlScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MotorOperatedSwitchControlScheduleProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MotorOperatedSwitchControlScheduleProfileTypeCode.VALUE,MotorOperatedSwitchControlScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
