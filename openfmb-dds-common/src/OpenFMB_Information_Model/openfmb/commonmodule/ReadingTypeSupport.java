...
public class ReadingTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::Reading";
    ...
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            if (typedSrc.timePeriod != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.DateTimeIntervalTypeSupport.get_instance().serialize(endpoint_data, typedSrc.timePeriod, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.timePeriod = (OpenFMB_Information_Model.openfmb.commonmodule.DateTimeInterval)OpenFMB_Information_Model.openfmb.commonmodule.DateTimeIntervalTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.timePeriod, src, false, true, endpoint_plugin_qos);     
                }
                else {
