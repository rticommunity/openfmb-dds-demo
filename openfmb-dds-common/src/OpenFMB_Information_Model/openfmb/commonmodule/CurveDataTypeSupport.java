...
public class CurveDataTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::CurveData";
    ...
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            memberLengthPosition = dst.writeMemberId((short)memberId);
            if (typedSrc.yvalue != null) {
                dst.writeFloat(typedSrc.yvalue);
            }
            dst.writeMemberLength(memberLengthPosition, false);
        }
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.yvalue = src.readFloat();
                }
                else {
                    typedDst.yvalue = null;
                }
                src.getBuffer().setDesBufferSize(tmpSize);
                src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
