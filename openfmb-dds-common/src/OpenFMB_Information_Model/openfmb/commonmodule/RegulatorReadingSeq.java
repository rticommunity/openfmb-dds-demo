...
/**
* A sequence of RegulatorReading instances.
*/
public final class RegulatorReadingSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public RegulatorReadingSeq() {
        super(RegulatorReading.class);
    }

    public RegulatorReadingSeq (int initialMaximum) {
        super(RegulatorReading.class, initialMaximum);
    }

    public RegulatorReadingSeq (Collection elements) {
        super(RegulatorReading.class, elements);
    }

    public  RegulatorReading get(int index) { 
        return (RegulatorReading) super.get(index); 
    }
