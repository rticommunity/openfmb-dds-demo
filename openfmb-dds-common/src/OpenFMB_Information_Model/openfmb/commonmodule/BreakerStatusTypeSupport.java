...
public class BreakerStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::BreakerStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BreakerStatusTypeSupport _singleton
    = new BreakerStatusTypeSupport();
    ...
    */
    public static BreakerStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static BreakerStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BreakerStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return BreakerStatus.create();
    }
    ...
    * <code>this</code> is not a <code>BreakerStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BreakerStatus typedDst = (BreakerStatus) destination;
        BreakerStatus typedSrc = (BreakerStatus) source;
        ...
        Object sample) 
    {
        ...
        BreakerStatus typedSrc = (BreakerStatus) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByte(typedSrc.__dummy_prevent_empty_class_BreakerStatus);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BreakerStatus typedDst = (BreakerStatus) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.__dummy_prevent_empty_class_BreakerStatus = src.readByte();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BreakerStatus typedDst = (BreakerStatus) sample;
    ...
    protected BreakerStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BreakerStatusTypeCode.VALUE,BreakerStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BreakerStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BreakerStatusTypeCode.VALUE,BreakerStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
