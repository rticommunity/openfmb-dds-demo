...
public class RecloserControlTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::RecloserControl";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RecloserControlKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(0, (255)+1);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RecloserControlKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        ...
        Object sample) 
    {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RecloserControlKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RecloserControlKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.type = (OpenFMB_Information_Model.openfmb.commonmodule.RecloserControlKind)OpenFMB_Information_Model.openfmb.commonmodule.RecloserControlKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RecloserControlKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
