...
public class  ESSEventTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("type", false, (short)-1,  false,(TypeCode) OpenFMB_Information_Model.openfmb.commonmodule.ESSEventKindTypeCode.VALUE,1 , false);__i++;
        sm[__i]=new  StructMember("stateOfCharge", false, (short)-1,  false,(TypeCode) TypeCode.TC_FLOAT,2 ,true);__i++;
        ...
        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("OpenFMB_Information_Model::openfmb::commonmodule::ESSEvent",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
