...
/* RecloserReadingProfilePublisher.java
 * A publication of data of type RecloserReadingProfile
 */
...
import OpenFMB_Information_Model.openfmb.reclosermodule.RecloserReadingProfileDataWriter;
import OpenFMB_Information_Model.openfmb.reclosermodule.RecloserReadingProfileTypeSupport;

// ===========================================================================

public class RecloserReadingProfilePublisher {
	
    public static RecloserReadingProfileDataWriter writer = null;

    // --- Constructors: -----------------------------------------------------

    public RecloserReadingProfilePublisher() {
        super();
    }
    ...
    public int initialize(int domainId, String  topicName, String QoSLibrary, String QoSProfile) {
        ...
        try {
            ...
            writer = (RecloserReadingProfileDataWriter)
    ...
    public void publish(RecloserReadingProfile instance) {
