...
/**
* A sequence of WindDataList instances.
*/
public final class WindDataListSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public WindDataListSeq() {
        super(WindDataList.class);
    }

    public WindDataListSeq (int initialMaximum) {
        super(WindDataList.class, initialMaximum);
    }

    public WindDataListSeq (Collection elements) {
        super(WindDataList.class, elements);
    }

    public  WindDataList get(int index) { 
        return (WindDataList) super.get(index); 
    }
