...
public class ResourceStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ResourceStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ResourceStatusTypeSupport _singleton
    = new ResourceStatusTypeSupport();
    ...
    */
    public static ResourceStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static ResourceStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ResourceStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return ResourceStatus.create();
    }
    ...
    * <code>this</code> is not a <code>ResourceStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ResourceStatus typedDst = (ResourceStatus) destination;
        ResourceStatus typedSrc = (ResourceStatus) source;
        ...
        Object sample) 
    {
        ...
        ResourceStatus typedSrc = (ResourceStatus) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByte(typedSrc.__dummy_prevent_empty_class_ResourceStatus);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ResourceStatus typedDst = (ResourceStatus) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.__dummy_prevent_empty_class_ResourceStatus = src.readByte();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ResourceStatus typedDst = (ResourceStatus) sample;
    ...
    protected ResourceStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ResourceStatusTypeCode.VALUE,ResourceStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ResourceStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ResourceStatusTypeCode.VALUE,ResourceStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
