...
public class TemperatureDataListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::TemperatureDataList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TemperatureDataListTypeSupport _singleton
    = new TemperatureDataListTypeSupport();
    ...
    */
    public static TemperatureDataListTypeSupport get_instance() {
        return _singleton;
    }

    public static TemperatureDataListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TemperatureDataListTypeCode.VALUE;
    }

    public Object create_data() {
        return TemperatureDataList.create();
    }
    ...
    public Object create_key() {
        return new TemperatureDataList();
    }
    ...
    public Class get_type() {
        return TemperatureDataList.class;
    }
    ...
    * <code>this</code> is not a <code>TemperatureDataList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TemperatureDataList typedDst = (TemperatureDataList) destination;
        TemperatureDataList typedSrc = (TemperatureDataList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.TemperatureDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.TemperatureDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        TemperatureDataList typedSrc = (TemperatureDataList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.TemperatureDataTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.temperatureData);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.TemperatureDataTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.temperatureData,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TemperatureDataList typedDst = (TemperatureDataList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.TemperatureDataTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.temperatureData, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.TemperatureDataTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TemperatureDataList typedDst = (TemperatureDataList) sample;
    ...
    protected TemperatureDataListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TemperatureDataListTypeCode.VALUE,TemperatureDataList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TemperatureDataListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TemperatureDataListTypeCode.VALUE,TemperatureDataList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
