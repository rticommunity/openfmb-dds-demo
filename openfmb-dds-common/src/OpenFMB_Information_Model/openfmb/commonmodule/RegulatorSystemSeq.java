...
/**
* A sequence of RegulatorSystem instances.
*/
public final class RegulatorSystemSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public RegulatorSystemSeq() {
        super(RegulatorSystem.class);
    }

    public RegulatorSystemSeq (int initialMaximum) {
        super(RegulatorSystem.class, initialMaximum);
    }

    public RegulatorSystemSeq (Collection elements) {
        super(RegulatorSystem.class, elements);
    }

    public  RegulatorSystem get(int index) { 
        return (RegulatorSystem) super.get(index); 
    }
