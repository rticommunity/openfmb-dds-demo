...
public class ShuntControlScheduleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ShuntControlSchedule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShuntControlScheduleTypeSupport _singleton
    = new ShuntControlScheduleTypeSupport();
    ...
    */
    public static ShuntControlScheduleTypeSupport get_instance() {
        return _singleton;
    }

    public static ShuntControlScheduleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShuntControlScheduleTypeCode.VALUE;
    }

    public Object create_data() {
        return ShuntControlSchedule.create();
    }
    ...
    public Object create_key() {
        return new ShuntControlSchedule();
    }
    ...
    public Class get_type() {
        return ShuntControlSchedule.class;
    }
    ...
    * <code>this</code> is not a <code>ShuntControlSchedule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShuntControlSchedule typedDst = (ShuntControlSchedule) destination;
        ShuntControlSchedule typedSrc = (ShuntControlSchedule) source;
        ...
        Object sample) 
    {
        ...
        ShuntControlSchedule typedSrc = (ShuntControlSchedule) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShuntControlSchedule typedDst = (ShuntControlSchedule) dst;
            typedDst.clear();      
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShuntControlSchedule typedDst = (ShuntControlSchedule) sample;
    ...
    protected ShuntControlScheduleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShuntControlScheduleTypeCode.VALUE,ShuntControlSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShuntControlScheduleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShuntControlScheduleTypeCode.VALUE,ShuntControlSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
