...
public class DiscreteTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::Discrete";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DiscreteTypeSupport _singleton
    = new DiscreteTypeSupport();
    ...
    */
    public static DiscreteTypeSupport get_instance() {
        return _singleton;
    }

    public static DiscreteTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DiscreteTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Discrete</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Discrete typedDst = (Discrete) destination;
        Discrete typedSrc = (Discrete) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.DiscreteValueTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.DiscreteValueTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        Discrete typedSrc = (Discrete) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.DiscreteValueTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.discreteMeasurementValue);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.DiscreteValueTypeSupport.get_instance().serialize(endpoint_data, typedSrc.discreteMeasurementValue, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Discrete typedDst = (Discrete) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.discreteMeasurementValue = (OpenFMB_Information_Model.openfmb.commonmodule.DiscreteValue)OpenFMB_Information_Model.openfmb.commonmodule.DiscreteValueTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.discreteMeasurementValue, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.DiscreteValueTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Discrete typedDst = (Discrete) sample;
    ...
    protected DiscreteTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DiscreteTypeCode.VALUE,Discrete.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DiscreteTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DiscreteTypeCode.VALUE,Discrete.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
