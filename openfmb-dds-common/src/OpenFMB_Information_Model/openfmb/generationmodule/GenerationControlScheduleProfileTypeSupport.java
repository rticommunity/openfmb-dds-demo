...
public class GenerationControlScheduleProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::generationmodule::GenerationControlScheduleProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationControlScheduleProfileTypeSupport _singleton
    = new GenerationControlScheduleProfileTypeSupport();
    ...
    */
    public static GenerationControlScheduleProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationControlScheduleProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationControlScheduleProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return GenerationControlScheduleProfile.create();
    }
    ...
    public Object create_key() {
        return new GenerationControlScheduleProfile();
    }
    ...
    public Class get_type() {
        return GenerationControlScheduleProfile.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationControlScheduleProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenerationControlScheduleProfile typedDst = (GenerationControlScheduleProfile) destination;
        GenerationControlScheduleProfile typedSrc = (GenerationControlScheduleProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GeneratingUnitTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationControlScheduleListTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GeneratingUnitTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationControlScheduleListTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        GenerationControlScheduleProfile typedSrc = (GenerationControlScheduleProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GeneratingUnitTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.generatingUnit);

        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationControlScheduleListTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.generationControlScheduleList);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.GeneratingUnitTypeSupport.get_instance().serialize(endpoint_data, typedSrc.generatingUnit, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            OpenFMB_Information_Model.openfmb.commonmodule.GenerationControlScheduleListTypeSupport.get_instance().serialize(endpoint_data, typedSrc.generationControlScheduleList, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        GenerationControlScheduleProfile src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenerationControlScheduleProfile typedDst = (GenerationControlScheduleProfile) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.generatingUnit = (OpenFMB_Information_Model.openfmb.commonmodule.GeneratingUnit)OpenFMB_Information_Model.openfmb.commonmodule.GeneratingUnitTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.generatingUnit, src, false, true, endpoint_plugin_qos);     
                typedDst.generationControlScheduleList = (OpenFMB_Information_Model.openfmb.commonmodule.GenerationControlScheduleList)OpenFMB_Information_Model.openfmb.commonmodule.GenerationControlScheduleListTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.generationControlScheduleList, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        GenerationControlScheduleProfile dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        GenerationControlScheduleProfile sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.GeneratingUnitTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            OpenFMB_Information_Model.openfmb.commonmodule.GenerationControlScheduleListTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenerationControlScheduleProfile typedDst = (GenerationControlScheduleProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GenerationControlScheduleProfile typedDst
        = (GenerationControlScheduleProfile) instance;
        GenerationControlScheduleProfile typedSrc
        = (GenerationControlScheduleProfile) key;
    ...
    */
    ...
    int mask) {
        return new GenerationControlScheduleProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GenerationControlScheduleProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected GenerationControlScheduleProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GenerationControlScheduleProfileTypeCode.VALUE,GenerationControlScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenerationControlScheduleProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenerationControlScheduleProfileTypeCode.VALUE,GenerationControlScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
