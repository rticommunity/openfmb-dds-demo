...
/**
* A sequence of RegulatorStatus instances.
*/
public final class RegulatorStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public RegulatorStatusSeq() {
        super(RegulatorStatus.class);
    }

    public RegulatorStatusSeq (int initialMaximum) {
        super(RegulatorStatus.class, initialMaximum);
    }

    public RegulatorStatusSeq (Collection elements) {
        super(RegulatorStatus.class, elements);
    }

    public  RegulatorStatus get(int index) { 
        return (RegulatorStatus) super.get(index); 
    }
