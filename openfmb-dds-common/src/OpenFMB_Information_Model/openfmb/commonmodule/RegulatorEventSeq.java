...
/**
* A sequence of RegulatorEvent instances.
*/
public final class RegulatorEventSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public RegulatorEventSeq() {
        super(RegulatorEvent.class);
    }

    public RegulatorEventSeq (int initialMaximum) {
        super(RegulatorEvent.class, initialMaximum);
    }

    public RegulatorEventSeq (Collection elements) {
        super(RegulatorEvent.class, elements);
    }

    public  RegulatorEvent get(int index) { 
        return (RegulatorEvent) super.get(index); 
    }
