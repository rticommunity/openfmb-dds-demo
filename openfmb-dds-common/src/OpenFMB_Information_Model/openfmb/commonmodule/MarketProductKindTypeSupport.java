...
public class MarketProductKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::MarketProductKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MarketProductKindTypeSupport _singleton
    = new MarketProductKindTypeSupport();
    ...
    */
    public static MarketProductKindTypeSupport get_instance() {
        return _singleton;
    }

    public static MarketProductKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MarketProductKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return MarketProductKind.class;
    }
    ...
    * <code>this</code> is not a <code>MarketProductKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        MarketProductKind typedSrc = (MarketProductKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = MarketProductKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected MarketProductKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MarketProductKindTypeCode.VALUE,MarketProductKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
