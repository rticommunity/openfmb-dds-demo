...
/**
* A sequence of SolarControlKind instances.
*/
public final class SolarControlKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SolarControlKindSeq() {
        super(SolarControlKind.class);
    }

    public SolarControlKindSeq (int initialMaximum) {
        super(SolarControlKind.class, initialMaximum);
    }

    public SolarControlKindSeq (Collection elements) {
        super(SolarControlKind.class, elements);
    }

    public  SolarControlKind get(int index) { 
        return (SolarControlKind) super.get(index); 
    }
