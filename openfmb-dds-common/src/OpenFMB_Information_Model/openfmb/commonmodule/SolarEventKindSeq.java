...
/**
* A sequence of SolarEventKind instances.
*/
public final class SolarEventKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SolarEventKindSeq() {
        super(SolarEventKind.class);
    }

    public SolarEventKindSeq (int initialMaximum) {
        super(SolarEventKind.class, initialMaximum);
    }

    public SolarEventKindSeq (Collection elements) {
        super(SolarEventKind.class, elements);
    }

    public  SolarEventKind get(int index) { 
        return (SolarEventKind) super.get(index); 
    }
