...
public class LoadControlScheduleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::LoadControlSchedule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LoadControlScheduleTypeSupport _singleton
    = new LoadControlScheduleTypeSupport();
    ...
    */
    public static LoadControlScheduleTypeSupport get_instance() {
        return _singleton;
    }

    public static LoadControlScheduleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LoadControlScheduleTypeCode.VALUE;
    }

    public Object create_data() {
        return LoadControlSchedule.create();
    }
    ...
    public Object create_key() {
        return new LoadControlSchedule();
    }
    ...
    public Class get_type() {
        return LoadControlSchedule.class;
    }
    ...
    * <code>this</code> is not a <code>LoadControlSchedule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LoadControlSchedule typedDst = (LoadControlSchedule) destination;
        LoadControlSchedule typedSrc = (LoadControlSchedule) source;
        ...
        Object sample) 
    {
        ...
        LoadControlSchedule typedSrc = (LoadControlSchedule) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LoadControlSchedule typedDst = (LoadControlSchedule) dst;
            typedDst.clear();      
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LoadControlSchedule typedDst = (LoadControlSchedule) sample;
    ...
    protected LoadControlScheduleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LoadControlScheduleTypeCode.VALUE,LoadControlSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LoadControlScheduleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LoadControlScheduleTypeCode.VALUE,LoadControlSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
