...
public class MotorOperatedSwitchControlScheduleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::MotorOperatedSwitchControlSchedule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MotorOperatedSwitchControlScheduleTypeSupport _singleton
    = new MotorOperatedSwitchControlScheduleTypeSupport();
    ...
    */
    public static MotorOperatedSwitchControlScheduleTypeSupport get_instance() {
        return _singleton;
    }

    public static MotorOperatedSwitchControlScheduleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MotorOperatedSwitchControlScheduleTypeCode.VALUE;
    }

    public Object create_data() {
        return MotorOperatedSwitchControlSchedule.create();
    }
    ...
    public Object create_key() {
        return new MotorOperatedSwitchControlSchedule();
    }
    ...
    public Class get_type() {
        return MotorOperatedSwitchControlSchedule.class;
    }
    ...
    * <code>this</code> is not a <code>MotorOperatedSwitchControlSchedule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MotorOperatedSwitchControlSchedule typedDst = (MotorOperatedSwitchControlSchedule) destination;
        MotorOperatedSwitchControlSchedule typedSrc = (MotorOperatedSwitchControlSchedule) source;
        ...
        Object sample) 
    {
        ...
        MotorOperatedSwitchControlSchedule typedSrc = (MotorOperatedSwitchControlSchedule) sample;
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        MotorOperatedSwitchControlSchedule src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MotorOperatedSwitchControlSchedule typedDst = (MotorOperatedSwitchControlSchedule) dst;
            typedDst.clear();      
    ...
    public void deserialize_from_cdr_buffer(
        MotorOperatedSwitchControlSchedule dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        MotorOperatedSwitchControlSchedule sample,
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MotorOperatedSwitchControlSchedule typedDst = (MotorOperatedSwitchControlSchedule) sample;
    ...
    protected MotorOperatedSwitchControlScheduleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MotorOperatedSwitchControlScheduleTypeCode.VALUE,MotorOperatedSwitchControlSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MotorOperatedSwitchControlScheduleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MotorOperatedSwitchControlScheduleTypeCode.VALUE,MotorOperatedSwitchControlSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
