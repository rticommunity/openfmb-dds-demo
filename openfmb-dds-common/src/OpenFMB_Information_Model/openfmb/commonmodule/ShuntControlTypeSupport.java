...
public class ShuntControlTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ShuntControl";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShuntControlTypeSupport _singleton
    = new ShuntControlTypeSupport();
    ...
    */
    public static ShuntControlTypeSupport get_instance() {
        return _singleton;
    }

    public static ShuntControlTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShuntControlTypeCode.VALUE;
    }

    public Object create_data() {
        return ShuntControl.create();
    }
    ...
    * <code>this</code> is not a <code>ShuntControl</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShuntControl typedDst = (ShuntControl) destination;
        ShuntControl typedSrc = (ShuntControl) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(0, (255)+1);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        ...
        Object sample) 
    {
        ...
        ShuntControl typedSrc = (ShuntControl) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShuntControl typedDst = (ShuntControl) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.type = (OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlKind)OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShuntControl typedDst = (ShuntControl) sample;
    ...
    protected ShuntControlTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShuntControlTypeCode.VALUE,ShuntControl.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShuntControlTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShuntControlTypeCode.VALUE,ShuntControl.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
