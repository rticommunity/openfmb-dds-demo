...
public class SetPointListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::SetPointList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SetPointListTypeSupport _singleton
    = new SetPointListTypeSupport();
    ...
    */
    public static SetPointListTypeSupport get_instance() {
        return _singleton;
    }

    public static SetPointListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SetPointListTypeCode.VALUE;
    }

    public Object create_data() {
        return SetPointList.create();
    }
    ...
    * <code>this</code> is not a <code>SetPointList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SetPointList typedDst = (SetPointList) destination;
        SetPointList typedSrc = (SetPointList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SetPointTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SetPointTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        SetPointList typedSrc = (SetPointList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SetPointTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.setPoint);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.SetPointTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.setPoint,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SetPointList typedDst = (SetPointList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.SetPointTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.setPoint, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.SetPointTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SetPointList typedDst = (SetPointList) sample;
    ...
    protected SetPointListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SetPointListTypeCode.VALUE,SetPointList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SetPointListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SetPointListTypeCode.VALUE,SetPointList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
