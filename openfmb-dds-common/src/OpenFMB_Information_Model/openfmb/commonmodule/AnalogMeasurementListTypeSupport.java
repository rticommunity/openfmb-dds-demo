...
public class AnalogMeasurementListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::AnalogMeasurementList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final AnalogMeasurementListTypeSupport _singleton
    = new AnalogMeasurementListTypeSupport();
    ...
    */
    public static AnalogMeasurementListTypeSupport get_instance() {
        return _singleton;
    }

    public static AnalogMeasurementListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return AnalogMeasurementListTypeCode.VALUE;
    }

    public Object create_data() {
        return AnalogMeasurementList.create();
    }
    ...
    public Object create_key() {
        return new AnalogMeasurementList();
    }
    ...
    public Class get_type() {
        return AnalogMeasurementList.class;
    }
    ...
    * <code>this</code> is not a <code>AnalogMeasurementList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        AnalogMeasurementList typedDst = (AnalogMeasurementList) destination;
        AnalogMeasurementList typedSrc = (AnalogMeasurementList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.AnalogTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.AnalogTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        AnalogMeasurementList typedSrc = (AnalogMeasurementList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.AnalogTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.analogMeasurement);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.AnalogTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.analogMeasurement,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            AnalogMeasurementList typedDst = (AnalogMeasurementList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.AnalogTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.analogMeasurement, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.AnalogTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            AnalogMeasurementList typedDst = (AnalogMeasurementList) sample;
    ...
    protected AnalogMeasurementListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,AnalogMeasurementListTypeCode.VALUE,AnalogMeasurementList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected AnalogMeasurementListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,AnalogMeasurementListTypeCode.VALUE,AnalogMeasurementList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
