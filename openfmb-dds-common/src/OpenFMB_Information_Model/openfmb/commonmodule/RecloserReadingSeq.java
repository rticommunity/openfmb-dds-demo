...
/**
* A sequence of RecloserReading instances.
*/
public final class RecloserReadingSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public RecloserReadingSeq() {
        super(RecloserReading.class);
    }

    public RecloserReadingSeq (int initialMaximum) {
        super(RecloserReading.class, initialMaximum);
    }

    public RecloserReadingSeq (Collection elements) {
        super(RecloserReading.class, elements);
    }

    public  RecloserReading get(int index) { 
        return (RecloserReading) super.get(index); 
    }
