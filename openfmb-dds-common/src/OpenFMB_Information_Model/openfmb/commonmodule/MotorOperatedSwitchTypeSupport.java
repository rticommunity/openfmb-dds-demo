...
public class MotorOperatedSwitchTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::MotorOperatedSwitch";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MotorOperatedSwitchTypeSupport _singleton
    = new MotorOperatedSwitchTypeSupport();
    ...
    */
    public static MotorOperatedSwitchTypeSupport get_instance() {
        return _singleton;
    }

    public static MotorOperatedSwitchTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MotorOperatedSwitchTypeCode.VALUE;
    }

    public Object create_data() {
        return MotorOperatedSwitch.create();
    }
    ...
    public Object create_key() {
        return new MotorOperatedSwitch();
    }
    ...
    public Class get_type() {
        return MotorOperatedSwitch.class;
    }
    ...
    * <code>this</code> is not a <code>MotorOperatedSwitch</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MotorOperatedSwitch typedDst = (MotorOperatedSwitch) destination;
        MotorOperatedSwitch typedSrc = (MotorOperatedSwitch) source;
        ...
        Object sample) 
    {
        ...
        MotorOperatedSwitch typedSrc = (MotorOperatedSwitch) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByte(typedSrc.__dummy_prevent_empty_class_MotorOperatedSwitch);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MotorOperatedSwitch typedDst = (MotorOperatedSwitch) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.__dummy_prevent_empty_class_MotorOperatedSwitch = src.readByte();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MotorOperatedSwitch typedDst = (MotorOperatedSwitch) sample;
    ...
    protected MotorOperatedSwitchTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MotorOperatedSwitchTypeCode.VALUE,MotorOperatedSwitch.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MotorOperatedSwitchTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MotorOperatedSwitchTypeCode.VALUE,MotorOperatedSwitch.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
