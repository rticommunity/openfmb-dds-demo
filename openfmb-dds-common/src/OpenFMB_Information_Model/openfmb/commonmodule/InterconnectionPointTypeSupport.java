...
public class InterconnectionPointTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::InterconnectionPoint";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final InterconnectionPointTypeSupport _singleton
    = new InterconnectionPointTypeSupport();
    ...
    */
    public static InterconnectionPointTypeSupport get_instance() {
        return _singleton;
    }

    public static InterconnectionPointTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return InterconnectionPointTypeCode.VALUE;
    }

    public Object create_data() {
        return InterconnectionPoint.create();
    }
    ...
    * <code>this</code> is not a <code>InterconnectionPoint</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        InterconnectionPoint typedDst = (InterconnectionPoint) destination;
        InterconnectionPoint typedSrc = (InterconnectionPoint) source;
        ...
        Object sample) 
    {
        ...
        InterconnectionPoint typedSrc = (InterconnectionPoint) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByte(typedSrc.__dummy_prevent_empty_class_InterconnectionPoint);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            InterconnectionPoint typedDst = (InterconnectionPoint) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.__dummy_prevent_empty_class_InterconnectionPoint = src.readByte();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            InterconnectionPoint typedDst = (InterconnectionPoint) sample;
    ...
    protected InterconnectionPointTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,InterconnectionPointTypeCode.VALUE,InterconnectionPoint.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected InterconnectionPointTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,InterconnectionPointTypeCode.VALUE,InterconnectionPoint.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
