...
public class SolarControlKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::SolarControlKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarControlKindTypeSupport _singleton
    = new SolarControlKindTypeSupport();
    ...
    */
    public static SolarControlKindTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarControlKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarControlKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>SolarControlKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        SolarControlKind typedSrc = (SolarControlKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = SolarControlKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected SolarControlKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SolarControlKindTypeCode.VALUE,SolarControlKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
