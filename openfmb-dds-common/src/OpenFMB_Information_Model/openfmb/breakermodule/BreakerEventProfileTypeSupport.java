...
public class BreakerEventProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::breakermodule::BreakerEventProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BreakerEventProfileTypeSupport _singleton
    = new BreakerEventProfileTypeSupport();
    ...
    */
    public static BreakerEventProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static BreakerEventProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BreakerEventProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return BreakerEventProfile.create();
    }
    ...
    public Object create_key() {
        return new BreakerEventProfile();
    }
    ...
    public Class get_type() {
        return BreakerEventProfile.class;
    }
    ...
    * <code>this</code> is not a <code>BreakerEventProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BreakerEventProfile typedDst = (BreakerEventProfile) destination;
        BreakerEventProfile typedSrc = (BreakerEventProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerEventTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerEventTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        BreakerEventProfile typedSrc = (BreakerEventProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerEventTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.breakerEvent);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.BreakerEventTypeSupport.get_instance().serialize(endpoint_data, typedSrc.breakerEvent, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BreakerEventProfile typedDst = (BreakerEventProfile) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.breakerEvent = (OpenFMB_Information_Model.openfmb.commonmodule.BreakerEvent)OpenFMB_Information_Model.openfmb.commonmodule.BreakerEventTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.breakerEvent, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.BreakerEventTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BreakerEventProfile typedDst = (BreakerEventProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        BreakerEventProfile typedDst
        = (BreakerEventProfile) instance;
        BreakerEventProfile typedSrc
        = (BreakerEventProfile) key;
    ...
    */
    ...
    int mask) {
        return new BreakerEventProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BreakerEventProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected BreakerEventProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,BreakerEventProfileTypeCode.VALUE,BreakerEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BreakerEventProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BreakerEventProfileTypeCode.VALUE,BreakerEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
