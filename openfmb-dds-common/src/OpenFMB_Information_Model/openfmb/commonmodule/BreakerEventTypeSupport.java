...
public class BreakerEventTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::BreakerEvent";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BreakerEventTypeSupport _singleton
    = new BreakerEventTypeSupport();
    ...
    */
    public static BreakerEventTypeSupport get_instance() {
        return _singleton;
    }

    public static BreakerEventTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BreakerEventTypeCode.VALUE;
    }

    public Object create_data() {
        return BreakerEvent.create();
    }
    ...
    * <code>this</code> is not a <code>BreakerEvent</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BreakerEvent typedDst = (BreakerEvent) destination;
        BreakerEvent typedSrc = (BreakerEvent) source;
        ...
        Object sample) 
    {
        ...
        BreakerEvent typedSrc = (BreakerEvent) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BreakerEvent typedDst = (BreakerEvent) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BreakerEvent typedDst = (BreakerEvent) sample;
    ...
    protected BreakerEventTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BreakerEventTypeCode.VALUE,BreakerEvent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BreakerEventTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BreakerEventTypeCode.VALUE,BreakerEvent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
