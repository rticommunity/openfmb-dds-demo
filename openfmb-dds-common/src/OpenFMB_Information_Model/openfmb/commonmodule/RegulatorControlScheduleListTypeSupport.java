...
public class RegulatorControlScheduleListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::RegulatorControlScheduleList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RegulatorControlScheduleListTypeSupport _singleton
    = new RegulatorControlScheduleListTypeSupport();
    ...
    */
    public static RegulatorControlScheduleListTypeSupport get_instance() {
        return _singleton;
    }

    public static RegulatorControlScheduleListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RegulatorControlScheduleListTypeCode.VALUE;
    }

    public Object create_data() {
        return RegulatorControlScheduleList.create();
    }
    ...
    public Object create_key() {
        return new RegulatorControlScheduleList();
    }
    ...
    public Class get_type() {
        return RegulatorControlScheduleList.class;
    }
    ...
    * <code>this</code> is not a <code>RegulatorControlScheduleList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RegulatorControlScheduleList typedDst = (RegulatorControlScheduleList) destination;
        RegulatorControlScheduleList typedSrc = (RegulatorControlScheduleList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorControlScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorControlScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        RegulatorControlScheduleList typedSrc = (RegulatorControlScheduleList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorControlScheduleTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.regulatorControlSchedule);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorControlScheduleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.regulatorControlSchedule,100, endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        RegulatorControlScheduleList src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RegulatorControlScheduleList typedDst = (RegulatorControlScheduleList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.RegulatorControlScheduleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.regulatorControlSchedule, src, 100, endpoint_plugin_qos);            
    ...
    public void deserialize_from_cdr_buffer(
        RegulatorControlScheduleList dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        RegulatorControlScheduleList sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorControlScheduleTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RegulatorControlScheduleList typedDst = (RegulatorControlScheduleList) sample;
    ...
    protected RegulatorControlScheduleListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RegulatorControlScheduleListTypeCode.VALUE,RegulatorControlScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RegulatorControlScheduleListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RegulatorControlScheduleListTypeCode.VALUE,RegulatorControlScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
