...
/**
* A sequence of BreakerReading instances.
*/
public final class BreakerReadingSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public BreakerReadingSeq() {
        super(BreakerReading.class);
    }

    public BreakerReadingSeq (int initialMaximum) {
        super(BreakerReading.class, initialMaximum);
    }

    public BreakerReadingSeq (Collection elements) {
        super(BreakerReading.class, elements);
    }

    public  BreakerReading get(int index) { 
        return (BreakerReading) super.get(index); 
    }
