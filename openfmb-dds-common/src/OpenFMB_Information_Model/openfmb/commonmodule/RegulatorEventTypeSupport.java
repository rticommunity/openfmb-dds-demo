...
public class RegulatorEventTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::RegulatorEvent";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RegulatorEventTypeSupport _singleton
    = new RegulatorEventTypeSupport();
    ...
    */
    public static RegulatorEventTypeSupport get_instance() {
        return _singleton;
    }

    public static RegulatorEventTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RegulatorEventTypeCode.VALUE;
    }

    public Object create_data() {
        return RegulatorEvent.create();
    }
    ...
    * <code>this</code> is not a <code>RegulatorEvent</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RegulatorEvent typedDst = (RegulatorEvent) destination;
        RegulatorEvent typedSrc = (RegulatorEvent) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorEventKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorEventKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        ...
        Object sample) 
    {
        ...
        RegulatorEvent typedSrc = (RegulatorEvent) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorEventKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorEventKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RegulatorEvent typedDst = (RegulatorEvent) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.type = (OpenFMB_Information_Model.openfmb.commonmodule.RegulatorEventKind)OpenFMB_Information_Model.openfmb.commonmodule.RegulatorEventKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorEventKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RegulatorEvent typedDst = (RegulatorEvent) sample;
    ...
    protected RegulatorEventTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RegulatorEventTypeCode.VALUE,RegulatorEvent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RegulatorEventTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RegulatorEventTypeCode.VALUE,RegulatorEvent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
