...
public class SolarEventKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::SolarEventKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarEventKindTypeSupport _singleton
    = new SolarEventKindTypeSupport();
    ...
    */
    public static SolarEventKindTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarEventKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarEventKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>SolarEventKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        SolarEventKind typedSrc = (SolarEventKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = SolarEventKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected SolarEventKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SolarEventKindTypeCode.VALUE,SolarEventKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
