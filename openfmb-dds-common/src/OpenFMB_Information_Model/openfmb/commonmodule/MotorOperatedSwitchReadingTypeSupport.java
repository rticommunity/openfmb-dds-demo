...
public class MotorOperatedSwitchReadingTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::MotorOperatedSwitchReading";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MotorOperatedSwitchReadingTypeSupport _singleton
    = new MotorOperatedSwitchReadingTypeSupport();
    ...
    */
    public static MotorOperatedSwitchReadingTypeSupport get_instance() {
        return _singleton;
    }

    public static MotorOperatedSwitchReadingTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MotorOperatedSwitchReadingTypeCode.VALUE;
    }

    public Object create_data() {
        return MotorOperatedSwitchReading.create();
    }
    ...
    public Object create_key() {
        return new MotorOperatedSwitchReading();
    }
    ...
    public Class get_type() {
        return MotorOperatedSwitchReading.class;
    }
    ...
    * <code>this</code> is not a <code>MotorOperatedSwitchReading</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MotorOperatedSwitchReading typedDst = (MotorOperatedSwitchReading) destination;
        MotorOperatedSwitchReading typedSrc = (MotorOperatedSwitchReading) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ReadingTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false,encapsulation_id,currentAlignment);
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingTypeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ReadingTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false,encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingTypeKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        MotorOperatedSwitchReading typedSrc = (MotorOperatedSwitchReading) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ReadingTypeSupport.get_instance().get_serialized_sample_size(
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(epd.getAlignment(currentAlignment), 4) + 12);
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.terminalID != null) {

            currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.terminalID );

            currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        }

        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingTypeKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ReadingTypeSupport.get_instance().serialize(endpoint_data,src,dst,false,encapsulation_id,serialize_sample,endpoint_plugin_qos);
            ...
            if (typedSrc.terminalID != null) {
                dst.writeString(typedSrc.terminalID,255);
            }
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingTypeKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        MotorOperatedSwitchReading src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MotorOperatedSwitchReading typedDst = (MotorOperatedSwitchReading) dst;
            typedDst.clear();      
            OpenFMB_Information_Model.openfmb.commonmodule.ReadingTypeSupport.get_instance().deserialize_sample(endpoint_data,dst,src,false,deserialize_sample,endpoint_plugin_qos);
            ...
            try{
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.terminalID = src.readString(255);
                }
                else {
                    typedDst.terminalID = null;
                }
                src.getBuffer().setDesBufferSize(tmpSize);
                src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));

                typedDst.type = (OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingTypeKind)OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingTypeKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        MotorOperatedSwitchReading dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        MotorOperatedSwitchReading sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ReadingTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingTypeKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MotorOperatedSwitchReading typedDst = (MotorOperatedSwitchReading) sample;
    ...
    protected MotorOperatedSwitchReadingTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MotorOperatedSwitchReadingTypeCode.VALUE,MotorOperatedSwitchReading.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MotorOperatedSwitchReadingTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MotorOperatedSwitchReadingTypeCode.VALUE,MotorOperatedSwitchReading.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
