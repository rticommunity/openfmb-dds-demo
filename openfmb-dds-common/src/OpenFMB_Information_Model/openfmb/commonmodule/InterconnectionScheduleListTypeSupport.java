...
public class InterconnectionScheduleListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::InterconnectionScheduleList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final InterconnectionScheduleListTypeSupport _singleton
    = new InterconnectionScheduleListTypeSupport();
    ...
    */
    public static InterconnectionScheduleListTypeSupport get_instance() {
        return _singleton;
    }

    public static InterconnectionScheduleListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return InterconnectionScheduleListTypeCode.VALUE;
    }

    public Object create_data() {
        return InterconnectionScheduleList.create();
    }
    ...
    public Object create_key() {
        return new InterconnectionScheduleList();
    }
    ...
    public Class get_type() {
        return InterconnectionScheduleList.class;
    }
    ...
    * <code>this</code> is not a <code>InterconnectionScheduleList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        InterconnectionScheduleList typedDst = (InterconnectionScheduleList) destination;
        InterconnectionScheduleList typedSrc = (InterconnectionScheduleList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        InterconnectionScheduleList typedSrc = (InterconnectionScheduleList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionScheduleTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.interconnectionSchedule);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionScheduleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.interconnectionSchedule,100, endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        InterconnectionScheduleList src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            InterconnectionScheduleList typedDst = (InterconnectionScheduleList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionScheduleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.interconnectionSchedule, src, 100, endpoint_plugin_qos);            
    ...
    public void deserialize_from_cdr_buffer(
        InterconnectionScheduleList dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        InterconnectionScheduleList sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.InterconnectionScheduleTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            InterconnectionScheduleList typedDst = (InterconnectionScheduleList) sample;
    ...
    protected InterconnectionScheduleListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,InterconnectionScheduleListTypeCode.VALUE,InterconnectionScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected InterconnectionScheduleListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,InterconnectionScheduleListTypeCode.VALUE,InterconnectionScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
