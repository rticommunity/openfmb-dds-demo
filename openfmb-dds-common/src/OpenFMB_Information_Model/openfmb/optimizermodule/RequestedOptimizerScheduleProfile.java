...
public class RequestedOptimizerScheduleProfile  extends OpenFMB_Information_Model.openfmb.commonmodule.Container implements Copyable, Serializable{
    ...
    public OpenFMB_Information_Model.openfmb.optimizermodule.RequestedInterconnectionScheduleProfileList requestedInterconnectionScheduleProfileList = null ;
    ...
    public RequestedOptimizerScheduleProfile() {

        super();

    }
    public RequestedOptimizerScheduleProfile (RequestedOptimizerScheduleProfile other) {
    ...
    public static Object create() {
        ...
        RequestedOptimizerScheduleProfile self;
        self = new  RequestedOptimizerScheduleProfile();
        self.clear();
        return self;
    ...
    public boolean equals(Object o) {
        ...
        RequestedOptimizerScheduleProfile otherObj = (RequestedOptimizerScheduleProfile)o;
        ...
        if ((requestedInterconnectionScheduleProfileList == null && otherObj.requestedInterconnectionScheduleProfileList != null) ||
        (requestedInterconnectionScheduleProfileList != null && otherObj.requestedInterconnectionScheduleProfileList == null)) {
            return false;
        }
        if (requestedInterconnectionScheduleProfileList != null) {
            if(!requestedInterconnectionScheduleProfileList.equals(otherObj.requestedInterconnectionScheduleProfileList)) {
                return false;
            }
        }
    ...
    public int hashCode() {
        ...
        if (requestedInterconnectionScheduleProfileList != null) {
            __result += requestedInterconnectionScheduleProfileList.hashCode(); 
        }
        if (essControlScheduleProfileList != null) {
    ...
    * This method could be placed into <code>RequestedOptimizerScheduleProfileTypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        RequestedOptimizerScheduleProfile typedSrc = (RequestedOptimizerScheduleProfile) src;
        RequestedOptimizerScheduleProfile typedDst = this;
        ...
        if (typedDst.requestedInterconnectionScheduleProfileList == null && typedSrc.requestedInterconnectionScheduleProfileList !=null){
            typedDst.requestedInterconnectionScheduleProfileList = 
            (OpenFMB_Information_Model.openfmb.optimizermodule.RequestedInterconnectionScheduleProfileList)OpenFMB_Information_Model.openfmb.optimizermodule.RequestedInterconnectionScheduleProfileList.create();
        }
        if(typedSrc.requestedInterconnectionScheduleProfileList !=null){
            typedDst.requestedInterconnectionScheduleProfileList = (OpenFMB_Information_Model.openfmb.optimizermodule.RequestedInterconnectionScheduleProfileList) typedDst.requestedInterconnectionScheduleProfileList.copy_from(typedSrc.requestedInterconnectionScheduleProfileList);
        } else{
            typedDst.requestedInterconnectionScheduleProfileList=null;
        }
    ...
    public String toString(String desc, int indent) {
        ...
        if (requestedInterconnectionScheduleProfileList != null) {
            strBuffer.append(requestedInterconnectionScheduleProfileList.toString("requestedInterconnectionScheduleProfileList ", indent+1));
        } else {
            CdrHelper.printIndent(strBuffer, indent+1);
            strBuffer.append("requestedInterconnectionScheduleProfileList: null\n");
        }
        if (essControlScheduleProfileList != null) {
