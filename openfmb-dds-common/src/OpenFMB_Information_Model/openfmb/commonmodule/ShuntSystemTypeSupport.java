...
public class ShuntSystemTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ShuntSystem";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShuntSystemTypeSupport _singleton
    = new ShuntSystemTypeSupport();
    ...
    */
    public static ShuntSystemTypeSupport get_instance() {
        return _singleton;
    }

    public static ShuntSystemTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShuntSystemTypeCode.VALUE;
    }

    public Object create_data() {
        return ShuntSystem.create();
    }
    ...
    * <code>this</code> is not a <code>ShuntSystem</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShuntSystem typedDst = (ShuntSystem) destination;
        ShuntSystem typedSrc = (ShuntSystem) source;
        ...
        Object sample) 
    {
        ...
        ShuntSystem typedSrc = (ShuntSystem) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByte(typedSrc.__dummy_prevent_empty_class_ShuntSystem);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShuntSystem typedDst = (ShuntSystem) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.__dummy_prevent_empty_class_ShuntSystem = src.readByte();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShuntSystem typedDst = (ShuntSystem) sample;
    ...
    protected ShuntSystemTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShuntSystemTypeCode.VALUE,ShuntSystem.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShuntSystemTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShuntSystemTypeCode.VALUE,ShuntSystem.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
