...
/* RecloserControlProfilePublisher.java
 * A publication of data of type RecloserControlProfile
 */
...
import OpenFMB_Information_Model.openfmb.reclosermodule.RecloserControlProfileDataWriter;
import OpenFMB_Information_Model.openfmb.reclosermodule.RecloserControlProfileTypeSupport;

// ===========================================================================

public class RecloserControlProfilePublisher {
	
    public static RecloserControlProfileDataWriter writer = null;

    // --- Constructors: -----------------------------------------------------

    public RecloserControlProfilePublisher() {
        super();
    }
    ...
    public int initialize(int domainId, String  topicName, String qosLibrary, String qosProfile) {
        ...
        try {
            ...
            writer = (RecloserControlProfileDataWriter)
    ...
    public void publish(RecloserControlProfile instance) {
