...
/**
* A sequence of SolarReading instances.
*/
public final class SolarReadingSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SolarReadingSeq() {
        super(SolarReading.class);
    }

    public SolarReadingSeq (int initialMaximum) {
        super(SolarReading.class, initialMaximum);
    }

    public SolarReadingSeq (Collection elements) {
        super(SolarReading.class, elements);
    }

    public  SolarReading get(int index) { 
        return (SolarReading) super.get(index); 
    }
