...
package openfmb.rti.publisher.weathermodule;

/* WeatherDataProfilePublisher.java
 * A publication of data of type WeatherDataProfile
 */
...
import OpenFMB_Information_Model.openfmb.weathermodule.WeatherDataProfileDataWriter;
import OpenFMB_Information_Model.openfmb.weathermodule.WeatherDataProfileTypeSupport;

// ===========================================================================

public class WeatherDataProfilePublisher {
	
    public static WeatherDataProfileDataWriter writer = null;

    // --- Constructors: -----------------------------------------------------

    public WeatherDataProfilePublisher() {
        super();
    }
    ...
    public int initialize(int domainId, String  topicName) {
        ...
        try {
            ...
            writer = (WeatherDataProfileDataWriter)
    ...
    public void publish(WeatherDataProfile instance) {
