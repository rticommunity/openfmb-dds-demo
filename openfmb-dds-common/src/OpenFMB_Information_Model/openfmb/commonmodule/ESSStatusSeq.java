...
/**
* A sequence of ESSStatus instances.
*/
public final class ESSStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ESSStatusSeq() {
        super(ESSStatus.class);
    }

    public ESSStatusSeq (int initialMaximum) {
        super(ESSStatus.class, initialMaximum);
    }

    public ESSStatusSeq (Collection elements) {
        super(ESSStatus.class, elements);
    }

    public  ESSStatus get(int index) { 
        return (ESSStatus) super.get(index); 
    }
