...
public class InterchangeScheduleProfileTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::interchangemodule::InterchangeScheduleProfile";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InterchangeScheduleListTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.PowerSystemResourceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InterchangeScheduleListTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.PowerSystemResourceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InterchangeScheduleListTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.interchangeScheduleList);

        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.PowerSystemResourceTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.InterchangeScheduleListTypeSupport.get_instance().serialize(endpoint_data, typedSrc.interchangeScheduleList, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            OpenFMB_Information_Model.openfmb.commonmodule.PowerSystemResourceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.powerSystemResource, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                typedDst.interchangeScheduleList = (OpenFMB_Information_Model.openfmb.commonmodule.InterchangeScheduleList)OpenFMB_Information_Model.openfmb.commonmodule.InterchangeScheduleListTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.interchangeScheduleList, src, false, true, endpoint_plugin_qos);     
                typedDst.powerSystemResource = (OpenFMB_Information_Model.openfmb.commonmodule.PowerSystemResource)OpenFMB_Information_Model.openfmb.commonmodule.PowerSystemResourceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.powerSystemResource, src, false, true, endpoint_plugin_qos);     
    ...
    public String data_to_string(
        InterchangeScheduleProfile sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.InterchangeScheduleListTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            OpenFMB_Information_Model.openfmb.commonmodule.PowerSystemResourceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
