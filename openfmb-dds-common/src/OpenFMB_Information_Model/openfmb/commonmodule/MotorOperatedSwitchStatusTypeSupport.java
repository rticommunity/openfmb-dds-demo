...
public class MotorOperatedSwitchStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::MotorOperatedSwitchStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MotorOperatedSwitchStatusTypeSupport _singleton
    = new MotorOperatedSwitchStatusTypeSupport();
    ...
    */
    public static MotorOperatedSwitchStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static MotorOperatedSwitchStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MotorOperatedSwitchStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return MotorOperatedSwitchStatus.create();
    }
    ...
    public Object create_key() {
        return new MotorOperatedSwitchStatus();
    }
    ...
    public Class get_type() {
        return MotorOperatedSwitchStatus.class;
    }
    ...
    * <code>this</code> is not a <code>MotorOperatedSwitchStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MotorOperatedSwitchStatus typedDst = (MotorOperatedSwitchStatus) destination;
        MotorOperatedSwitchStatus typedSrc = (MotorOperatedSwitchStatus) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.StatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false,encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.StatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false,encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.BYTE.getMaxSizeSerialized(currentAlignment );
        ...
        Object sample) 
    {
        ...
        MotorOperatedSwitchStatus typedSrc = (MotorOperatedSwitchStatus) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.StatusTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data, false, encapsulation_id, currentAlignment, sample);

        currentAlignment  +=  CdrPrimitiveType.BYTE.getMaxSizeSerialized(epd.getAlignment(currentAlignment));
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.StatusTypeSupport.get_instance().serialize(endpoint_data,src,dst,false,encapsulation_id,serialize_sample,endpoint_plugin_qos);

            dst.writeByte(typedSrc.__dummy_prevent_empty_class_MotorOperatedSwitchStatus);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MotorOperatedSwitchStatus typedDst = (MotorOperatedSwitchStatus) dst;
            typedDst.clear();      
            OpenFMB_Information_Model.openfmb.commonmodule.StatusTypeSupport.get_instance().deserialize_sample(endpoint_data,dst,src,false,deserialize_sample,endpoint_plugin_qos);

            try{
                typedDst.__dummy_prevent_empty_class_MotorOperatedSwitchStatus = src.readByte();
    ...
    public String data_to_string(
        MotorOperatedSwitchStatus sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.StatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            src.skipByte();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MotorOperatedSwitchStatus typedDst = (MotorOperatedSwitchStatus) sample;
    ...
    protected MotorOperatedSwitchStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MotorOperatedSwitchStatusTypeCode.VALUE,MotorOperatedSwitchStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MotorOperatedSwitchStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MotorOperatedSwitchStatusTypeCode.VALUE,MotorOperatedSwitchStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
