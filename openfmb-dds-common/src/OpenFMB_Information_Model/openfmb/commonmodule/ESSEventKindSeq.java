...
/**
* A sequence of ESSEventKind instances.
*/
public final class ESSEventKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ESSEventKindSeq() {
        super(ESSEventKind.class);
    }

    public ESSEventKindSeq (int initialMaximum) {
        super(ESSEventKind.class, initialMaximum);
    }

    public ESSEventKindSeq (Collection elements) {
        super(ESSEventKind.class, elements);
    }

    public  ESSEventKind get(int index) { 
        return (ESSEventKind) super.get(index); 
    }
