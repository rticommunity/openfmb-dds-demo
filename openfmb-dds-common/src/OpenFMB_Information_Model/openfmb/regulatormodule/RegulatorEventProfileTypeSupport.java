...
public class RegulatorEventProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::regulatormodule::RegulatorEventProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RegulatorEventProfileTypeSupport _singleton
    = new RegulatorEventProfileTypeSupport();
    ...
    */
    public static RegulatorEventProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static RegulatorEventProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RegulatorEventProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return RegulatorEventProfile.create();
    }
    ...
    public Object create_key() {
        return new RegulatorEventProfile();
    }
    ...
    public Class get_type() {
        return RegulatorEventProfile.class;
    }
    ...
    * <code>this</code> is not a <code>RegulatorEventProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RegulatorEventProfile typedDst = (RegulatorEventProfile) destination;
        RegulatorEventProfile typedSrc = (RegulatorEventProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorEventTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorEventTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        RegulatorEventProfile typedSrc = (RegulatorEventProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorEventTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.regulatorEvent);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorEventTypeSupport.get_instance().serialize(endpoint_data, typedSrc.regulatorEvent, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RegulatorEventProfile typedDst = (RegulatorEventProfile) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.regulatorEvent = (OpenFMB_Information_Model.openfmb.commonmodule.RegulatorEvent)OpenFMB_Information_Model.openfmb.commonmodule.RegulatorEventTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.regulatorEvent, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorEventTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RegulatorEventProfile typedDst = (RegulatorEventProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        RegulatorEventProfile typedDst
        = (RegulatorEventProfile) instance;
        RegulatorEventProfile typedSrc
        = (RegulatorEventProfile) key;
    ...
    */
    ...
    int mask) {
        return new RegulatorEventProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new RegulatorEventProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected RegulatorEventProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,RegulatorEventProfileTypeCode.VALUE,RegulatorEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RegulatorEventProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RegulatorEventProfileTypeCode.VALUE,RegulatorEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
