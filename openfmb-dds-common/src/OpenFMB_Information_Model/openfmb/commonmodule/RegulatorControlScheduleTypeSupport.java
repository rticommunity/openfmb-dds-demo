...
public class RegulatorControlScheduleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::RegulatorControlSchedule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RegulatorControlScheduleTypeSupport _singleton
    = new RegulatorControlScheduleTypeSupport();
    ...
    */
    public static RegulatorControlScheduleTypeSupport get_instance() {
        return _singleton;
    }

    public static RegulatorControlScheduleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RegulatorControlScheduleTypeCode.VALUE;
    }

    public Object create_data() {
        return RegulatorControlSchedule.create();
    }
    ...
    public Object create_key() {
        return new RegulatorControlSchedule();
    }
    ...
    public Class get_type() {
        return RegulatorControlSchedule.class;
    }
    ...
    * <code>this</code> is not a <code>RegulatorControlSchedule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RegulatorControlSchedule typedDst = (RegulatorControlSchedule) destination;
        RegulatorControlSchedule typedSrc = (RegulatorControlSchedule) source;
        ...
        Object sample) 
    {
        ...
        RegulatorControlSchedule typedSrc = (RegulatorControlSchedule) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RegulatorControlSchedule typedDst = (RegulatorControlSchedule) dst;
            typedDst.clear();      
    ...
    public String data_to_string(
        RegulatorControlSchedule sample,
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RegulatorControlSchedule typedDst = (RegulatorControlSchedule) sample;
    ...
    protected RegulatorControlScheduleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RegulatorControlScheduleTypeCode.VALUE,RegulatorControlSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RegulatorControlScheduleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RegulatorControlScheduleTypeCode.VALUE,RegulatorControlSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
