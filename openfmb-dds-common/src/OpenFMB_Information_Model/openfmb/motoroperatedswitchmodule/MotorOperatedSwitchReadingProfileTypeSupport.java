...
public class MotorOperatedSwitchReadingProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::motoroperatedswitchmodule::MotorOperatedSwitchReadingProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MotorOperatedSwitchReadingProfileTypeSupport _singleton
    = new MotorOperatedSwitchReadingProfileTypeSupport();
    ...
    */
    public static MotorOperatedSwitchReadingProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static MotorOperatedSwitchReadingProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MotorOperatedSwitchReadingProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return MotorOperatedSwitchReadingProfile.create();
    }
    ...
    public Object create_key() {
        return new MotorOperatedSwitchReadingProfile();
    }
    ...
    public Class get_type() {
        return MotorOperatedSwitchReadingProfile.class;
    }
    ...
    * <code>this</code> is not a <code>MotorOperatedSwitchReadingProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MotorOperatedSwitchReadingProfile typedDst = (MotorOperatedSwitchReadingProfile) destination;
        MotorOperatedSwitchReadingProfile typedSrc = (MotorOperatedSwitchReadingProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingListTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingListTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        MotorOperatedSwitchReadingProfile typedSrc = (MotorOperatedSwitchReadingProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingListTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.motorOperatedSwitchReadingList);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingListTypeSupport.get_instance().serialize(endpoint_data, typedSrc.motorOperatedSwitchReadingList, dst, false, encapsulation_id,true,endpoint_plugin_qos);
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        MotorOperatedSwitchReadingProfile src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MotorOperatedSwitchReadingProfile typedDst = (MotorOperatedSwitchReadingProfile) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.motorOperatedSwitchReadingList = (OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingList)OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingListTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.motorOperatedSwitchReadingList, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        MotorOperatedSwitchReadingProfile dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        MotorOperatedSwitchReadingProfile sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchReadingListTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MotorOperatedSwitchReadingProfile typedDst = (MotorOperatedSwitchReadingProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        MotorOperatedSwitchReadingProfile typedDst
        = (MotorOperatedSwitchReadingProfile) instance;
        MotorOperatedSwitchReadingProfile typedSrc
        = (MotorOperatedSwitchReadingProfile) key;
    ...
    */
    ...
    int mask) {
        return new MotorOperatedSwitchReadingProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MotorOperatedSwitchReadingProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected MotorOperatedSwitchReadingProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,MotorOperatedSwitchReadingProfileTypeCode.VALUE,MotorOperatedSwitchReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MotorOperatedSwitchReadingProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MotorOperatedSwitchReadingProfileTypeCode.VALUE,MotorOperatedSwitchReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
