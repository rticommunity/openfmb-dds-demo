...
public class SolarInverterEventTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::SolarInverterEvent";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarInverterEventTypeSupport _singleton
    = new SolarInverterEventTypeSupport();
    ...
    */
    public static SolarInverterEventTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarInverterEventTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarInverterEventTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarInverterEvent.create();
    }
    ...
    public Class get_type() {
        return SolarInverterEvent.class;
    }
    ...
    * <code>this</code> is not a <code>SolarInverterEvent</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarInverterEvent typedDst = (SolarInverterEvent) destination;
        SolarInverterEvent typedSrc = (SolarInverterEvent) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarEventKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarEventKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        ...
        Object sample) 
    {
        ...
        SolarInverterEvent typedSrc = (SolarInverterEvent) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarEventKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.SolarEventKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarInverterEvent typedDst = (SolarInverterEvent) dst;
            typedDst.clear();      
            try{
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.isConnected = null;
                }
                src.getBuffer().setDesBufferSize(tmpSize);
                src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));

                typedDst.type = (OpenFMB_Information_Model.openfmb.commonmodule.SolarEventKind)OpenFMB_Information_Model.openfmb.commonmodule.SolarEventKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.SolarEventKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarInverterEvent typedDst = (SolarInverterEvent) sample;
    ...
    protected SolarInverterEventTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SolarInverterEventTypeCode.VALUE,SolarInverterEvent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarInverterEventTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarInverterEventTypeCode.VALUE,SolarInverterEvent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
