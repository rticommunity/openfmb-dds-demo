...
public class LoadReadingListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::LoadReadingList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LoadReadingListTypeSupport _singleton
    = new LoadReadingListTypeSupport();
    ...
    */
    public static LoadReadingListTypeSupport get_instance() {
        return _singleton;
    }

    public static LoadReadingListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LoadReadingListTypeCode.VALUE;
    }

    public Object create_data() {
        return LoadReadingList.create();
    }
    ...
    * <code>this</code> is not a <code>LoadReadingList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LoadReadingList typedDst = (LoadReadingList) destination;
        LoadReadingList typedSrc = (LoadReadingList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.LoadReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.LoadReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        LoadReadingList typedSrc = (LoadReadingList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.LoadReadingTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.loadReading);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.LoadReadingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.loadReading,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LoadReadingList typedDst = (LoadReadingList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.LoadReadingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.loadReading, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.LoadReadingTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LoadReadingList typedDst = (LoadReadingList) sample;
    ...
    protected LoadReadingListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LoadReadingListTypeCode.VALUE,LoadReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LoadReadingListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LoadReadingListTypeCode.VALUE,LoadReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
