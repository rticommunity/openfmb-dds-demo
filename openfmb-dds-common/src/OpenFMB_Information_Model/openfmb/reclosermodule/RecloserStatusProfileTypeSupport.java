...
public class RecloserStatusProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::reclosermodule::RecloserStatusProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RecloserStatusProfileTypeSupport _singleton
    = new RecloserStatusProfileTypeSupport();
    ...
    */
    public static RecloserStatusProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static RecloserStatusProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RecloserStatusProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return RecloserStatusProfile.create();
    }
    ...
    public Object create_key() {
        return new RecloserStatusProfile();
    }
    ...
    public Class get_type() {
        return RecloserStatusProfile.class;
    }
    ...
    * <code>this</code> is not a <code>RecloserStatusProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RecloserStatusProfile typedDst = (RecloserStatusProfile) destination;
        RecloserStatusProfile typedSrc = (RecloserStatusProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RecloserTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RecloserStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RecloserTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RecloserStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        RecloserStatusProfile typedSrc = (RecloserStatusProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RecloserTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.recloser);

        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RecloserStatusTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RecloserTypeSupport.get_instance().serialize(endpoint_data, typedSrc.recloser, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            OpenFMB_Information_Model.openfmb.commonmodule.RecloserStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.recloserStatus, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RecloserStatusProfile typedDst = (RecloserStatusProfile) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.recloser = (OpenFMB_Information_Model.openfmb.commonmodule.Recloser)OpenFMB_Information_Model.openfmb.commonmodule.RecloserTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.recloser, src, false, true, endpoint_plugin_qos);     
                typedDst.recloserStatus = (OpenFMB_Information_Model.openfmb.commonmodule.RecloserStatus)OpenFMB_Information_Model.openfmb.commonmodule.RecloserStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.recloserStatus, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RecloserTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            OpenFMB_Information_Model.openfmb.commonmodule.RecloserStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RecloserStatusProfile typedDst = (RecloserStatusProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        RecloserStatusProfile typedDst
        = (RecloserStatusProfile) instance;
        RecloserStatusProfile typedSrc
        = (RecloserStatusProfile) key;
    ...
    */
    ...
    int mask) {
        return new RecloserStatusProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new RecloserStatusProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected RecloserStatusProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,RecloserStatusProfileTypeCode.VALUE,RecloserStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RecloserStatusProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RecloserStatusProfileTypeCode.VALUE,RecloserStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
