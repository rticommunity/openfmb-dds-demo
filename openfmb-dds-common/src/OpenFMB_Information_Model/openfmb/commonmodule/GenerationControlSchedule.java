...
public class GenerationControlSchedule  extends OpenFMB_Information_Model.openfmb.commonmodule.Curve implements Copyable, Serializable{

    public OpenFMB_Information_Model.openfmb.commonmodule.DateTimeInterval dateTimeInterval = null ;

    public GenerationControlSchedule() {

        super();

    }
    public GenerationControlSchedule (GenerationControlSchedule other) {
    ...
    public static Object create() {
        ...
        GenerationControlSchedule self;
        self = new  GenerationControlSchedule();
        self.clear();
        return self;
    ...
    public boolean equals(Object o) {
        ...
        GenerationControlSchedule otherObj = (GenerationControlSchedule)o;
    ...
    * This method could be placed into <code>GenerationControlScheduleTypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        GenerationControlSchedule typedSrc = (GenerationControlSchedule) src;
        GenerationControlSchedule typedDst = this;
