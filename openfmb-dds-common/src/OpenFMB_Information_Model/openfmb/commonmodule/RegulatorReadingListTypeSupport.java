...
public class RegulatorReadingListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::RegulatorReadingList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RegulatorReadingListTypeSupport _singleton
    = new RegulatorReadingListTypeSupport();
    ...
    */
    public static RegulatorReadingListTypeSupport get_instance() {
        return _singleton;
    }

    public static RegulatorReadingListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RegulatorReadingListTypeCode.VALUE;
    }

    public Object create_data() {
        return RegulatorReadingList.create();
    }
    ...
    public Object create_key() {
        return new RegulatorReadingList();
    }
    ...
    public Class get_type() {
        return RegulatorReadingList.class;
    }
    ...
    * <code>this</code> is not a <code>RegulatorReadingList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RegulatorReadingList typedDst = (RegulatorReadingList) destination;
        RegulatorReadingList typedSrc = (RegulatorReadingList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        RegulatorReadingList typedSrc = (RegulatorReadingList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.regulatorReading);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.regulatorReading,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RegulatorReadingList typedDst = (RegulatorReadingList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.regulatorReading, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.RegulatorReadingTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RegulatorReadingList typedDst = (RegulatorReadingList) sample;
    ...
    protected RegulatorReadingListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RegulatorReadingListTypeCode.VALUE,RegulatorReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RegulatorReadingListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RegulatorReadingListTypeCode.VALUE,RegulatorReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
