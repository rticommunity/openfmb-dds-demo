...
public class MotorOperatedSwitchStatusProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::motoroperatedswitchmodule::MotorOperatedSwitchStatusProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MotorOperatedSwitchStatusProfileTypeSupport _singleton
    = new MotorOperatedSwitchStatusProfileTypeSupport();
    ...
    */
    public static MotorOperatedSwitchStatusProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static MotorOperatedSwitchStatusProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MotorOperatedSwitchStatusProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return MotorOperatedSwitchStatusProfile.create();
    }
    ...
    public Object create_key() {
        return new MotorOperatedSwitchStatusProfile();
    }
    ...
    public Class get_type() {
        return MotorOperatedSwitchStatusProfile.class;
    }
    ...
    * <code>this</code> is not a <code>MotorOperatedSwitchStatusProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MotorOperatedSwitchStatusProfile typedDst = (MotorOperatedSwitchStatusProfile) destination;
        MotorOperatedSwitchStatusProfile typedSrc = (MotorOperatedSwitchStatusProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        MotorOperatedSwitchStatusProfile typedSrc = (MotorOperatedSwitchStatusProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchStatusTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.motorOperatedSwitchStatus);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.motorOperatedSwitchStatus, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        MotorOperatedSwitchStatusProfile src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MotorOperatedSwitchStatusProfile typedDst = (MotorOperatedSwitchStatusProfile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.motorOperatedSwitchStatus = (OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchStatus)OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.motorOperatedSwitchStatus, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        MotorOperatedSwitchStatusProfile dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        MotorOperatedSwitchStatusProfile sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MotorOperatedSwitchStatusProfile typedDst = (MotorOperatedSwitchStatusProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        MotorOperatedSwitchStatusProfile typedDst
        = (MotorOperatedSwitchStatusProfile) instance;
        MotorOperatedSwitchStatusProfile typedSrc
        = (MotorOperatedSwitchStatusProfile) key;
    ...
    */
    ...
    int mask) {
        return new MotorOperatedSwitchStatusProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MotorOperatedSwitchStatusProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected MotorOperatedSwitchStatusProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,MotorOperatedSwitchStatusProfileTypeCode.VALUE,MotorOperatedSwitchStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MotorOperatedSwitchStatusProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MotorOperatedSwitchStatusProfileTypeCode.VALUE,MotorOperatedSwitchStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
