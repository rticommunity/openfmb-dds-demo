...
public class BooleanMeasurementTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::BooleanMeasurement";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BooleanMeasurementTypeSupport _singleton
    = new BooleanMeasurementTypeSupport();
    ...
    */
    public static BooleanMeasurementTypeSupport get_instance() {
        return _singleton;
    }

    public static BooleanMeasurementTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BooleanMeasurementTypeCode.VALUE;
    }

    public Object create_data() {
        return BooleanMeasurement.create();
    }
    ...
    public Class get_type() {
        return BooleanMeasurement.class;
    }
    ...
    * <code>this</code> is not a <code>BooleanMeasurement</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BooleanMeasurement typedDst = (BooleanMeasurement) destination;
        BooleanMeasurement typedSrc = (BooleanMeasurement) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BooleanMeasurementValueTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BooleanMeasurementValueTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        BooleanMeasurement typedSrc = (BooleanMeasurement) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BooleanMeasurementValueTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.booleanMeasurementValue);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.BooleanMeasurementValueTypeSupport.get_instance().serialize(endpoint_data, typedSrc.booleanMeasurementValue, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BooleanMeasurement typedDst = (BooleanMeasurement) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.booleanMeasurementValue = (OpenFMB_Information_Model.openfmb.commonmodule.BooleanMeasurementValue)OpenFMB_Information_Model.openfmb.commonmodule.BooleanMeasurementValueTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.booleanMeasurementValue, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.BooleanMeasurementValueTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BooleanMeasurement typedDst = (BooleanMeasurement) sample;
    ...
    protected BooleanMeasurementTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BooleanMeasurementTypeCode.VALUE,BooleanMeasurement.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BooleanMeasurementTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BooleanMeasurementTypeCode.VALUE,BooleanMeasurement.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
