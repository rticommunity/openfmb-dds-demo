...
public class CurveNameKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::CurveNameKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CurveNameKindTypeSupport _singleton
    = new CurveNameKindTypeSupport();
    ...
    */
    public static CurveNameKindTypeSupport get_instance() {
        return _singleton;
    }

    public static CurveNameKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CurveNameKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>CurveNameKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        CurveNameKind typedSrc = (CurveNameKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = CurveNameKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected CurveNameKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CurveNameKindTypeCode.VALUE,CurveNameKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
