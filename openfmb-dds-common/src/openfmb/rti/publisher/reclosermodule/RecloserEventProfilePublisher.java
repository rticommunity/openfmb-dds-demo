...
/* RecloserEventProfilePublisher.java
 * A publication of data of type RecloserEventProfile
 */
...
import OpenFMB_Information_Model.openfmb.reclosermodule.RecloserEventProfileDataWriter;
import OpenFMB_Information_Model.openfmb.reclosermodule.RecloserEventProfileTypeSupport;

// ===========================================================================

public class RecloserEventProfilePublisher {
	
    public static RecloserEventProfileDataWriter writer = null;

    // --- Constructors: -----------------------------------------------------

    public RecloserEventProfilePublisher() {
        super();
    }
    ...
    public int initialize(int domainId, String  topicName, String QoSLibrary, String QoSProfile) {
        ...
        try {
            ...
            writer = (RecloserEventProfileDataWriter)
    ...
    public void publish(RecloserEventProfile instance) {
