...
public class RecloserEventTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::RecloserEvent";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RecloserEventTypeSupport _singleton
    = new RecloserEventTypeSupport();
    ...
    */
    public static RecloserEventTypeSupport get_instance() {
        return _singleton;
    }

    public static RecloserEventTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RecloserEventTypeCode.VALUE;
    }

    public Object create_data() {
        return RecloserEvent.create();
    }
    ...
    * <code>this</code> is not a <code>RecloserEvent</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RecloserEvent typedDst = (RecloserEvent) destination;
        RecloserEvent typedSrc = (RecloserEvent) source;
        ...
        Object sample) 
    {
        ...
        RecloserEvent typedSrc = (RecloserEvent) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RecloserEvent typedDst = (RecloserEvent) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RecloserEvent typedDst = (RecloserEvent) sample;
    ...
    protected RecloserEventTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RecloserEventTypeCode.VALUE,RecloserEvent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RecloserEventTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RecloserEventTypeCode.VALUE,RecloserEvent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
