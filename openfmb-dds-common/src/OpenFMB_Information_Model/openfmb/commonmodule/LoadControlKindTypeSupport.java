...
public class LoadControlKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::LoadControlKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LoadControlKindTypeSupport _singleton
    = new LoadControlKindTypeSupport();
    ...
    */
    public static LoadControlKindTypeSupport get_instance() {
        return _singleton;
    }

    public static LoadControlKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LoadControlKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>LoadControlKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        LoadControlKind typedSrc = (LoadControlKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = LoadControlKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected LoadControlKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LoadControlKindTypeCode.VALUE,LoadControlKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
