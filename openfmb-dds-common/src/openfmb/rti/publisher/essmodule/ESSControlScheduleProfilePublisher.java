...
/* ESSControlScheduleProfilePublisher.java
 * A publication of data of type ESSControlScheduleProfile
 */
...
import OpenFMB_Information_Model.openfmb.essmodule.ESSControlScheduleProfileDataWriter;
import OpenFMB_Information_Model.openfmb.essmodule.ESSControlScheduleProfileTypeSupport;

// ===========================================================================

public class ESSControlScheduleProfilePublisher {
	
    public static ESSControlScheduleProfileDataWriter writer = null;

    // --- Constructors: -----------------------------------------------------

    public ESSControlScheduleProfilePublisher() {
        super();
    }
    ...
    public int initialize(int domainId, String  topicName) {
        ...
        try {
            ...
            writer = (ESSControlScheduleProfileDataWriter)
    ...
    public void publish(ESSControlScheduleProfile instance) {
