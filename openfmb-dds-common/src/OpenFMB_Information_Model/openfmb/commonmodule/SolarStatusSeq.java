...
/**
* A sequence of SolarStatus instances.
*/
public final class SolarStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SolarStatusSeq() {
        super(SolarStatus.class);
    }

    public SolarStatusSeq (int initialMaximum) {
        super(SolarStatus.class, initialMaximum);
    }

    public SolarStatusSeq (Collection elements) {
        super(SolarStatus.class, elements);
    }

    public  SolarStatus get(int index) { 
        return (SolarStatus) super.get(index); 
    }
