...
/**
* A sequence of LoadStatus instances.
*/
public final class LoadStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LoadStatusSeq() {
        super(LoadStatus.class);
    }

    public LoadStatusSeq (int initialMaximum) {
        super(LoadStatus.class, initialMaximum);
    }

    public LoadStatusSeq (Collection elements) {
        super(LoadStatus.class, elements);
    }

    public  LoadStatus get(int index) { 
        return (LoadStatus) super.get(index); 
    }
