...
public class RegulatorEventKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::RegulatorEventKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RegulatorEventKindTypeSupport _singleton
    = new RegulatorEventKindTypeSupport();
    ...
    */
    public static RegulatorEventKindTypeSupport get_instance() {
        return _singleton;
    }

    public static RegulatorEventKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RegulatorEventKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return RegulatorEventKind.class;
    }
    ...
    * <code>this</code> is not a <code>RegulatorEventKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        RegulatorEventKind typedSrc = (RegulatorEventKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = RegulatorEventKind.valueOf(ordinal);
            if (dst == null) {
                ...
                if (ap.acceptUnknownEnumValue) {
                    dst = RegulatorEventKind.valueOf(
                        3);
                } else {
    ...
    protected RegulatorEventKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RegulatorEventKindTypeCode.VALUE,RegulatorEventKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
