...
/**
* A sequence of ShuntControl instances.
*/
public final class ShuntControlSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShuntControlSeq() {
        super(ShuntControl.class);
    }

    public ShuntControlSeq (int initialMaximum) {
        super(ShuntControl.class, initialMaximum);
    }

    public ShuntControlSeq (Collection elements) {
        super(ShuntControl.class, elements);
    }

    public  ShuntControl get(int index) { 
        return (ShuntControl) super.get(index); 
    }
