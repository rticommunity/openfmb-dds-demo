...
/**
* A sequence of HexBinary16 instances.
*/
public final class HexBinary16Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public HexBinary16Seq() {
        super(HexBinary16.class);
    }

    public HexBinary16Seq (int initialMaximum) {
        super(HexBinary16.class, initialMaximum);
    }

    public HexBinary16Seq (Collection elements) {
        super(HexBinary16.class, elements);
    }

    public  HexBinary16 get(int index) { 
        return (HexBinary16) super.get(index); 
    }
