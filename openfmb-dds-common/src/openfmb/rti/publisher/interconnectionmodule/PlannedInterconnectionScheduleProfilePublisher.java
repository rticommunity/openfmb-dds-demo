...
/* PlannedInterconnectionScheduleProfilePublisher.java
 * A publication of data of type PlannedInterconnectionScheduleProfile
 */
...
import OpenFMB_Information_Model.openfmb.interconnectionmodule.PlannedInterconnectionScheduleProfileDataWriter;
import OpenFMB_Information_Model.openfmb.interconnectionmodule.PlannedInterconnectionScheduleProfileTypeSupport;

// ===========================================================================

public class PlannedInterconnectionScheduleProfilePublisher {
	
    public static PlannedInterconnectionScheduleProfileDataWriter writer = null;

    // --- Constructors: -----------------------------------------------------

    public PlannedInterconnectionScheduleProfilePublisher() {
        super();
    }
    ...
    public int initialize(int domainId, String  topicName) {
        ...
        try {
            ...
            writer = (PlannedInterconnectionScheduleProfileDataWriter)
    ...
    public void publish(PlannedInterconnectionScheduleProfile instance) {
