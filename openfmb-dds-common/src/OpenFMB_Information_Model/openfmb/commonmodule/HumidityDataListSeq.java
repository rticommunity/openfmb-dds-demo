...
/**
* A sequence of HumidityDataList instances.
*/
public final class HumidityDataListSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public HumidityDataListSeq() {
        super(HumidityDataList.class);
    }

    public HumidityDataListSeq (int initialMaximum) {
        super(HumidityDataList.class, initialMaximum);
    }

    public HumidityDataListSeq (Collection elements) {
        super(HumidityDataList.class, elements);
    }

    public  HumidityDataList get(int index) { 
        return (HumidityDataList) super.get(index); 
    }
