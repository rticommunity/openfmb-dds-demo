...
public class BreakerReadingProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::breakermodule::BreakerReadingProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BreakerReadingProfileTypeSupport _singleton
    = new BreakerReadingProfileTypeSupport();
    ...
    */
    public static BreakerReadingProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static BreakerReadingProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BreakerReadingProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return BreakerReadingProfile.create();
    }
    ...
    public Object create_key() {
        return new BreakerReadingProfile();
    }
    ...
    public Class get_type() {
        return BreakerReadingProfile.class;
    }
    ...
    * <code>this</code> is not a <code>BreakerReadingProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BreakerReadingProfile typedDst = (BreakerReadingProfile) destination;
        BreakerReadingProfile typedSrc = (BreakerReadingProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingListTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingListTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        BreakerReadingProfile typedSrc = (BreakerReadingProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingListTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.breakerReadingList);

        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.BreakerTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.breaker);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingListTypeSupport.get_instance().serialize(endpoint_data, typedSrc.breakerReadingList, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            OpenFMB_Information_Model.openfmb.commonmodule.BreakerTypeSupport.get_instance().serialize(endpoint_data, typedSrc.breaker, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BreakerReadingProfile typedDst = (BreakerReadingProfile) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.breakerReadingList = (OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingList)OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingListTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.breakerReadingList, src, false, true, endpoint_plugin_qos);     
                typedDst.breaker = (OpenFMB_Information_Model.openfmb.commonmodule.Breaker)OpenFMB_Information_Model.openfmb.commonmodule.BreakerTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.breaker, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.BreakerReadingListTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            OpenFMB_Information_Model.openfmb.commonmodule.BreakerTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BreakerReadingProfile typedDst = (BreakerReadingProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        BreakerReadingProfile typedDst
        = (BreakerReadingProfile) instance;
        BreakerReadingProfile typedSrc
        = (BreakerReadingProfile) key;
    ...
    */
    ...
    int mask) {
        return new BreakerReadingProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BreakerReadingProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected BreakerReadingProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,BreakerReadingProfileTypeCode.VALUE,BreakerReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BreakerReadingProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BreakerReadingProfileTypeCode.VALUE,BreakerReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
