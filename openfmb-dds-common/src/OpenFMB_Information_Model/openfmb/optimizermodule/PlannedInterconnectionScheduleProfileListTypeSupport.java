...
public class PlannedInterconnectionScheduleProfileListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::optimizermodule::PlannedInterconnectionScheduleProfileList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PlannedInterconnectionScheduleProfileListTypeSupport _singleton
    = new PlannedInterconnectionScheduleProfileListTypeSupport();
    ...
    */
    public static PlannedInterconnectionScheduleProfileListTypeSupport get_instance() {
        return _singleton;
    }

    public static PlannedInterconnectionScheduleProfileListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PlannedInterconnectionScheduleProfileListTypeCode.VALUE;
    }

    public Object create_data() {
        return PlannedInterconnectionScheduleProfileList.create();
    }
    ...
    public Object create_key() {
        return new PlannedInterconnectionScheduleProfileList();
    }
    ...
    public Class get_type() {
        return PlannedInterconnectionScheduleProfileList.class;
    }
    ...
    * <code>this</code> is not a <code>PlannedInterconnectionScheduleProfileList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PlannedInterconnectionScheduleProfileList typedDst = (PlannedInterconnectionScheduleProfileList) destination;
        PlannedInterconnectionScheduleProfileList typedSrc = (PlannedInterconnectionScheduleProfileList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.interconnectionmodule.PlannedInterconnectionScheduleProfileTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.interconnectionmodule.PlannedInterconnectionScheduleProfileTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        PlannedInterconnectionScheduleProfileList typedSrc = (PlannedInterconnectionScheduleProfileList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.interconnectionmodule.PlannedInterconnectionScheduleProfileTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.plannedInterconnectionScheduleProfile);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.interconnectionmodule.PlannedInterconnectionScheduleProfileTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.plannedInterconnectionScheduleProfile,100, endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        PlannedInterconnectionScheduleProfileList src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PlannedInterconnectionScheduleProfileList typedDst = (PlannedInterconnectionScheduleProfileList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.interconnectionmodule.PlannedInterconnectionScheduleProfileTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.plannedInterconnectionScheduleProfile, src, 100, endpoint_plugin_qos);            
    ...
    public void deserialize_from_cdr_buffer(
        PlannedInterconnectionScheduleProfileList dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        PlannedInterconnectionScheduleProfileList sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.interconnectionmodule.PlannedInterconnectionScheduleProfileTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PlannedInterconnectionScheduleProfileList typedDst = (PlannedInterconnectionScheduleProfileList) sample;
    ...
    protected PlannedInterconnectionScheduleProfileListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PlannedInterconnectionScheduleProfileListTypeCode.VALUE,PlannedInterconnectionScheduleProfileList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PlannedInterconnectionScheduleProfileListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PlannedInterconnectionScheduleProfileListTypeCode.VALUE,PlannedInterconnectionScheduleProfileList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
