...
public class ESSControlKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ESSControlKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ESSControlKindTypeSupport _singleton
    = new ESSControlKindTypeSupport();
    ...
    */
    public static ESSControlKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ESSControlKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ESSControlKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ESSControlKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        ESSControlKind typedSrc = (ESSControlKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ESSControlKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ESSControlKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ESSControlKindTypeCode.VALUE,ESSControlKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
