...
public class SolarStatusProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::solarmodule::SolarStatusProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarStatusProfileTypeSupport _singleton
    = new SolarStatusProfileTypeSupport();
    ...
    */
    public static SolarStatusProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarStatusProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarStatusProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarStatusProfile.create();
    }
    ...
    public Class get_type() {
        return SolarStatusProfile.class;
    }
    ...
    * <code>this</code> is not a <code>SolarStatusProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarStatusProfile typedDst = (SolarStatusProfile) destination;
        SolarStatusProfile typedSrc = (SolarStatusProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        SolarStatusProfile typedSrc = (SolarStatusProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarStatusTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.solarStatus);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.SolarStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.solarStatus, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarStatusProfile typedDst = (SolarStatusProfile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.solarStatus = (OpenFMB_Information_Model.openfmb.commonmodule.SolarStatus)OpenFMB_Information_Model.openfmb.commonmodule.SolarStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.solarStatus, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.SolarStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarStatusProfile typedDst = (SolarStatusProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        SolarStatusProfile typedDst
        = (SolarStatusProfile) instance;
        SolarStatusProfile typedSrc
        = (SolarStatusProfile) key;
    ...
    */
    ...
    int mask) {
        return new SolarStatusProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SolarStatusProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected SolarStatusProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,SolarStatusProfileTypeCode.VALUE,SolarStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarStatusProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarStatusProfileTypeCode.VALUE,SolarStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
