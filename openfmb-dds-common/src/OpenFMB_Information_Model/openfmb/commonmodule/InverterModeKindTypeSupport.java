...
public class InverterModeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::InverterModeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final InverterModeKindTypeSupport _singleton
    = new InverterModeKindTypeSupport();
    ...
    */
    public static InverterModeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static InverterModeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return InverterModeKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>InverterModeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        InverterModeKind typedSrc = (InverterModeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = InverterModeKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected InverterModeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,InverterModeKindTypeCode.VALUE,InverterModeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
