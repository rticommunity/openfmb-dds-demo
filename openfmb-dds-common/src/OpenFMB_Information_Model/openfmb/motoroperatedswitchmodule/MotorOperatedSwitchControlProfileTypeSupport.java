...
public class MotorOperatedSwitchControlProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::motoroperatedswitchmodule::MotorOperatedSwitchControlProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MotorOperatedSwitchControlProfileTypeSupport _singleton
    = new MotorOperatedSwitchControlProfileTypeSupport();
    ...
    */
    public static MotorOperatedSwitchControlProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static MotorOperatedSwitchControlProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MotorOperatedSwitchControlProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return MotorOperatedSwitchControlProfile.create();
    }
    ...
    public Object create_key() {
        return new MotorOperatedSwitchControlProfile();
    }
    ...
    public Class get_type() {
        return MotorOperatedSwitchControlProfile.class;
    }
    ...
    * <code>this</code> is not a <code>MotorOperatedSwitchControlProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MotorOperatedSwitchControlProfile typedDst = (MotorOperatedSwitchControlProfile) destination;
        MotorOperatedSwitchControlProfile typedSrc = (MotorOperatedSwitchControlProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        MotorOperatedSwitchControlProfile typedSrc = (MotorOperatedSwitchControlProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.motorOperatedSwitchControl);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlTypeSupport.get_instance().serialize(endpoint_data, typedSrc.motorOperatedSwitchControl, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        MotorOperatedSwitchControlProfile src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MotorOperatedSwitchControlProfile typedDst = (MotorOperatedSwitchControlProfile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.motorOperatedSwitchControl = (OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControl)OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.motorOperatedSwitchControl, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        MotorOperatedSwitchControlProfile dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        MotorOperatedSwitchControlProfile sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.MotorOperatedSwitchControlTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MotorOperatedSwitchControlProfile typedDst = (MotorOperatedSwitchControlProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        MotorOperatedSwitchControlProfile typedDst
        = (MotorOperatedSwitchControlProfile) instance;
        MotorOperatedSwitchControlProfile typedSrc
        = (MotorOperatedSwitchControlProfile) key;
    ...
    */
    ...
    int mask) {
        return new MotorOperatedSwitchControlProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MotorOperatedSwitchControlProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected MotorOperatedSwitchControlProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,MotorOperatedSwitchControlProfileTypeCode.VALUE,MotorOperatedSwitchControlProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MotorOperatedSwitchControlProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MotorOperatedSwitchControlProfileTypeCode.VALUE,MotorOperatedSwitchControlProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
