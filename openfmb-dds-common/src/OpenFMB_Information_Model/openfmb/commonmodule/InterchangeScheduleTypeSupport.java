...
public class InterchangeScheduleTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::InterchangeSchedule";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InterTieDirectionKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);

        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MarketProductKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.EnergyProductKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.OptimizedMicroGridMarketTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        ...
        Object sample) 
    {
        ...
        if (typedSrc.directionType != null) {
            ...
            currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InterTieDirectionKindTypeSupport.get_instance().get_serialized_sample_size(
        ...
        if (typedSrc.energyType != null) {
            ...
            currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.MarketProductKindTypeSupport.get_instance().get_serialized_sample_size(
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(epd.getAlignment(currentAlignment), 4) + 4);
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.intervalLength != null) {
        ...
        if (typedSrc.scheduleType != null) {
            ...
            currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.EnergyProductKindTypeSupport.get_instance().get_serialized_sample_size(
        ...
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.scheduleTypeExtension != null) {

            currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.scheduleTypeExtension );

            currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        }
        currentAlignment += (CdrPrimitiveType.getPadSize(epd.getAlignment(currentAlignment), 4) + 12);
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.directionTypeExtension != null) {

            currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.directionTypeExtension );

            currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        }
        currentAlignment += (CdrPrimitiveType.getPadSize(epd.getAlignment(currentAlignment), 4) + 12);
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.energyTypeExtension != null) {

            currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.energyTypeExtension );
        ...
        if (typedSrc.optimizedMicroGridMarket != null) {
            ...
            currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.OptimizedMicroGridMarketTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            if (typedSrc.directionType != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.InterTieDirectionKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.directionType, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            ...
            memberLengthPosition = dst.writeMemberId((short)memberId);
            if (typedSrc.energyType != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.MarketProductKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.energyType, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            dst.writeMemberLength(memberLengthPosition, false);
            ...
            memberLengthPosition = dst.writeMemberId((short)memberId);
            if (typedSrc.scheduleType != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.EnergyProductKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.scheduleType, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            dst.writeMemberLength(memberLengthPosition, false);
            ...
            if (typedSrc.scheduleTypeExtension != null) {
                dst.writeString(typedSrc.scheduleTypeExtension,255);
            }
            if (dst.useExtendedMemberId == true) {
            ...
            if (typedSrc.directionTypeExtension != null) {
                dst.writeString(typedSrc.directionTypeExtension,255);
            }
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
            ...
            if (typedSrc.energyTypeExtension != null) {
                dst.writeString(typedSrc.energyTypeExtension,255);
            }
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
            ...
            if (typedSrc.optimizedMicroGridMarket != null) {
                OpenFMB_Information_Model.openfmb.commonmodule.OptimizedMicroGridMarketTypeSupport.get_instance().serialize(endpoint_data, typedSrc.optimizedMicroGridMarket, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                if (tmpLength > 0) {
                    if (typedDst.directionType == null) {
                    ...
                    typedDst.directionType = (OpenFMB_Information_Model.openfmb.commonmodule.InterTieDirectionKind)OpenFMB_Information_Model.openfmb.commonmodule.InterTieDirectionKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.directionType, src, false, true, endpoint_plugin_qos);     
                }
                else {
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.energyType = (OpenFMB_Information_Model.openfmb.commonmodule.MarketProductKind)OpenFMB_Information_Model.openfmb.commonmodule.MarketProductKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.energyType, src, false, true, endpoint_plugin_qos);     
                }
                else {
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.scheduleType = (OpenFMB_Information_Model.openfmb.commonmodule.EnergyProductKind)OpenFMB_Information_Model.openfmb.commonmodule.EnergyProductKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.scheduleType, src, false, true, endpoint_plugin_qos);     
                }
                else {
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.scheduleTypeExtension = src.readString(255);
                }
                else {
                    typedDst.scheduleTypeExtension = null;
                }
                src.getBuffer().setDesBufferSize(tmpSize);
                src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.directionTypeExtension = src.readString(255);
                }
                else {
                    typedDst.directionTypeExtension = null;
                }
                src.getBuffer().setDesBufferSize(tmpSize);
                src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
                ...
                if (tmpLength > 0) {
                    ...
                    typedDst.energyTypeExtension = src.readString(255);
                }
                else {
                    typedDst.energyTypeExtension = null;
                }
                src.getBuffer().setDesBufferSize(tmpSize);
                src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
                ...
                src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
                if (tmpLength > 0) {
                    if (typedDst.optimizedMicroGridMarket == null) {
                    ...
                    typedDst.optimizedMicroGridMarket = (OpenFMB_Information_Model.openfmb.commonmodule.OptimizedMicroGridMarket)OpenFMB_Information_Model.openfmb.commonmodule.OptimizedMicroGridMarketTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.optimizedMicroGridMarket, src, false, true, endpoint_plugin_qos);     
                }
                else {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
            if (tmpLength > 0) {
                OpenFMB_Information_Model.openfmb.commonmodule.InterTieDirectionKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
            src.getBuffer().setDesBufferSize(tmpSize);
            src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
            ...
            src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
            if (tmpLength > 0) {
                OpenFMB_Information_Model.openfmb.commonmodule.MarketProductKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
            src.getBuffer().setDesBufferSize(tmpSize);
            src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
            ...
            src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
            if (tmpLength > 0) {
                OpenFMB_Information_Model.openfmb.commonmodule.EnergyProductKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
            src.getBuffer().setDesBufferSize(tmpSize);
            src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
            ...
            src.getBuffer().setDesBufferSize((int)(tmpPosition + memberInfo.length));
            if (tmpLength > 0) {
                OpenFMB_Information_Model.openfmb.commonmodule.OptimizedMicroGridMarketTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
            src.getBuffer().setDesBufferSize(tmpSize);
            src.getBuffer().setCurrentPosition((int)(tmpPosition + tmpLength));
