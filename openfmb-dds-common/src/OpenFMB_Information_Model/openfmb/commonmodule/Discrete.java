...
public class Discrete   implements Copyable, Serializable{
    ...
    public OpenFMB_Information_Model.openfmb.commonmodule.DiscreteValue discreteMeasurementValue = (OpenFMB_Information_Model.openfmb.commonmodule.DiscreteValue)OpenFMB_Information_Model.openfmb.commonmodule.DiscreteValue.create();

    public Discrete() {

    }
    public Discrete (Discrete other) {
    ...
    public void clear() {
        ...
        phases=null; 
        unit=null; 
        if (discreteMeasurementValue != null) {
            discreteMeasurementValue.clear();
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if(!discreteMeasurementValue.equals(otherObj.discreteMeasurementValue)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        __result += discreteMeasurementValue.hashCode(); 
        return __result;
    }
    ...
    * This method could be placed into <code>DiscreteTypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        Discrete typedSrc = (Discrete) src;
        Discrete typedDst = this;
        ...
        typedDst.discreteMeasurementValue = (OpenFMB_Information_Model.openfmb.commonmodule.DiscreteValue) typedDst.discreteMeasurementValue.copy_from(typedSrc.discreteMeasurementValue);
    ...
    public String toString(String desc, int indent) {
        ...
        strBuffer.append(discreteMeasurementValue.toString("discreteMeasurementValue ", indent+1));
