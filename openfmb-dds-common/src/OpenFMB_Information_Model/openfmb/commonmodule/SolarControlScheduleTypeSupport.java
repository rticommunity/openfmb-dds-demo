...
public class SolarControlScheduleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::SolarControlSchedule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarControlScheduleTypeSupport _singleton
    = new SolarControlScheduleTypeSupport();
    ...
    */
    public static SolarControlScheduleTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarControlScheduleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarControlScheduleTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarControlSchedule.create();
    }
    ...
    public Object create_key() {
        return new SolarControlSchedule();
    }
    ...
    public Class get_type() {
        return SolarControlSchedule.class;
    }
    ...
    * <code>this</code> is not a <code>SolarControlSchedule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarControlSchedule typedDst = (SolarControlSchedule) destination;
        SolarControlSchedule typedSrc = (SolarControlSchedule) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InverterModeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.InverterModeKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        ...
        Object sample) 
    {
        ...
        SolarControlSchedule typedSrc = (SolarControlSchedule) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarControlSchedule typedDst = (SolarControlSchedule) dst;
            typedDst.clear();      
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarControlSchedule typedDst = (SolarControlSchedule) sample;
    ...
    protected SolarControlScheduleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SolarControlScheduleTypeCode.VALUE,SolarControlSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarControlScheduleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarControlScheduleTypeCode.VALUE,SolarControlSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
