...
public class LoadControlScheduleListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::LoadControlScheduleList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LoadControlScheduleListTypeSupport _singleton
    = new LoadControlScheduleListTypeSupport();
    ...
    */
    public static LoadControlScheduleListTypeSupport get_instance() {
        return _singleton;
    }

    public static LoadControlScheduleListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LoadControlScheduleListTypeCode.VALUE;
    }

    public Object create_data() {
        return LoadControlScheduleList.create();
    }
    ...
    public Object create_key() {
        return new LoadControlScheduleList();
    }
    ...
    public Class get_type() {
        return LoadControlScheduleList.class;
    }
    ...
    * <code>this</code> is not a <code>LoadControlScheduleList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LoadControlScheduleList typedDst = (LoadControlScheduleList) destination;
        LoadControlScheduleList typedSrc = (LoadControlScheduleList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.LoadControlScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.LoadControlScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        LoadControlScheduleList typedSrc = (LoadControlScheduleList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.LoadControlScheduleTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.loadControlSchedule);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.LoadControlScheduleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.loadControlSchedule,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LoadControlScheduleList typedDst = (LoadControlScheduleList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.LoadControlScheduleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.loadControlSchedule, src, 100, endpoint_plugin_qos);            
    ...
    public String data_to_string(
        LoadControlScheduleList sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.LoadControlScheduleTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LoadControlScheduleList typedDst = (LoadControlScheduleList) sample;
    ...
    protected LoadControlScheduleListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LoadControlScheduleListTypeCode.VALUE,LoadControlScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LoadControlScheduleListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LoadControlScheduleListTypeCode.VALUE,LoadControlScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
