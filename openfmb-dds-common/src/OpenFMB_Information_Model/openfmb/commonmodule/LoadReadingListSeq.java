...
/**
* A sequence of LoadReadingList instances.
*/
public final class LoadReadingListSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LoadReadingListSeq() {
        super(LoadReadingList.class);
    }

    public LoadReadingListSeq (int initialMaximum) {
        super(LoadReadingList.class, initialMaximum);
    }

    public LoadReadingListSeq (Collection elements) {
        super(LoadReadingList.class, elements);
    }

    public  LoadReadingList get(int index) { 
        return (LoadReadingList) super.get(index); 
    }
