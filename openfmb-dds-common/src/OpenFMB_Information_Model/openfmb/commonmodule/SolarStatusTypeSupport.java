...
public class SolarStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::SolarStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarStatusTypeSupport _singleton
    = new SolarStatusTypeSupport();
    ...
    */
    public static SolarStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarStatus.create();
    }
    ...
    * <code>this</code> is not a <code>SolarStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarStatus typedDst = (SolarStatus) destination;
        SolarStatus typedSrc = (SolarStatus) source;
        ...
        Object sample) 
    {
        ...
        SolarStatus typedSrc = (SolarStatus) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByte(typedSrc.__dummy_prevent_empty_class_SolarStatus);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarStatus typedDst = (SolarStatus) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.__dummy_prevent_empty_class_SolarStatus = src.readByte();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarStatus typedDst = (SolarStatus) sample;
    ...
    protected SolarStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SolarStatusTypeCode.VALUE,SolarStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarStatusTypeCode.VALUE,SolarStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
