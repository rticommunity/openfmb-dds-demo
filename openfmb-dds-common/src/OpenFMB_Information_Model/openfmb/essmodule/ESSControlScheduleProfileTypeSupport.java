...
public class ESSControlScheduleProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::essmodule::ESSControlScheduleProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ESSControlScheduleProfileTypeSupport _singleton
    = new ESSControlScheduleProfileTypeSupport();
    ...
    */
    public static ESSControlScheduleProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static ESSControlScheduleProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ESSControlScheduleProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return ESSControlScheduleProfile.create();
    }
    ...
    public Object create_key() {
        return new ESSControlScheduleProfile();
    }
    ...
    public Class get_type() {
        return ESSControlScheduleProfile.class;
    }
    ...
    * <code>this</code> is not a <code>ESSControlScheduleProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ESSControlScheduleProfile typedDst = (ESSControlScheduleProfile) destination;
        ESSControlScheduleProfile typedSrc = (ESSControlScheduleProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSControlScheduleListTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSControlScheduleListTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        ESSControlScheduleProfile typedSrc = (ESSControlScheduleProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSControlScheduleListTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.essControlScheduleList);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ESSControlScheduleListTypeSupport.get_instance().serialize(endpoint_data, typedSrc.essControlScheduleList, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ESSControlScheduleProfile typedDst = (ESSControlScheduleProfile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.essControlScheduleList = (OpenFMB_Information_Model.openfmb.commonmodule.ESSControlScheduleList)OpenFMB_Information_Model.openfmb.commonmodule.ESSControlScheduleListTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.essControlScheduleList, src, false, true, endpoint_plugin_qos);     
    ...
    public String data_to_string(
        ESSControlScheduleProfile sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ESSControlScheduleListTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ESSControlScheduleProfile typedDst = (ESSControlScheduleProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        ESSControlScheduleProfile typedDst
        = (ESSControlScheduleProfile) instance;
        ESSControlScheduleProfile typedSrc
        = (ESSControlScheduleProfile) key;
    ...
    */
    ...
    int mask) {
        return new ESSControlScheduleProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ESSControlScheduleProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected ESSControlScheduleProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ESSControlScheduleProfileTypeCode.VALUE,ESSControlScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ESSControlScheduleProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ESSControlScheduleProfileTypeCode.VALUE,ESSControlScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
