...
public class GenerationControlScheduleListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::GenerationControlScheduleList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationControlScheduleListTypeSupport _singleton
    = new GenerationControlScheduleListTypeSupport();
    ...
    */
    public static GenerationControlScheduleListTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationControlScheduleListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationControlScheduleListTypeCode.VALUE;
    }

    public Object create_data() {
        return GenerationControlScheduleList.create();
    }
    ...
    public Object create_key() {
        return new GenerationControlScheduleList();
    }
    ...
    public Class get_type() {
        return GenerationControlScheduleList.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationControlScheduleList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenerationControlScheduleList typedDst = (GenerationControlScheduleList) destination;
        GenerationControlScheduleList typedSrc = (GenerationControlScheduleList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationControlScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationControlScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        GenerationControlScheduleList typedSrc = (GenerationControlScheduleList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.GenerationControlScheduleTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.generationControlSchedule);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.GenerationControlScheduleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.generationControlSchedule,100, endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        GenerationControlScheduleList src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenerationControlScheduleList typedDst = (GenerationControlScheduleList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.GenerationControlScheduleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.generationControlSchedule, src, 100, endpoint_plugin_qos);            
    ...
    public void deserialize_from_cdr_buffer(
        GenerationControlScheduleList dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        GenerationControlScheduleList sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.GenerationControlScheduleTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenerationControlScheduleList typedDst = (GenerationControlScheduleList) sample;
    ...
    protected GenerationControlScheduleListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GenerationControlScheduleListTypeCode.VALUE,GenerationControlScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenerationControlScheduleListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenerationControlScheduleListTypeCode.VALUE,GenerationControlScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
