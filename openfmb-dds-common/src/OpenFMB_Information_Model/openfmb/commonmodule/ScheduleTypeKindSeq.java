...
/**
* A sequence of ScheduleTypeKind instances.
*/
public final class ScheduleTypeKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ScheduleTypeKindSeq() {
        super(ScheduleTypeKind.class);
    }

    public ScheduleTypeKindSeq (int initialMaximum) {
        super(ScheduleTypeKind.class, initialMaximum);
    }

    public ScheduleTypeKindSeq (Collection elements) {
        super(ScheduleTypeKind.class, elements);
    }

    public  ScheduleTypeKind get(int index) { 
        return (ScheduleTypeKind) super.get(index); 
    }
