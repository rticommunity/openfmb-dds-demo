...
package openfmb.rti.publisher.securitymodule;

/* SecurityEventProfilePublisher.java
 * A publication of data of type SecurityEventProfile
 */
...
import OpenFMB_Information_Model.openfmb.securitymodule.SecurityEventProfileDataWriter;
import OpenFMB_Information_Model.openfmb.securitymodule.SecurityEventProfileTypeSupport;

// ===========================================================================

public class SecurityEventProfilePublisher {
	
    public static SecurityEventProfileDataWriter writer = null;

    // --- Constructors: -----------------------------------------------------

    public SecurityEventProfilePublisher() {
        super();
    }
    ...
    public int initialize(int domainId, String  topicName) {
        ...
        try {
            ...
            writer = (SecurityEventProfileDataWriter)
    ...
    public void publish(SecurityEventProfile instance) {
