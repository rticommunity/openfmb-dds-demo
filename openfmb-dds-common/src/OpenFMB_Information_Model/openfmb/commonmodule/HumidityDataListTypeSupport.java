...
public class HumidityDataListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::HumidityDataList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final HumidityDataListTypeSupport _singleton
    = new HumidityDataListTypeSupport();
    ...
    */
    public static HumidityDataListTypeSupport get_instance() {
        return _singleton;
    }

    public static HumidityDataListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return HumidityDataListTypeCode.VALUE;
    }

    public Object create_data() {
        return HumidityDataList.create();
    }
    ...
    * <code>this</code> is not a <code>HumidityDataList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        HumidityDataList typedDst = (HumidityDataList) destination;
        HumidityDataList typedSrc = (HumidityDataList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.HumidityDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.HumidityDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        HumidityDataList typedSrc = (HumidityDataList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.HumidityDataTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.humidityData);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.HumidityDataTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.humidityData,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            HumidityDataList typedDst = (HumidityDataList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.HumidityDataTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.humidityData, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.HumidityDataTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            HumidityDataList typedDst = (HumidityDataList) sample;
    ...
    protected HumidityDataListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,HumidityDataListTypeCode.VALUE,HumidityDataList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected HumidityDataListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,HumidityDataListTypeCode.VALUE,HumidityDataList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
