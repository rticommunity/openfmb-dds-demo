...
* SolarReadingTypeKind
*/

public class SolarReadingTypeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::SolarReadingTypeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarReadingTypeKindTypeSupport _singleton
    = new SolarReadingTypeKindTypeSupport();
    ...
    */
    public static SolarReadingTypeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarReadingTypeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarReadingTypeKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return SolarReadingTypeKind.class;
    }
    ...
    * <code>this</code> is not a <code>SolarReadingTypeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        SolarReadingTypeKind typedSrc = (SolarReadingTypeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = SolarReadingTypeKind.valueOf(ordinal);
            if (dst == null) {
                ...
                if (ap.acceptUnknownEnumValue) {
                    dst = SolarReadingTypeKind.valueOf(
                        2);
                } else {
    ...
    protected SolarReadingTypeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SolarReadingTypeKindTypeCode.VALUE,SolarReadingTypeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
