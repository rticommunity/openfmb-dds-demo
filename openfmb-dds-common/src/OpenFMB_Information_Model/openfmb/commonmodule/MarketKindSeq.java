...
/**
* A sequence of MarketKind instances.
*/
public final class MarketKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MarketKindSeq() {
        super(MarketKind.class);
    }

    public MarketKindSeq (int initialMaximum) {
        super(MarketKind.class, initialMaximum);
    }

    public MarketKindSeq (Collection elements) {
        super(MarketKind.class, elements);
    }

    public  MarketKind get(int index) { 
        return (MarketKind) super.get(index); 
    }
