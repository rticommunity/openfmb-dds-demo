...
public class SolarReadingListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::SolarReadingList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarReadingListTypeSupport _singleton
    = new SolarReadingListTypeSupport();
    ...
    */
    public static SolarReadingListTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarReadingListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarReadingListTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarReadingList.create();
    }
    ...
    * <code>this</code> is not a <code>SolarReadingList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarReadingList typedDst = (SolarReadingList) destination;
        SolarReadingList typedSrc = (SolarReadingList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        SolarReadingList typedSrc = (SolarReadingList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarReadingTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.solarReading);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.SolarReadingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.solarReading,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarReadingList typedDst = (SolarReadingList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.SolarReadingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.solarReading, src, 100, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.SolarReadingTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarReadingList typedDst = (SolarReadingList) sample;
    ...
    protected SolarReadingListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SolarReadingListTypeCode.VALUE,SolarReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarReadingListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarReadingListTypeCode.VALUE,SolarReadingList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
