...
/**
* A sequence of MarketFactorList instances.
*/
public final class MarketFactorListSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MarketFactorListSeq() {
        super(MarketFactorList.class);
    }

    public MarketFactorListSeq (int initialMaximum) {
        super(MarketFactorList.class, initialMaximum);
    }

    public MarketFactorListSeq (Collection elements) {
        super(MarketFactorList.class, elements);
    }

    public  MarketFactorList get(int index) { 
        return (MarketFactorList) super.get(index); 
    }
