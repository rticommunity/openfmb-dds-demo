...
public class ESSEventTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ESSEvent";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ESSEventTypeSupport _singleton
    = new ESSEventTypeSupport();
    ...
    */
    public static ESSEventTypeSupport get_instance() {
        return _singleton;
    }

    public static ESSEventTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ESSEventTypeCode.VALUE;
    }

    public Object create_data() {
        return ESSEvent.create();
    }
    ...
    * <code>this</code> is not a <code>ESSEvent</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ESSEvent typedDst = (ESSEvent) destination;
        ESSEvent typedSrc = (ESSEvent) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSEventKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(0 );
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getPadSize(currentAlignment, 4);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSEventKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        ...
        Object sample) 
    {
        ...
        ESSEvent typedSrc = (ESSEvent) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ESSEventKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.type);
        currentAlignment += (CdrPrimitiveType.getPadSize(epd.getAlignment(currentAlignment), 4) + 4);
        epd.setBaseAlignment(currentAlignment);
        if (typedSrc.stateOfCharge != null) {

            currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(epd.getAlignment(currentAlignment));
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ESSEventKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ESSEvent typedDst = (ESSEvent) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.type = (OpenFMB_Information_Model.openfmb.commonmodule.ESSEventKind)OpenFMB_Information_Model.openfmb.commonmodule.ESSEventKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ESSEventKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ESSEvent typedDst = (ESSEvent) sample;
    ...
    protected ESSEventTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ESSEventTypeCode.VALUE,ESSEvent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ESSEventTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ESSEventTypeCode.VALUE,ESSEvent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
