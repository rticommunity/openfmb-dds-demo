...
public class SolarControlScheduleProfileListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::optimizermodule::SolarControlScheduleProfileList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarControlScheduleProfileListTypeSupport _singleton
    = new SolarControlScheduleProfileListTypeSupport();
    ...
    */
    public static SolarControlScheduleProfileListTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarControlScheduleProfileListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarControlScheduleProfileListTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarControlScheduleProfileList.create();
    }
    ...
    public Object create_key() {
        return new SolarControlScheduleProfileList();
    }
    ...
    public Class get_type() {
        return SolarControlScheduleProfileList.class;
    }
    ...
    * <code>this</code> is not a <code>SolarControlScheduleProfileList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarControlScheduleProfileList typedDst = (SolarControlScheduleProfileList) destination;
        SolarControlScheduleProfileList typedSrc = (SolarControlScheduleProfileList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.solarmodule.SolarControlScheduleProfileTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.solarmodule.SolarControlScheduleProfileTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        SolarControlScheduleProfileList typedSrc = (SolarControlScheduleProfileList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.solarmodule.SolarControlScheduleProfileTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.solarControlScheduleProfile);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.solarmodule.SolarControlScheduleProfileTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.solarControlScheduleProfile,100, endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        SolarControlScheduleProfileList src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarControlScheduleProfileList typedDst = (SolarControlScheduleProfileList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.solarmodule.SolarControlScheduleProfileTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.solarControlScheduleProfile, src, 100, endpoint_plugin_qos);            
    ...
    public void deserialize_from_cdr_buffer(
        SolarControlScheduleProfileList dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        SolarControlScheduleProfileList sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.solarmodule.SolarControlScheduleProfileTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarControlScheduleProfileList typedDst = (SolarControlScheduleProfileList) sample;
    ...
    protected SolarControlScheduleProfileListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SolarControlScheduleProfileListTypeCode.VALUE,SolarControlScheduleProfileList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarControlScheduleProfileListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarControlScheduleProfileListTypeCode.VALUE,SolarControlScheduleProfileList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
