...
public class GenerationControlScheduleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::GenerationControlSchedule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationControlScheduleTypeSupport _singleton
    = new GenerationControlScheduleTypeSupport();
    ...
    */
    public static GenerationControlScheduleTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationControlScheduleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationControlScheduleTypeCode.VALUE;
    }

    public Object create_data() {
        return GenerationControlSchedule.create();
    }
    ...
    public Object create_key() {
        return new GenerationControlSchedule();
    }
    ...
    public Class get_type() {
        return GenerationControlSchedule.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationControlSchedule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenerationControlSchedule typedDst = (GenerationControlSchedule) destination;
        GenerationControlSchedule typedSrc = (GenerationControlSchedule) source;
        ...
        Object sample) 
    {
        ...
        GenerationControlSchedule typedSrc = (GenerationControlSchedule) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenerationControlSchedule typedDst = (GenerationControlSchedule) dst;
            typedDst.clear();      
    ...
    public String data_to_string(
        GenerationControlSchedule sample,
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenerationControlSchedule typedDst = (GenerationControlSchedule) sample;
    ...
    protected GenerationControlScheduleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GenerationControlScheduleTypeCode.VALUE,GenerationControlSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenerationControlScheduleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenerationControlScheduleTypeCode.VALUE,GenerationControlSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
