...
public class ShuntControlSchedule  extends OpenFMB_Information_Model.openfmb.commonmodule.Curve implements Copyable, Serializable{

    public OpenFMB_Information_Model.openfmb.commonmodule.DateTimeInterval dateTimeInterval = null ;

    public ShuntControlSchedule() {

        super();

    }
    public ShuntControlSchedule (ShuntControlSchedule other) {
    ...
    public static Object create() {
        ...
        ShuntControlSchedule self;
        self = new  ShuntControlSchedule();
        self.clear();
        return self;
    ...
    public boolean equals(Object o) {
        ...
        ShuntControlSchedule otherObj = (ShuntControlSchedule)o;
    ...
    * This method could be placed into <code>ShuntControlScheduleTypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        ShuntControlSchedule typedSrc = (ShuntControlSchedule) src;
        ShuntControlSchedule typedDst = this;
