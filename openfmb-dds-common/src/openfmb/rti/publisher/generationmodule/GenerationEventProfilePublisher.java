...
/* GenerationEventProfilePublisher.java
 * A publication of data of type GenerationEventProfile
 */
...
import OpenFMB_Information_Model.openfmb.generationmodule.GenerationEventProfileDataWriter;
import OpenFMB_Information_Model.openfmb.generationmodule.GenerationEventProfileTypeSupport;

// ===========================================================================

public class GenerationEventProfilePublisher {
	
    public static GenerationEventProfileDataWriter writer = null;

    // --- Constructors: -----------------------------------------------------

    public GenerationEventProfilePublisher() {
        super();
    }
    ...
    public int initialize(int domainId, String  topicName) {
        ...
        try {
            ...
            writer = (GenerationEventProfileDataWriter)
    ...
    public void publish(GenerationEventProfile instance) {
