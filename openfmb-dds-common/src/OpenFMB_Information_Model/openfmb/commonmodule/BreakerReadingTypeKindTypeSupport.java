...
* BreakerReadingTypeKind
*/

public class BreakerReadingTypeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::BreakerReadingTypeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BreakerReadingTypeKindTypeSupport _singleton
    = new BreakerReadingTypeKindTypeSupport();
    ...
    */
    public static BreakerReadingTypeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static BreakerReadingTypeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BreakerReadingTypeKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return BreakerReadingTypeKind.class;
    }
    ...
    * <code>this</code> is not a <code>BreakerReadingTypeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        BreakerReadingTypeKind typedSrc = (BreakerReadingTypeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = BreakerReadingTypeKind.valueOf(ordinal);
            if (dst == null) {
                ...
                if (ap.acceptUnknownEnumValue) {
                    dst = BreakerReadingTypeKind.valueOf(
                        2);
                } else {
    ...
    protected BreakerReadingTypeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BreakerReadingTypeKindTypeCode.VALUE,BreakerReadingTypeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
