...
public class GenerationEventKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::GenerationEventKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationEventKindTypeSupport _singleton
    = new GenerationEventKindTypeSupport();
    ...
    */
    public static GenerationEventKindTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationEventKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationEventKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return GenerationEventKind.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationEventKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        GenerationEventKind typedSrc = (GenerationEventKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = GenerationEventKind.valueOf(ordinal);
            if (dst == null) {
                ...
                if (ap.acceptUnknownEnumValue) {
                    dst = GenerationEventKind.valueOf(
                        6);
                } else {
    ...
    protected GenerationEventKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GenerationEventKindTypeCode.VALUE,GenerationEventKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
