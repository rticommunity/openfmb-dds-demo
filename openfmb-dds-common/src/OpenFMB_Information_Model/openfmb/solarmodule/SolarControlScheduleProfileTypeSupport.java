...
public class SolarControlScheduleProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::solarmodule::SolarControlScheduleProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarControlScheduleProfileTypeSupport _singleton
    = new SolarControlScheduleProfileTypeSupport();
    ...
    */
    public static SolarControlScheduleProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarControlScheduleProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarControlScheduleProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarControlScheduleProfile.create();
    }
    ...
    public Object create_key() {
        return new SolarControlScheduleProfile();
    }
    ...
    public Class get_type() {
        return SolarControlScheduleProfile.class;
    }
    ...
    * <code>this</code> is not a <code>SolarControlScheduleProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarControlScheduleProfile typedDst = (SolarControlScheduleProfile) destination;
        SolarControlScheduleProfile typedSrc = (SolarControlScheduleProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarInverterTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarControlScheduleListTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarInverterTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarControlScheduleListTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        SolarControlScheduleProfile typedSrc = (SolarControlScheduleProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarInverterTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.solarInverter);

        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.SolarControlScheduleListTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.solarControlScheduleList);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.SolarInverterTypeSupport.get_instance().serialize(endpoint_data, typedSrc.solarInverter, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            OpenFMB_Information_Model.openfmb.commonmodule.SolarControlScheduleListTypeSupport.get_instance().serialize(endpoint_data, typedSrc.solarControlScheduleList, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        SolarControlScheduleProfile src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarControlScheduleProfile typedDst = (SolarControlScheduleProfile) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.solarInverter = (OpenFMB_Information_Model.openfmb.commonmodule.SolarInverter)OpenFMB_Information_Model.openfmb.commonmodule.SolarInverterTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.solarInverter, src, false, true, endpoint_plugin_qos);     
                typedDst.solarControlScheduleList = (OpenFMB_Information_Model.openfmb.commonmodule.SolarControlScheduleList)OpenFMB_Information_Model.openfmb.commonmodule.SolarControlScheduleListTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.solarControlScheduleList, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        SolarControlScheduleProfile dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        SolarControlScheduleProfile sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.SolarInverterTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            OpenFMB_Information_Model.openfmb.commonmodule.SolarControlScheduleListTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarControlScheduleProfile typedDst = (SolarControlScheduleProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        SolarControlScheduleProfile typedDst
        = (SolarControlScheduleProfile) instance;
        SolarControlScheduleProfile typedSrc
        = (SolarControlScheduleProfile) key;
    ...
    */
    ...
    int mask) {
        return new SolarControlScheduleProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SolarControlScheduleProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected SolarControlScheduleProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,SolarControlScheduleProfileTypeCode.VALUE,SolarControlScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarControlScheduleProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarControlScheduleProfileTypeCode.VALUE,SolarControlScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
