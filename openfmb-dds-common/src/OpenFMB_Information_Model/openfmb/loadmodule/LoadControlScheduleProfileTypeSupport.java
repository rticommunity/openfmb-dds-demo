...
public class LoadControlScheduleProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::loadmodule::LoadControlScheduleProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LoadControlScheduleProfileTypeSupport _singleton
    = new LoadControlScheduleProfileTypeSupport();
    ...
    */
    public static LoadControlScheduleProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static LoadControlScheduleProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LoadControlScheduleProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return LoadControlScheduleProfile.create();
    }
    ...
    public Object create_key() {
        return new LoadControlScheduleProfile();
    }
    ...
    public Class get_type() {
        return LoadControlScheduleProfile.class;
    }
    ...
    * <code>this</code> is not a <code>LoadControlScheduleProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LoadControlScheduleProfile typedDst = (LoadControlScheduleProfile) destination;
        LoadControlScheduleProfile typedSrc = (LoadControlScheduleProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.LoadControlScheduleListTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.LoadControlScheduleListTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        LoadControlScheduleProfile typedSrc = (LoadControlScheduleProfile) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.LoadControlScheduleListTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.loadControlScheduleList);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.LoadControlScheduleListTypeSupport.get_instance().serialize(endpoint_data, typedSrc.loadControlScheduleList, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        LoadControlScheduleProfile src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LoadControlScheduleProfile typedDst = (LoadControlScheduleProfile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.loadControlScheduleList = (OpenFMB_Information_Model.openfmb.commonmodule.LoadControlScheduleList)OpenFMB_Information_Model.openfmb.commonmodule.LoadControlScheduleListTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.loadControlScheduleList, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        LoadControlScheduleProfile dst,
        byte[] buffer,
        long length) 
    {
    ...
    public String data_to_string(
        LoadControlScheduleProfile sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.LoadControlScheduleListTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LoadControlScheduleProfile typedDst = (LoadControlScheduleProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        LoadControlScheduleProfile typedDst
        = (LoadControlScheduleProfile) instance;
        LoadControlScheduleProfile typedSrc
        = (LoadControlScheduleProfile) key;
    ...
    */
    ...
    int mask) {
        return new LoadControlScheduleProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new LoadControlScheduleProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected LoadControlScheduleProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,LoadControlScheduleProfileTypeCode.VALUE,LoadControlScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LoadControlScheduleProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LoadControlScheduleProfileTypeCode.VALUE,LoadControlScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
