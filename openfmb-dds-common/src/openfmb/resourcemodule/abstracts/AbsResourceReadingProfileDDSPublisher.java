...
public abstract class AbsResourceReadingProfileDDSPublisher 
{
    ...
    public void initialize() {
        ...
        EncryptableProperties prop = new EncryptableProperties(encryptor);
                ...
                {
                        System.out.println("Could not load application properties. Shutting down. " + e);
                        return;
                }
                catch (Exception e)
                {
                        System.out.println("Invalid property value. Shutting down. " + e);
                        return;
                }
        ...
        if (participant == null) {
            System.out.println("create_participant error\n");
            return;
        }
        ...
        if (publisher == null) {
            System.out.println("create_publisher error\n");
            return;
        }
        ...
        topic = participant.create_topic(
            ...
            null /* listener */, StatusKind.STATUS_MASK_NONE);
        if (topic == null) {
            System.out.println("create_topic error\n");
            return;
        }
        ...
        publisher.create_datawriter(
            ...
            null /* listener */, StatusKind.STATUS_MASK_NONE);
        if (writer == null) {
            System.out.println("create_datawriter error\n");
            return;
        }
