...
public class ShuntControlScheduleListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::ShuntControlScheduleList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShuntControlScheduleListTypeSupport _singleton
    = new ShuntControlScheduleListTypeSupport();
    ...
    */
    public static ShuntControlScheduleListTypeSupport get_instance() {
        return _singleton;
    }

    public static ShuntControlScheduleListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShuntControlScheduleListTypeCode.VALUE;
    }

    public Object create_data() {
        return ShuntControlScheduleList.create();
    }
    ...
    public Object create_key() {
        return new ShuntControlScheduleList();
    }
    ...
    public Class get_type() {
        return ShuntControlScheduleList.class;
    }
    ...
    * <code>this</code> is not a <code>ShuntControlScheduleList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShuntControlScheduleList typedDst = (ShuntControlScheduleList) destination;
        ShuntControlScheduleList typedSrc = (ShuntControlScheduleList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlScheduleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        ShuntControlScheduleList typedSrc = (ShuntControlScheduleList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlScheduleTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.shuntControlSchedule);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlScheduleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.shuntControlSchedule,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShuntControlScheduleList typedDst = (ShuntControlScheduleList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlScheduleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.shuntControlSchedule, src, 100, endpoint_plugin_qos);            
    ...
    public String data_to_string(
        ShuntControlScheduleList sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.ShuntControlScheduleTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShuntControlScheduleList typedDst = (ShuntControlScheduleList) sample;
    ...
    protected ShuntControlScheduleListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShuntControlScheduleListTypeCode.VALUE,ShuntControlScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShuntControlScheduleListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShuntControlScheduleListTypeCode.VALUE,ShuntControlScheduleList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
