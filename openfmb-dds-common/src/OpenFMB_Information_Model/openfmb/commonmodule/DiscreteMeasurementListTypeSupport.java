...
public class DiscreteMeasurementListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OpenFMB_Information_Model::openfmb::commonmodule::DiscreteMeasurementList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DiscreteMeasurementListTypeSupport _singleton
    = new DiscreteMeasurementListTypeSupport();
    ...
    */
    public static DiscreteMeasurementListTypeSupport get_instance() {
        return _singleton;
    }

    public static DiscreteMeasurementListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DiscreteMeasurementListTypeCode.VALUE;
    }

    public Object create_data() {
        return DiscreteMeasurementList.create();
    }
    ...
    public Object create_key() {
        return new DiscreteMeasurementList();
    }
    ...
    public Class get_type() {
        return DiscreteMeasurementList.class;
    }
    ...
    * <code>this</code> is not a <code>DiscreteMeasurementList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DiscreteMeasurementList typedDst = (DiscreteMeasurementList) destination;
        DiscreteMeasurementList typedSrc = (DiscreteMeasurementList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.DiscreteTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.DiscreteTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        ...
        Object sample) 
    {
        ...
        DiscreteMeasurementList typedSrc = (DiscreteMeasurementList) sample;
        ...
        currentAlignment += OpenFMB_Information_Model.openfmb.commonmodule.DiscreteTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.discreteMeasurement);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.DiscreteTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.discreteMeasurement,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DiscreteMeasurementList typedDst = (DiscreteMeasurementList) dst;
            typedDst.clear();      
            try{
                OpenFMB_Information_Model.openfmb.commonmodule.DiscreteTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.discreteMeasurement, src, 100, endpoint_plugin_qos);            
    ...
    public String data_to_string(
        DiscreteMeasurementList sample,
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            OpenFMB_Information_Model.openfmb.commonmodule.DiscreteTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DiscreteMeasurementList typedDst = (DiscreteMeasurementList) sample;
    ...
    protected DiscreteMeasurementListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DiscreteMeasurementListTypeCode.VALUE,DiscreteMeasurementList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DiscreteMeasurementListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DiscreteMeasurementListTypeCode.VALUE,DiscreteMeasurementList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
